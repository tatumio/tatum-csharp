...
public class PolygonApiTests : IAsyncDisposable
{
    ...
    // {
    //     var wallet = await _polygonApi.PolygonBlockchain.EthGenerateWalletAsync();
    //
    ...
    // {
    //     var response = await _polygonApi.PolygonBlockchainWithHttpInfo.EthGenerateWalletWithHttpInfoAsync();
    //
    ...
    // {
    //     var wallet = await _polygonApi.PolygonBlockchain.EthGenerateWalletAsync(_testData.TestMnemonic);
    //
    ...
    // {
    //     var response = await _polygonApi.PolygonBlockchainWithHttpInfo.EthGenerateWalletWithHttpInfoAsync(_testData.TestMnemonic);
    //
    //     response.StatusCode.Should().Be(HttpStatusCode.OK);
    ...
    // {
    //     var address = await _polygonApi.PolygonBlockchain.EthGenerateAddressAsync(_testData.TestXPub, 0);
    //
    ...
    // {
    //     Func<Task> action = async () => await _polygonApi.PolygonBlockchain.EthGenerateAddressAsync("some random text", 0);
    //
    ...
    // {
    //     var address = await _polygonApi.PolygonBlockchainWithHttpInfo.EthGenerateAddressWithHttpInfoAsync(_testData.TestXPub, 0);
    //     
    //     await Verifier.Verify(address);
    // }
    //
    ...
    // {
    //     var address = await _polygonApi.PolygonBlockchainWithHttpInfo.EthGenerateAddressWithHttpInfoAsync("some random text", 0);
    //
    //     await Verifier.Verify(address);
    // }
    //
    ...
    // {
    //     var privKey = await _polygonApi.PolygonBlockchain.EthGenerateAddressPrivateKeyAsync(new PrivKeyRequest(0, _testData.TestMnemonic));
    //
    ...
    //     
    //     var privKey = await _polygonApi.PolygonBlockchain.EthGenerateAddressPrivateKeyAsync(privKeyRequest);
    ...
    // {
    //     var blockNumber = await _polygonApi.PolygonBlockchain.EthGetCurrentBlockAsync();
    //
    ...
    // {
    //     var block = await _polygonApi.PolygonBlockchain.EthGetBlockAsync("0");
    //
    ...
    // {
    //     var accountBalance = await _polygonApi.PolygonBlockchain.EthGetBalanceAsync(_testData.StorageAddress);
    //
    ...
    //     var amount = 0.00005m;
    //
    //     var transactionHash = await _polygonApi.PolygonBlockchain.EthBlockchainTransferAsync(
    ...
    //     
    //     var transaction = await _polygonApi.PolygonBlockchain.EthGetTransactionAsync(txHash);
    //
    ...
    // {
    //     var accountBalance = await _polygonApi.PolygonBlockchain.EthGetTransactionCountAsync(_testData.StorageAddress);
    //
    ...
    // {
    //     var transaction = await _polygonApi.PolygonBlockchain.EthGetTransactionByAddressAsync(_testData.StorageAddress, 10);
    //
    //     transaction.Should()
    //         .NotBeNull()
    //         .And.NotBeEmpty()
    ...
    //     
    //     var transaction = await _polygonApi.PolygonBlockchain.EthGetInternalTransactionByAddressAsync(address, 10);
    //
    //     transaction.Should()
    //         .NotBeNull()
    //         .And.NotBeEmpty()
    ...
    //     );
    //     
    //     var transaction = await _polygonApi.PolygonBlockchain.EthBlockchainSmartContractInvocationAsync(callSmartContractMethod);
    //
    ...
    //     );
    //     
    //     var data = await _polygonApi.PolygonBlockchain.EthBlockchainSmartContractInvocationAsync(callReadSmartContractMethod);
    //
    ...
    // {
    //     var txCount = await _polygonApi.PolygonBlockchain.EthGetTransactionCountAsync(_testData.StorageAddress);
    ...
    //
    //     var resultTransaction = await _polygonApi.PolygonBlockchain.EthBroadcastAsync(new BroadcastKMS("0x" + signedTransaction));
    //
    ...
    //             try
    //             {
    //                 var tx = await _polygonApi.PolygonBlockchain.EthGetTransactionAsync(hash,
    ...
    //     {
    //         var result = await _polygonApi.PolygonBlockchain.EthBlockchainTransferAsync(
    //             new TransferEthBlockchain(
    //                 null,
    //                 0,
