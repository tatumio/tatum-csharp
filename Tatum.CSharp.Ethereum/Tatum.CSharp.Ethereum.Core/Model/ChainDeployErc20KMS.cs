...
namespace Tatum.CSharp.Ethereum.Core.Model
{
    ...
    public partial class ChainDeployErc20KMS : IEquatable<ChainDeployErc20KMS>, IValidatableObject
    {
        ...
        public ChainDeployErc20KMS(string symbol = default(string), string name = default(string), string totalCap = default(string), string supply = default(string), decimal digits = default(decimal), string address = default(string), Guid signatureId = default(Guid), decimal nonce = default(decimal), CustomFee fee = default(CustomFee))
        {
