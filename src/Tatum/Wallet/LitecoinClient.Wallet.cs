...
namespace Tatum.Clients
{
    public partial class LitecoinClient : ILitecoinClient
    {
        ...
        Wallet ILitecoinClient.CreateWallet(string mnemonic, bool testnet)
        {
            ...
            {
                Mnemonic = mnemonic,
                XPub = xPub.ToString(testnet ? CreateLitecoinTestnet() : CreateLitecoinMainnet())
            };
        }
        ...
        string ILitecoinClient.GeneratePrivateKey(string mnemonic, int index, bool testnet)
        {
            return new Mnemonic(mnemonic)
                ...
                .PrivateKey
                .GetWif(testnet ? CreateLitecoinTestnet() : CreateLitecoinMainnet())
                .ToString();
        }
        ...
        {
            return ExtPubKey.Parse(xPubString, testnet ? CreateLitecoinTestnet() : CreateLitecoinMainnet())
                .Derive(Convert.ToUInt32(index))
                .PubKey
                .GetAddress(ScriptPubKeyType.Legacy, testnet ? CreateLitecoinTestnet() : CreateLitecoinMainnet())
                .ToString();
        }

        protected Network CreateLitecoinMainnet()
        {
            ...
            .SetNetworkSet(Litecoin.Instance)
            .AddDNSSeeds(new[]
            {
        ...
        protected Network CreateLitecoinTestnet()
        {
