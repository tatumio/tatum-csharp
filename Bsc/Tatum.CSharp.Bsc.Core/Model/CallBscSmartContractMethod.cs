...
namespace Tatum.CSharp.Bsc.Core.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CallBscSmartContractMethod")]
    public partial class CallBscSmartContractMethod : IEquatable<CallBscSmartContractMethod>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CallBscSmartContractMethod" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CallBscSmartContractMethod() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CallBscSmartContractMethod" /> class.
        /// </summary>
        ...
        public CallBscSmartContractMethod(string contractAddress = default(string), string methodName = default(string), Object methodABI = default(Object), List<string> _params = default(List<string>), string amount = default(string), string fromPrivateKey = default(string), decimal nonce = default(decimal), CustomFee fee = default(CustomFee))
        {
            // to ensure "contractAddress" is required (not null)
            if (contractAddress == null)
            {
                throw new ArgumentNullException("contractAddress is a required property for CallBscSmartContractMethod and cannot be null");
            }
            this.ContractAddress = contractAddress;
            // to ensure "methodName" is required (not null)
            if (methodName == null)
            {
                throw new ArgumentNullException("methodName is a required property for CallBscSmartContractMethod and cannot be null");
            }
            this.MethodName = methodName;
            // to ensure "methodABI" is required (not null)
            if (methodABI == null)
            {
                throw new ArgumentNullException("methodABI is a required property for CallBscSmartContractMethod and cannot be null");
            }
            this.MethodABI = methodABI;
            // to ensure "_params" is required (not null)
            if (_params == null)
            {
                throw new ArgumentNullException("_params is a required property for CallBscSmartContractMethod and cannot be null");
            }
            this.Params = _params;
            // to ensure "fromPrivateKey" is required (not null)
            if (fromPrivateKey == null)
            {
                throw new ArgumentNullException("fromPrivateKey is a required property for CallBscSmartContractMethod and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CallBscSmartContractMethod {\n");
        ...
        {
            return this.Equals(input as CallBscSmartContractMethod);
        }

        /// <summary>
        /// Returns true if CallBscSmartContractMethod instances are equal
        /// </summary>
        /// <param name="input">Instance of CallBscSmartContractMethod to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CallBscSmartContractMethod input)
        {
            if (input == null)
            {
                return false;
