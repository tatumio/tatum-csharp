...
namespace Tatum.CSharp.Bsc.Core.Model
{
    ...
    /// FeeETH
    /// </summary>
    [DataContract(Name = "FeeETH")]
    public partial class FeeETH : IEquatable<FeeETH>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FeeETH" /> class.
        /// </summary>
        ...
        public FeeETH(decimal gasLimit = default(decimal), decimal gasPrice = default(decimal))
        {
        ...
        {
            return this.Equals(input as FeeETH);
        }

        /// <summary>
        /// Returns true if FeeETH instances are equal
        /// </summary>
        /// <param name="input">Instance of FeeETH to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FeeETH input)
        {
            if (input == null)
            {
                return false;
