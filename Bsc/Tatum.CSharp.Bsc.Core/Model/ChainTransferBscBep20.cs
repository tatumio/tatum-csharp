...
namespace Tatum.CSharp.Bsc.Core.Model
{
    ...
    public partial class ChainTransferBscBep20 : IEquatable<ChainTransferBscBep20>, IValidatableObject
    {
        ...
        public ChainTransferBscBep20(string to = default(string), string contractAddress = default(string), string amount = default(string), decimal digits = default(decimal), string fromPrivateKey = default(string), decimal nonce = default(decimal), CustomFee fee = default(CustomFee))
        {
