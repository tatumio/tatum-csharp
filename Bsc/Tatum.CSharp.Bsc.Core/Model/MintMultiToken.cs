...
namespace Tatum.CSharp.Bsc.Core.Model
{
    ...
    public partial class MintMultiToken : IEquatable<MintMultiToken>, IValidatableObject
    {
        ...
        public MintMultiToken(string tokenId = default(string), string to = default(string), string contractAddress = default(string), string amount = default(string), string data = default(string), string fromPrivateKey = default(string), decimal nonce = default(decimal), CustomFee fee = default(CustomFee))
        {
