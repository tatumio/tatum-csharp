...
namespace Tatum.CSharp.Bsc.Core.Api
{
    ...
    public partial class FungibleTokensApi : IFungibleTokensApi
    {
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public FungibleTokensApi(HttpClient client, Tatum.CSharp.Bsc.Core.Client.Configuration configuration, HttpClientHandler handler = null)
        {
        ...
        public ApiResponse<TransactionHash> Erc20TransferWithHttpInfo(ChainTransferBscBep20 chainTransferBscBep20, string xTestnetType = default(string))
        {
            ...
            if (chainTransferBscBep20 == null)
                throw new ApiException(400, "Missing required parameter 'chainTransferBscBep20' when calling FungibleTokensApi->Erc20Transfer_0");
        ...
        public ApiResponse<SignatureId> Erc20TransferWithHttpInfo(ChainTransferEthErc20KMS chainTransferEthErc20KMS, string xTestnetType = default(string))
        {
            ...
            if (chainTransferEthErc20KMS == null)
                throw new ApiException(400, "Missing required parameter 'chainTransferEthErc20KMS' when calling FungibleTokensApi->Erc20Transfer_1");
        ...
        public ApiResponse<SignatureId> Erc20TransferWithHttpInfo(ChainTransferBscBep20KMS chainTransferBscBep20KMS, string xTestnetType = default(string))
        {
            ...
            if (chainTransferBscBep20KMS == null)
                throw new ApiException(400, "Missing required parameter 'chainTransferBscBep20KMS' when calling FungibleTokensApi->Erc20Transfer_2");
