...
namespace Tatum.CSharp.Bsc.Core.Model
{
    ...
    public partial class ChainTransferEthErc20KMS : IEquatable<ChainTransferEthErc20KMS>, IValidatableObject
    {
        ...
        public ChainTransferEthErc20KMS(string to = default(string), string contractAddress = default(string), string amount = default(string), decimal digits = default(decimal), Guid signatureId = default(Guid), decimal nonce = default(decimal), CustomFee fee = default(CustomFee))
        {
