...
namespace Tatum.CSharp.Bsc.Core.Model
{
    ...
    public partial class DeployNft : IEquatable<DeployNft>, IValidatableObject
    {
        ...
        public DeployNft(string name = default(string), string symbol = default(string), string fromPrivateKey = default(string), bool provenance = default(bool), bool cashback = default(bool), bool publicMint = default(bool), decimal nonce = default(decimal), CustomFee fee = default(CustomFee))
        {
