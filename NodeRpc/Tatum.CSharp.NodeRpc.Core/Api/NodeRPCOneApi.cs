...
namespace Tatum.CSharp.NodeRpc.Core.Api
{
    ...
    public partial class NodeRPCOneApi : INodeRPCOneApi
    {
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public NodeRPCOneApi(HttpClient client, Tatum.CSharp.NodeRpc.Core.Client.Configuration configuration, HttpClientHandler handler = null)
        {
        ...
        public ApiResponse<Object> NodeJsonPostRpcDriverWithHttpInfo(Object body, string nodeType = default(string), string testnetType = default(string), string chainType = default(string))
        {
            ...
            if (body == null)
                throw new ApiException(400, "Missing required parameter 'body' when calling NodeRPCOneApi->NodeJsonPostRpcDriver");
            ...
            var localVarResponse = Client.Post<Object>("/v3/blockchain/node/ONE", localVarRequestOptions, Configuration);
        ...
        public async System.Threading.Tasks.Task<ApiResponse<Object>> NodeJsonPostRpcDriverWithHttpInfoAsync(Object body, string nodeType = default(string), string testnetType = default(string), string chainType = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var localVarResponse = await AsynchronousClient.PostAsync<Object>("/v3/blockchain/node/ONE", localVarRequestOptions, Configuration, cancellationToken).ConfigureAwait(false);
