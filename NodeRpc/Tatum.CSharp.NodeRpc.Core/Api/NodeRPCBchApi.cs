...
namespace Tatum.CSharp.NodeRpc.Core.Api
{
    ...
    /// </summary>
    public interface INodeRPCBchApiSync : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface INodeRPCBchApiWithHttpInfoSync : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface INodeRPCBchApiAsync : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface INodeRPCBchApiWithHttpInfoAsync : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface INodeRPCBchApi : INodeRPCBchApiSync, INodeRPCBchApiWithHttpInfoSync, INodeRPCBchApiAsync, INodeRPCBchApiWithHttpInfoAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class NodeRPCBchApi : INodeRPCBchApi
    {
        private ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="NodeRPCBchApi"/> class.
        /// </summary>
        ...
        /// </remarks>
        public NodeRPCBchApi(HttpClient client, HttpClientHandler handler = null) : this(client, (string)null, handler)
        {
        }
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public NodeRPCBchApi(HttpClient client, string basePath, HttpClientHandler handler = null)
        {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NodeRPCBchApi"/> class using Configuration object.
        /// </summary>
        /// <param name="client">An instance of HttpClient.</param>
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public NodeRPCBchApi(HttpClient client, Configuration configuration, HttpClientHandler handler = null)
        {
        ...
        /// <exception cref="ArgumentNullException"></exception>
        public NodeRPCBchApi(ISynchronousClient client, IAsynchronousClient asyncClient, IReadableConfiguration configuration)
        {
        ...
        public ApiResponse<Object> NodeJsonRpcPostDriverWithHttpInfo(string rpcPath, Object body, string nodeType = default(string), string testnetType = default(string), string chainType = default(string))
        {
            ...
            if (rpcPath == null)
                throw new ApiException(400, "Missing required parameter 'rpcPath' when calling NodeRPCBchApi->NodeJsonRpcPostDriver");

            // verify the required parameter 'body' is set
            if (body == null)
                throw new ApiException(400, "Missing required parameter 'body' when calling NodeRPCBchApi->NodeJsonRpcPostDriver");
            ...
            var localVarResponse = Client.Post<Object>("/v3/blockchain/node/BCH/{rpcPath}", localVarRequestOptions, Configuration);
        ...
        public async System.Threading.Tasks.Task<ApiResponse<Object>> NodeJsonRpcPostDriverWithHttpInfoAsync(string rpcPath, Object body, string nodeType = default(string), string testnetType = default(string), string chainType = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var localVarResponse = await AsynchronousClient.PostAsync<Object>("/v3/blockchain/node/BCH/{rpcPath}", localVarRequestOptions, Configuration, cancellationToken).ConfigureAwait(false);
