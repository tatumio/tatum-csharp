...
namespace Tatum.CSharp.NodeRpc.Core.Api
{
    ...
    /// </summary>
    public interface INodeRPCEthApiSync : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface INodeRPCEthApiWithHttpInfoSync : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface INodeRPCEthApiAsync : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface INodeRPCEthApiWithHttpInfoAsync : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface INodeRPCEthApi : INodeRPCEthApiSync, INodeRPCEthApiWithHttpInfoSync, INodeRPCEthApiAsync, INodeRPCEthApiWithHttpInfoAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class NodeRPCEthApi : INodeRPCEthApi
    {
        private ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="NodeRPCEthApi"/> class.
        /// </summary>
        ...
        /// </remarks>
        public NodeRPCEthApi(HttpClient client, HttpClientHandler handler = null) : this(client, (string)null, handler)
        {
        }
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public NodeRPCEthApi(HttpClient client, string basePath, HttpClientHandler handler = null)
        {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NodeRPCEthApi"/> class using Configuration object.
        /// </summary>
        /// <param name="client">An instance of HttpClient.</param>
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public NodeRPCEthApi(HttpClient client, Configuration configuration, HttpClientHandler handler = null)
        {
        ...
        /// <exception cref="ArgumentNullException"></exception>
        public NodeRPCEthApi(ISynchronousClient client, IAsynchronousClient asyncClient, IReadableConfiguration configuration)
        {
        ...
        public ApiResponse<Object> NodeJsonRpcPostDriverWithHttpInfo(string rpcPath, Object body, string nodeType = default(string), string testnetType = default(string), string chainType = default(string))
        {
            ...
            if (rpcPath == null)
                throw new ApiException(400, "Missing required parameter 'rpcPath' when calling NodeRPCEthApi->NodeJsonRpcPostDriver");

            // verify the required parameter 'body' is set
            if (body == null)
                throw new ApiException(400, "Missing required parameter 'body' when calling NodeRPCEthApi->NodeJsonRpcPostDriver");
            ...
            var localVarResponse = Client.Post<Object>("/v3/blockchain/node/ETH/{rpcPath}", localVarRequestOptions, Configuration);
        ...
        public async System.Threading.Tasks.Task<ApiResponse<Object>> NodeJsonRpcPostDriverWithHttpInfoAsync(string rpcPath, Object body, string nodeType = default(string), string testnetType = default(string), string chainType = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var localVarResponse = await AsynchronousClient.PostAsync<Object>("/v3/blockchain/node/ETH/{rpcPath}", localVarRequestOptions, Configuration, cancellationToken).ConfigureAwait(false);
