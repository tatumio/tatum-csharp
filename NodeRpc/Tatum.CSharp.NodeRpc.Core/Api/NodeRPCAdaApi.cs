...
namespace Tatum.CSharp.NodeRpc.Core.Api
{
    ...
    /// </summary>
    public interface INodeRPCAdaApiSync : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface INodeRPCAdaApiWithHttpInfoSync : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface INodeRPCAdaApiAsync : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface INodeRPCAdaApiWithHttpInfoAsync : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface INodeRPCAdaApi : INodeRPCAdaApiSync, INodeRPCAdaApiWithHttpInfoSync, INodeRPCAdaApiAsync, INodeRPCAdaApiWithHttpInfoAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class NodeRPCAdaApi : INodeRPCAdaApi
    {
        private ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="NodeRPCAdaApi"/> class.
        /// </summary>
        ...
        /// </remarks>
        public NodeRPCAdaApi(HttpClient client, HttpClientHandler handler = null) : this(client, (string)null, handler)
        {
        }
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public NodeRPCAdaApi(HttpClient client, string basePath, HttpClientHandler handler = null)
        {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NodeRPCAdaApi"/> class using Configuration object.
        /// </summary>
        /// <param name="client">An instance of HttpClient.</param>
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public NodeRPCAdaApi(HttpClient client, Configuration configuration, HttpClientHandler handler = null)
        {
        ...
        /// <exception cref="ArgumentNullException"></exception>
        public NodeRPCAdaApi(ISynchronousClient client, IAsynchronousClient asyncClient, IReadableConfiguration configuration)
        {
        ...
        public ApiResponse<Object> NodeJsonRpcPostDriverWithHttpInfo(string rpcPath, Object body, string nodeType = default(string), string testnetType = default(string), string chainType = default(string))
        {
            ...
            if (rpcPath == null)
                throw new ApiException(400, "Missing required parameter 'rpcPath' when calling NodeRPCAdaApi->NodeJsonRpcPostDriver");

            // verify the required parameter 'body' is set
            if (body == null)
                throw new ApiException(400, "Missing required parameter 'body' when calling NodeRPCAdaApi->NodeJsonRpcPostDriver");
            ...
            var localVarResponse = Client.Post<Object>("/v3/blockchain/node/ADA/{rpcPath}", localVarRequestOptions, Configuration);
        ...
        public async System.Threading.Tasks.Task<ApiResponse<Object>> NodeJsonRpcPostDriverWithHttpInfoAsync(string rpcPath, Object body, string nodeType = default(string), string testnetType = default(string), string chainType = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var localVarResponse = await AsynchronousClient.PostAsync<Object>("/v3/blockchain/node/ADA/{rpcPath}", localVarRequestOptions, Configuration, cancellationToken).ConfigureAwait(false);
