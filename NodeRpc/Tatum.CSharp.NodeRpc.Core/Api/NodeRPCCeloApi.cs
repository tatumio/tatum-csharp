...
namespace Tatum.CSharp.NodeRpc.Core.Api
{
    ...
    /// </summary>
    public interface INodeRPCCeloApiSync : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface INodeRPCCeloApiWithHttpInfoSync : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface INodeRPCCeloApiAsync : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface INodeRPCCeloApiWithHttpInfoAsync : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface INodeRPCCeloApi : INodeRPCCeloApiSync, INodeRPCCeloApiWithHttpInfoSync, INodeRPCCeloApiAsync, INodeRPCCeloApiWithHttpInfoAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class NodeRPCCeloApi : INodeRPCCeloApi
    {
        private ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="NodeRPCCeloApi"/> class.
        /// </summary>
        ...
        /// </remarks>
        public NodeRPCCeloApi(HttpClient client, HttpClientHandler handler = null) : this(client, (string)null, handler)
        {
        }
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public NodeRPCCeloApi(HttpClient client, string basePath, HttpClientHandler handler = null)
        {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NodeRPCCeloApi"/> class using Configuration object.
        /// </summary>
        /// <param name="client">An instance of HttpClient.</param>
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public NodeRPCCeloApi(HttpClient client, Configuration configuration, HttpClientHandler handler = null)
        {
        ...
        /// <exception cref="ArgumentNullException"></exception>
        public NodeRPCCeloApi(ISynchronousClient client, IAsynchronousClient asyncClient, IReadableConfiguration configuration)
        {
        ...
        public ApiResponse<Object> NodeJsonRpcPostDriverWithHttpInfo(string rpcPath, Object body, string nodeType = default(string), string testnetType = default(string), string chainType = default(string))
        {
            ...
            if (rpcPath == null)
                throw new ApiException(400, "Missing required parameter 'rpcPath' when calling NodeRPCCeloApi->NodeJsonRpcPostDriver");

            // verify the required parameter 'body' is set
            if (body == null)
                throw new ApiException(400, "Missing required parameter 'body' when calling NodeRPCCeloApi->NodeJsonRpcPostDriver");
            ...
            var localVarResponse = Client.Post<Object>("/v3/blockchain/node/CELO/{rpcPath}", localVarRequestOptions, Configuration);
        ...
        public async System.Threading.Tasks.Task<ApiResponse<Object>> NodeJsonRpcPostDriverWithHttpInfoAsync(string rpcPath, Object body, string nodeType = default(string), string testnetType = default(string), string chainType = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var localVarResponse = await AsynchronousClient.PostAsync<Object>("/v3/blockchain/node/CELO/{rpcPath}", localVarRequestOptions, Configuration, cancellationToken).ConfigureAwait(false);
