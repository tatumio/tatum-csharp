...
namespace Tatum.CSharp.Harmony.Core.Model
{
    ...
    public partial class BurnNft : IEquatable<BurnNft>, IValidatableObject
    {
        ...
        public BurnNft(string tokenId = default(string), string contractAddress = default(string), string fromPrivateKey = default(string), decimal nonce = default(decimal), CustomFee fee = default(CustomFee))
        {
