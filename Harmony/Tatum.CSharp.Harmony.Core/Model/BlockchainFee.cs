...
namespace Tatum.CSharp.Harmony.Core.Model
{
    ...
    public partial class BlockchainFee : IEquatable<BlockchainFee>, IValidatableObject
    {
        ...
        public BlockchainFee(decimal fast = default(decimal), decimal medium = default(decimal), decimal slow = default(decimal), decimal baseFee = default(decimal), string time = default(string), decimal block = default(decimal))
        {
            this.Fast = fast;
            this.Medium = medium;
            this.Slow = slow;
