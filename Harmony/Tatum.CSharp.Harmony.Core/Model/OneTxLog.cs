...
namespace Tatum.CSharp.Harmony.Core.Model
{
    ...
    /// OneTxLog
    /// </summary>
    [DataContract(Name = "OneTxLog")]
    public partial class OneTxLog : IEquatable<OneTxLog>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OneTxLog" /> class.
        /// </summary>
        ...
        public OneTxLog(string address = default(string), List<string> topics = default(List<string>), string data = default(string), decimal logIndex = default(decimal), decimal blockNumber = default(decimal), string blockHash = default(string), decimal transactionIndex = default(decimal), string transactionHash = default(string))
        {
        ...
        {
            return this.Equals(input as OneTxLog);
        }

        /// <summary>
        /// Returns true if OneTxLog instances are equal
        /// </summary>
        /// <param name="input">Instance of OneTxLog to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OneTxLog input)
        {
            if (input == null)
            {
                return false;
