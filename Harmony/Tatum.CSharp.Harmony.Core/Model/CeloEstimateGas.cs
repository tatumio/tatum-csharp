...
namespace Tatum.CSharp.Harmony.Core.Model
{
    ...
    /// CeloEstimateGas
    /// </summary>
    [DataContract(Name = "CeloEstimateGas")]
    public partial class CeloEstimateGas : IEquatable<CeloEstimateGas>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CeloEstimateGas" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CeloEstimateGas() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CeloEstimateGas" /> class.
        /// </summary>
        ...
        public CeloEstimateGas(string from = default(string), string to = default(string), string amount = default(string), string data = default(string))
        {
            // to ensure "from" is required (not null)
            if (from == null)
            {
                throw new ArgumentNullException("from is a required property for CeloEstimateGas and cannot be null");
            }
            this.From = from;
            // to ensure "to" is required (not null)
            if (to == null)
            {
                throw new ArgumentNullException("to is a required property for CeloEstimateGas and cannot be null");
            }
            this.To = to;
            // to ensure "amount" is required (not null)
            if (amount == null)
            {
                throw new ArgumentNullException("amount is a required property for CeloEstimateGas and cannot be null");
            }
            this.Amount = amount;
            this.Data = data;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CeloEstimateGas {\n");
        ...
        {
            return this.Equals(input as CeloEstimateGas);
        }

        /// <summary>
        /// Returns true if CeloEstimateGas instances are equal
        /// </summary>
        /// <param name="input">Instance of CeloEstimateGas to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CeloEstimateGas input)
        {
            if (input == null)
            {
                return false;
