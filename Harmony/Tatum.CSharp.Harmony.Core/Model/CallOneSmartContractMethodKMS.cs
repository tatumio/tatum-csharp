...
namespace Tatum.CSharp.Harmony.Core.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CallOneSmartContractMethodKMS")]
    public partial class CallOneSmartContractMethodKMS : IEquatable<CallOneSmartContractMethodKMS>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CallOneSmartContractMethodKMS" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CallOneSmartContractMethodKMS() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CallOneSmartContractMethodKMS" /> class.
        /// </summary>
        ...
        public CallOneSmartContractMethodKMS(string contractAddress = default(string), string methodName = default(string), Object methodABI = default(Object), List<string> _params = default(List<string>), decimal index = default(decimal), Guid signatureId = default(Guid), decimal nonce = default(decimal), CustomFee fee = default(CustomFee))
        {
            // to ensure "contractAddress" is required (not null)
            if (contractAddress == null)
            {
                throw new ArgumentNullException("contractAddress is a required property for CallOneSmartContractMethodKMS and cannot be null");
            }
            this.ContractAddress = contractAddress;
            // to ensure "methodName" is required (not null)
            if (methodName == null)
            {
                throw new ArgumentNullException("methodName is a required property for CallOneSmartContractMethodKMS and cannot be null");
            }
            this.MethodName = methodName;
            // to ensure "methodABI" is required (not null)
            if (methodABI == null)
            {
                throw new ArgumentNullException("methodABI is a required property for CallOneSmartContractMethodKMS and cannot be null");
            }
            this.MethodABI = methodABI;
            // to ensure "_params" is required (not null)
            if (_params == null)
            {
                throw new ArgumentNullException("_params is a required property for CallOneSmartContractMethodKMS and cannot be null");
            }
            this.Params = _params;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CallOneSmartContractMethodKMS {\n");
        ...
        {
            return this.Equals(input as CallOneSmartContractMethodKMS);
        }

        /// <summary>
        /// Returns true if CallOneSmartContractMethodKMS instances are equal
        /// </summary>
        /// <param name="input">Instance of CallOneSmartContractMethodKMS to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CallOneSmartContractMethodKMS input)
        {
            if (input == null)
            {
                return false;
