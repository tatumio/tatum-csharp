...
namespace Tatum.CSharp.Harmony.Core.Model
{
    ...
    /// OneTx
    /// </summary>
    [DataContract(Name = "OneTx")]
    public partial class OneTx : IEquatable<OneTx>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OneTx" /> class.
        /// </summary>
        ...
        public OneTx(string blockHash = default(string), bool status = default(bool), decimal? blockNumber = default(decimal?), string from = default(string), decimal gas = default(decimal), string gasPrice = default(string), string transactionHash = default(string), string input = default(string), decimal nonce = default(decimal), string to = default(string), decimal? transactionIndex = default(decimal?), string value = default(string), decimal? gasUsed = default(decimal?), decimal? cumulativeGasUsed = default(decimal?), string contractAddress = default(string), List<OneTxLog> logs = default(List<OneTxLog>))
        {
        ...
        public List<OneTxLog> Logs { get; set; }
        ...
        {
            return this.Equals(input as OneTx);
        }

        /// <summary>
        /// Returns true if OneTx instances are equal
        /// </summary>
        /// <param name="input">Instance of OneTx to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OneTx input)
        {
            if (input == null)
            {
                return false;
