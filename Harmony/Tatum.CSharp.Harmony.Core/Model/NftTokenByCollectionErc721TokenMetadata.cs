...
namespace Tatum.CSharp.Harmony.Core.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NftTokenByCollectionErc721TokenMetadata")]
    public partial class NftTokenByCollectionErc721TokenMetadata : IEquatable<NftTokenByCollectionErc721TokenMetadata>, IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>Metadata URL of the TokenID. This data don&#39;t have to be present, safest way (if not present) is to obtain them from the NFT Contract.tokenURI() method call.</value>
        ...
        /// </summary>
        /// <value>Metadata scheme obtained from the url. This data don&#39;t have to be present, safest way (if not present) is to obtain them from the NFT Contract.tokenURI() method call.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NftTokenByCollectionErc721TokenMetadata {\n");
        ...
        {
            return this.Equals(input as NftTokenByCollectionErc721TokenMetadata);
        }

        /// <summary>
        /// Returns true if NftTokenByCollectionErc721TokenMetadata instances are equal
        /// </summary>
        /// <param name="input">Instance of NftTokenByCollectionErc721TokenMetadata to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NftTokenByCollectionErc721TokenMetadata input)
        {
            if (input == null)
            {
                return false;
