...
namespace Tatum.CSharp.Harmony.Core.Model
{
    ...
    /// MultiTokenMetadata
    /// </summary>
    [DataContract(Name = "MultiTokenMetadata")]
    public partial class MultiTokenMetadata : IEquatable<MultiTokenMetadata>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MultiTokenMetadata" /> class.
        /// </summary>
        /// <param name="data">Metadata associated with token..</param>
        public MultiTokenMetadata(string data = default(string))
        {
            this.Data = data;
        }
        ...
        /// </summary>
        /// <value>Metadata associated with token.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MultiTokenMetadata {\n");
        ...
        {
            return this.Equals(input as MultiTokenMetadata);
        }

        /// <summary>
        /// Returns true if MultiTokenMetadata instances are equal
        /// </summary>
        /// <param name="input">Instance of MultiTokenMetadata to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MultiTokenMetadata input)
        {
            if (input == null)
            {
                return false;
