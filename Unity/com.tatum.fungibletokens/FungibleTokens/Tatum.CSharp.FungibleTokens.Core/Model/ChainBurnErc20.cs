...
namespace Tatum.CSharp.FungibleTokens.Core.Model
{
    ...
    /// ChainBurnErc20
    /// </summary>
    [DataContract(Name = "ChainBurnErc20")]
    public partial class ChainBurnErc20 : IEquatable<ChainBurnErc20>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ChainBurnErc20" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ChainBurnErc20() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ChainBurnErc20" /> class.
        /// </summary>
        ...
        public ChainBurnErc20(ChainEnum chain = default(ChainEnum), string amount = default(string), string contractAddress = default(string), string fromPrivateKey = default(string), CustomFee fee = default(CustomFee), decimal nonce = default(decimal))
        {
            this.Chain = chain;
            // to ensure "amount" is required (not null)
            if (amount == null)
            {
                throw new ArgumentNullException("amount is a required property for ChainBurnErc20 and cannot be null");
            }
            this.Amount = amount;
            // to ensure "contractAddress" is required (not null)
            if (contractAddress == null)
            {
                throw new ArgumentNullException("contractAddress is a required property for ChainBurnErc20 and cannot be null");
            }
            this.ContractAddress = contractAddress;
            // to ensure "fromPrivateKey" is required (not null)
            if (fromPrivateKey == null)
            {
                throw new ArgumentNullException("fromPrivateKey is a required property for ChainBurnErc20 and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ChainBurnErc20 {\n");
        ...
        {
            return this.Equals(input as ChainBurnErc20);
        }

        /// <summary>
        /// Returns true if ChainBurnErc20 instances are equal
        /// </summary>
        /// <param name="input">Instance of ChainBurnErc20 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ChainBurnErc20 input)
        {
            if (input == null)
            {
                return false;
