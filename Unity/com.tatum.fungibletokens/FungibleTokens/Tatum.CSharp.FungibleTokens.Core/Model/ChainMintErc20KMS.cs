...
namespace Tatum.CSharp.FungibleTokens.Core.Model
{
    ...
    /// ChainMintErc20KMS
    /// </summary>
    [DataContract(Name = "ChainMintErc20KMS")]
    public partial class ChainMintErc20KMS : IEquatable<ChainMintErc20KMS>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ChainMintErc20KMS" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ChainMintErc20KMS() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ChainMintErc20KMS" /> class.
        /// </summary>
        ...
        public ChainMintErc20KMS(ChainEnum chain = default(ChainEnum), string amount = default(string), string to = default(string), string contractAddress = default(string), Guid signatureId = default(Guid), decimal nonce = default(decimal))
        {
            this.Chain = chain;
            // to ensure "amount" is required (not null)
            if (amount == null)
            {
                throw new ArgumentNullException("amount is a required property for ChainMintErc20KMS and cannot be null");
            }
            this.Amount = amount;
            // to ensure "to" is required (not null)
            if (to == null)
            {
                throw new ArgumentNullException("to is a required property for ChainMintErc20KMS and cannot be null");
            }
            this.To = to;
            // to ensure "contractAddress" is required (not null)
            if (contractAddress == null)
            {
                throw new ArgumentNullException("contractAddress is a required property for ChainMintErc20KMS and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ChainMintErc20KMS {\n");
        ...
        {
            return this.Equals(input as ChainMintErc20KMS);
        }

        /// <summary>
        /// Returns true if ChainMintErc20KMS instances are equal
        /// </summary>
        /// <param name="input">Instance of ChainMintErc20KMS to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ChainMintErc20KMS input)
        {
            if (input == null)
            {
                return false;
