...
namespace Tatum.CSharp.MultiTokens.Core.Model
{
    ...
    /// AddMultiTokenMinter
    /// </summary>
    [DataContract(Name = "AddMultiTokenMinter")]
    public partial class AddMultiTokenMinter : IEquatable<AddMultiTokenMinter>, IValidatableObject
    {
        /// <summary>
        /// Chain to work with.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AddMultiTokenMinter" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AddMultiTokenMinter() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AddMultiTokenMinter" /> class.
        /// </summary>
        ...
        public AddMultiTokenMinter(ChainEnum chain = default(ChainEnum), string contractAddress = default(string), string minter = default(string), string fromPrivateKey = default(string), decimal nonce = default(decimal), CustomFee fee = default(CustomFee), FeeCurrencyEnum? feeCurrency = default(FeeCurrencyEnum?))
        {
            this.Chain = chain;
            // to ensure "contractAddress" is required (not null)
            if (contractAddress == null)
            {
                throw new ArgumentNullException("contractAddress is a required property for AddMultiTokenMinter and cannot be null");
            }
            this.ContractAddress = contractAddress;
            // to ensure "minter" is required (not null)
            if (minter == null)
            {
                throw new ArgumentNullException("minter is a required property for AddMultiTokenMinter and cannot be null");
            }
            this.Minter = minter;
            // to ensure "fromPrivateKey" is required (not null)
            if (fromPrivateKey == null)
            {
                throw new ArgumentNullException("fromPrivateKey is a required property for AddMultiTokenMinter and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AddMultiTokenMinter {\n");
        ...
        {
            return this.Equals(input as AddMultiTokenMinter);
        }

        /// <summary>
        /// Returns true if AddMultiTokenMinter instances are equal
        /// </summary>
        /// <param name="input">Instance of AddMultiTokenMinter to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AddMultiTokenMinter input)
        {
            if (input == null)
            {
                return false;
