...
namespace Tatum.CSharp.MultiTokens.Core.Model
{
    ...
    public partial class BurnMultiTokenBatchKMS : IEquatable<BurnMultiTokenBatchKMS>, IValidatableObject
    {
        ...
        public BurnMultiTokenBatchKMS(ChainEnum chain = default(ChainEnum), string account = default(string), List<string> tokenId = default(List<string>), List<string> amounts = default(List<string>), string data = default(string), string contractAddress = default(string), decimal index = default(decimal), Guid signatureId = default(Guid), decimal nonce = default(decimal), CustomFee fee = default(CustomFee))
        {
            this.Chain = chain;
