...
namespace Tatum.CSharp.Harmony.Core.Model
{
    ...
    public partial class TransferMultiTokenBatchKMS : IEquatable<TransferMultiTokenBatchKMS>, IValidatableObject
    {
        ...
        public TransferMultiTokenBatchKMS(string to = default(string), List<string> tokenId = default(List<string>), List<string> amount = default(List<string>), string data = default(string), string contractAddress = default(string), decimal index = default(decimal), Guid signatureId = default(Guid), decimal nonce = default(decimal), CustomFee fee = default(CustomFee))
        {
