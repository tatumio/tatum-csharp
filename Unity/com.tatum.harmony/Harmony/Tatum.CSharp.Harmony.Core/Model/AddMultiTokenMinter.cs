...
namespace Tatum.CSharp.Harmony.Core.Model
{
    ...
    public partial class AddMultiTokenMinter : IEquatable<AddMultiTokenMinter>, IValidatableObject
    {
        ...
        public AddMultiTokenMinter(string contractAddress = default(string), string minter = default(string), string fromPrivateKey = default(string), decimal nonce = default(decimal), CustomFee fee = default(CustomFee), FeeCurrencyEnum? feeCurrency = default(FeeCurrencyEnum?))
        {
