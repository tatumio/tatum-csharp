...
namespace Tatum.CSharp.Harmony.Core.Model
{
    ...
    public partial class MintMultiTokenBatchKMS : IEquatable<MintMultiTokenBatchKMS>, IValidatableObject
    {
        ...
        public MintMultiTokenBatchKMS(List<string> to = default(List<string>), List<List<string>> tokenId = default(List<List<string>>), List<List<string>> amounts = default(List<List<string>>), string data = default(string), string contractAddress = default(string), decimal index = default(decimal), Guid signatureId = default(Guid), decimal nonce = default(decimal), CustomFee fee = default(CustomFee))
        {
