...
namespace Tatum.CSharp.BlockchainFees.Core.Api
{
    ...
    /// </summary>
    public interface IBlockchainFeesBscApiSync : IApiAccessor
    {
        ...
        GasEstimated BscEstimateGas(BscEstimateGas bscEstimateGas);
        /// <summary>
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IBlockchainFeesBscApiWithHttpInfoSync : IApiAccessor
    {
        ...
        ApiResponse<GasEstimated> BscEstimateGasWithHttpInfo(BscEstimateGas bscEstimateGas);
        /// <summary>
        /// Estimate the fee for a transaction on a blockchain
        /// </summary>
        /// <remarks>
    ...
    public interface IBlockchainFeesBscApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<GasEstimated> BscEstimateGasAsync(BscEstimateGas bscEstimateGas, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Estimate the fee for a transaction on a blockchain
        /// </summary>
        /// <remarks>
    ...
    public interface IBlockchainFeesBscApiWithHttpInfoAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<ApiResponse<GasEstimated>> BscEstimateGasWithHttpInfoAsync(BscEstimateGas bscEstimateGas, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Estimate the fee for a transaction on a blockchain
        /// </summary>
        /// <remarks>
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IBlockchainFeesBscApi : IBlockchainFeesBscApiSync, IBlockchainFeesBscApiWithHttpInfoSync, IBlockchainFeesBscApiAsync, IBlockchainFeesBscApiWithHttpInfoAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class BlockchainFeesBscApi : IBlockchainFeesBscApi
    {
        private ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="BlockchainFeesBscApi"/> class.
        /// </summary>
        ...
        /// </remarks>
        public BlockchainFeesBscApi(HttpClient client, HttpClientHandler handler = null) : this(client, (string)null, handler)
        {
        }
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public BlockchainFeesBscApi(HttpClient client, string basePath, HttpClientHandler handler = null)
        {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BlockchainFeesBscApi"/> class using Configuration object.
        /// </summary>
        /// <param name="client">An instance of HttpClient.</param>
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public BlockchainFeesBscApi(HttpClient client, Tatum.CSharp.BlockchainFees.Core.Client.Configuration configuration, HttpClientHandler handler = null)
        {
        ...
        /// <exception cref="ArgumentNullException"></exception>
        public BlockchainFeesBscApi(ISynchronousClient client, IAsynchronousClient asyncClient, IReadableConfiguration configuration)
        {
        ...
        /// <summary>
        /// Estimate the fee for a BNB Smart Chain transaction 2 credits per API call Get an estimated gas price and the number of gas units needed for a BNB Smart Chain transaction. The gas price is obtained from https://explorer.bitquery.io/bsc/gas. NOTE: The estimated gas price is returned in wei. However, when making the transaction itself and providing the custom fee, you have to provide the gas price in Gwei. Make sure to convert the estimated gas price from wei to Gwei before submitting your transaction.
        /// </summary>
        /// <exception cref="Tatum.CSharp.BlockchainFees.Core.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="bscEstimateGas"></param>
        /// <returns>GasEstimated</returns>
        public GasEstimated BscEstimateGas(BscEstimateGas bscEstimateGas)
        {
        ...
        /// <param name="bscEstimateGas"></param>
        /// <returns>ApiResponse of GasEstimated</returns>
        public ApiResponse<GasEstimated> BscEstimateGasWithHttpInfo(BscEstimateGas bscEstimateGas)
        {
            ...
            var localVarResponse = Client.Post<GasEstimated>("/v3/bsc/gas", localVarRequestOptions, Configuration);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of GasEstimated</returns>
        public async System.Threading.Tasks.Task<GasEstimated> BscEstimateGasAsync(BscEstimateGas bscEstimateGas, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (GasEstimated)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<GasEstimated>> BscEstimateGasWithHttpInfoAsync(BscEstimateGas bscEstimateGas, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'bscEstimateGas' is set
            if (bscEstimateGas == null)
                throw new ApiException(400, "Missing required parameter 'bscEstimateGas' when calling BlockchainFeesBscApi->BscEstimateGas");
            ...
            var localVarResponse = await AsynchronousClient.PostAsync<GasEstimated>("/v3/bsc/gas", localVarRequestOptions, Configuration, cancellationToken).ConfigureAwait(false);
        ...
        public ApiResponse<FeeETH> EstimateFeeBlockchainWithHttpInfo(EstimateFee estimateFee)
        {
            ...
            if (estimateFee == null)
                throw new ApiException(400, "Missing required parameter 'estimateFee' when calling BlockchainFeesBscApi->EstimateFeeBlockchain");
        ...
        public ApiResponse<FeeETH> EstimateFeeBlockchainWithHttpInfo(EstimateFeeBatchMintNft estimateFeeBatchMintNft)
        {
            ...
            if (estimateFeeBatchMintNft == null)
                throw new ApiException(400, "Missing required parameter 'estimateFeeBatchMintNft' when calling BlockchainFeesBscApi->EstimateFeeBlockchain_0");
        ...
        public ApiResponse<FeeETH> EstimateFeeBlockchainWithHttpInfo(EstimateFeeDeployCustodialWallet estimateFeeDeployCustodialWallet)
        {
            ...
            if (estimateFeeDeployCustodialWallet == null)
                throw new ApiException(400, "Missing required parameter 'estimateFeeDeployCustodialWallet' when calling BlockchainFeesBscApi->EstimateFeeBlockchain_1");
        ...
        public ApiResponse<FeeETH> EstimateFeeBlockchainWithHttpInfo(EstimateFeeTransferFromCustodial estimateFeeTransferFromCustodial)
        {
            ...
            if (estimateFeeTransferFromCustodial == null)
                throw new ApiException(400, "Missing required parameter 'estimateFeeTransferFromCustodial' when calling BlockchainFeesBscApi->EstimateFeeBlockchain_2");
