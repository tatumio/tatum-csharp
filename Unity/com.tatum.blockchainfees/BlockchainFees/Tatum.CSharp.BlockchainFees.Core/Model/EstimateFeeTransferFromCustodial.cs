...
namespace Tatum.CSharp.BlockchainFees.Core.Model
{
    ...
    public partial class EstimateFeeTransferFromCustodial : IEquatable<EstimateFeeTransferFromCustodial>, IValidatableObject
    {
        ...
        public EstimateFeeTransferFromCustodial(ChainEnum chain = default(ChainEnum), TypeEnum type = default(TypeEnum), string sender = default(string), string recipient = default(string), string custodialAddress = default(string), TokenTypeEnum tokenType = default(TokenTypeEnum), string amount = default(string), string contractAddress = default(string))
        {
            this.Chain = chain;
            this.Type = type;
