...
namespace Tatum.CSharp.Solana.Core.Model
{
    ...
    /// SolBalance
    /// </summary>
    [DataContract(Name = "SolBalance")]
    public partial class SolBalance : IEquatable<SolBalance>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SolBalance" /> class.
        /// </summary>
        /// <param name="balance">Balance in SOL.</param>
        public SolBalance(string balance = default(string))
        {
        ...
        {
            return this.Equals(input as SolBalance);
        }

        /// <summary>
        /// Returns true if SolBalance instances are equal
        /// </summary>
        /// <param name="input">Instance of SolBalance to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SolBalance input)
        {
            if (input == null)
            {
                return false;
