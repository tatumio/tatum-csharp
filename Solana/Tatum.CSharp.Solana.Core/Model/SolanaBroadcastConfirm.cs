...
namespace Tatum.CSharp.Solana.Core.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SolanaBroadcastConfirm")]
    public partial class SolanaBroadcastConfirm : IEquatable<SolanaBroadcastConfirm>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SolanaBroadcastConfirm" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SolanaBroadcastConfirm() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SolanaBroadcastConfirm" /> class.
        /// </summary>
        /// <param name="txData">Raw signed transaction to be published to network. (required).</param>
        /// <param name="options">options.</param>
        public SolanaBroadcastConfirm(string txData = default(string), SolanaBroadcastConfirmOptions options = default(SolanaBroadcastConfirmOptions))
        {
            // to ensure "txData" is required (not null)
            if (txData == null)
            {
                throw new ArgumentNullException("txData is a required property for SolanaBroadcastConfirm and cannot be null");
            }
            this.TxData = txData;
        ...
        public SolanaBroadcastConfirmOptions Options { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SolanaBroadcastConfirm {\n");
        ...
        {
            return this.Equals(input as SolanaBroadcastConfirm);
        }

        /// <summary>
        /// Returns true if SolanaBroadcastConfirm instances are equal
        /// </summary>
        /// <param name="input">Instance of SolanaBroadcastConfirm to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SolanaBroadcastConfirm input)
        {
            if (input == null)
            {
                return false;
