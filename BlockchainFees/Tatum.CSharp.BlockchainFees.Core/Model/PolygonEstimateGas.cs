...
namespace Tatum.CSharp.BlockchainFees.Core.Model
{
    ...
    /// PolygonEstimateGas
    /// </summary>
    [DataContract(Name = "PolygonEstimateGas")]
    public partial class PolygonEstimateGas : IEquatable<PolygonEstimateGas>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PolygonEstimateGas" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PolygonEstimateGas() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PolygonEstimateGas" /> class.
        /// </summary>
        ...
        public PolygonEstimateGas(string from = default(string), string to = default(string), string amount = default(string), string data = default(string))
        {
            ...
            if (from == null)
            {
                throw new ArgumentNullException("from is a required property for PolygonEstimateGas and cannot be null");
            }
            this.From = from;
            // to ensure "to" is required (not null)
            if (to == null)
            {
                throw new ArgumentNullException("to is a required property for PolygonEstimateGas and cannot be null");
            }
            this.To = to;
            // to ensure "amount" is required (not null)
            if (amount == null)
            {
                throw new ArgumentNullException("amount is a required property for PolygonEstimateGas and cannot be null");
            }
            this.Amount = amount;
            this.Data = data;
        }
        ...
        /// </summary>
        /// <value>Amount to be sent in MATIC.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PolygonEstimateGas {\n");
        ...
        {
            return this.Equals(input as PolygonEstimateGas);
        }

        /// <summary>
        /// Returns true if PolygonEstimateGas instances are equal
        /// </summary>
        /// <param name="input">Instance of PolygonEstimateGas to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PolygonEstimateGas input)
        {
            if (input == null)
            {
                return false;
