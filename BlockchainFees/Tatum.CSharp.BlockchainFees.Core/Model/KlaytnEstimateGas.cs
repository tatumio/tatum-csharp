...
namespace Tatum.CSharp.BlockchainFees.Core.Model
{
    ...
    /// KlaytnEstimateGas
    /// </summary>
    [DataContract(Name = "KlaytnEstimateGas")]
    public partial class KlaytnEstimateGas : IEquatable<KlaytnEstimateGas>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="KlaytnEstimateGas" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected KlaytnEstimateGas() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="KlaytnEstimateGas" /> class.
        /// </summary>
        /// <param name="from">Sender address. (required).</param>
        /// <param name="to">Blockchain address to send assets (required).</param>
        /// <param name="amount">Amount to be sent in KLAY. (required).</param>
        ...
        public KlaytnEstimateGas(string from = default(string), string to = default(string), string amount = default(string), string data = default(string))
        {
            // to ensure "from" is required (not null)
            if (from == null)
            {
                throw new ArgumentNullException("from is a required property for KlaytnEstimateGas and cannot be null");
            }
            this.From = from;
            // to ensure "to" is required (not null)
            if (to == null)
            {
                throw new ArgumentNullException("to is a required property for KlaytnEstimateGas and cannot be null");
            }
            this.To = to;
            // to ensure "amount" is required (not null)
            if (amount == null)
            {
                throw new ArgumentNullException("amount is a required property for KlaytnEstimateGas and cannot be null");
            }
            this.Amount = amount;
            this.Data = data;
        }
        ...
        /// </summary>
        /// <value>Amount to be sent in KLAY.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class KlaytnEstimateGas {\n");
        ...
        {
            return this.Equals(input as KlaytnEstimateGas);
        }

        /// <summary>
        /// Returns true if KlaytnEstimateGas instances are equal
        /// </summary>
        /// <param name="input">Instance of KlaytnEstimateGas to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KlaytnEstimateGas input)
        {
            if (input == null)
            {
                return false;
