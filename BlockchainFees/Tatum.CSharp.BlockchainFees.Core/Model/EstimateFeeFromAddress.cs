...
namespace Tatum.CSharp.BlockchainFees.Core.Model
{
    ...
    public partial class EstimateFeeFromAddress : IEquatable<EstimateFeeFromAddress>, IValidatableObject
    {
        ...
        public EstimateFeeFromAddress(ChainEnum chain = default(ChainEnum), TypeEnum type = default(TypeEnum), List<string> fromAddress = default(List<string>), List<Object> to = default(List<Object>))
        {
            this.Chain = chain;
            this.Type = type;
