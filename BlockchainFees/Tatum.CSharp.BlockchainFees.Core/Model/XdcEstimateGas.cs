...
namespace Tatum.CSharp.BlockchainFees.Core.Model
{
    ...
    /// XdcEstimateGas
    /// </summary>
    [DataContract(Name = "XdcEstimateGas")]
    public partial class XdcEstimateGas : IEquatable<XdcEstimateGas>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="XdcEstimateGas" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected XdcEstimateGas() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="XdcEstimateGas" /> class.
        /// </summary>
        /// <param name="from">Sender address. (required).</param>
        /// <param name="to">Blockchain address to send assets (required).</param>
        /// <param name="amount">Amount to be sent in XDC. (required).</param>
        public XdcEstimateGas(string from = default(string), string to = default(string), string amount = default(string))
        {
            // to ensure "from" is required (not null)
            if (from == null)
            {
                throw new ArgumentNullException("from is a required property for XdcEstimateGas and cannot be null");
            }
            this.From = from;
            // to ensure "to" is required (not null)
            if (to == null)
            {
                throw new ArgumentNullException("to is a required property for XdcEstimateGas and cannot be null");
            }
            this.To = to;
            // to ensure "amount" is required (not null)
            if (amount == null)
            {
                throw new ArgumentNullException("amount is a required property for XdcEstimateGas and cannot be null");
            }
            this.Amount = amount;
        }
        ...
        /// </summary>
        /// <value>Amount to be sent in XDC.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class XdcEstimateGas {\n");
        ...
        {
            return this.Equals(input as XdcEstimateGas);
        }

        /// <summary>
        /// Returns true if XdcEstimateGas instances are equal
        /// </summary>
        /// <param name="input">Instance of XdcEstimateGas to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(XdcEstimateGas input)
        {
            if (input == null)
            {
                return false;
