...
namespace Tatum.CSharp.MultiTokens.Core.Model
{
    ...
    public partial class TransferMultiTokenKMS : IEquatable<TransferMultiTokenKMS>, IValidatableObject
    {
        ...
        public TransferMultiTokenKMS(ChainEnum chain = default(ChainEnum), string to = default(string), string tokenId = default(string), string amount = default(string), string data = default(string), string contractAddress = default(string), decimal index = default(decimal), Guid signatureId = default(Guid), decimal nonce = default(decimal), CustomFee fee = default(CustomFee))
        {
            this.Chain = chain;
