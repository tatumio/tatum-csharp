...
namespace Tatum.CSharp.MultiTokens.Core.Model
{
    ...
    public partial class MintMultiTokenKMS : IEquatable<MintMultiTokenKMS>, IValidatableObject
    {
        ...
        public MintMultiTokenKMS(ChainEnum chain = default(ChainEnum), string tokenId = default(string), string to = default(string), string contractAddress = default(string), string amount = default(string), string data = default(string), decimal index = default(decimal), Guid signatureId = default(Guid), decimal nonce = default(decimal), CustomFee fee = default(CustomFee))
        {
            this.Chain = chain;
