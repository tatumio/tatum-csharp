...
namespace Tatum.CSharp.MultiTokens.Core.Api
{
    ...
    /// </summary>
    public interface IMultiTokensBscApiSync : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IMultiTokensBscApiWithHttpInfoSync : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IMultiTokensBscApiAsync : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IMultiTokensBscApiWithHttpInfoAsync : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IMultiTokensBscApi : IMultiTokensBscApiSync, IMultiTokensBscApiWithHttpInfoSync, IMultiTokensBscApiAsync, IMultiTokensBscApiWithHttpInfoAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class MultiTokensBscApi : IMultiTokensBscApi
    {
        private ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="MultiTokensBscApi"/> class.
        /// </summary>
        ...
        /// </remarks>
        public MultiTokensBscApi(HttpClient client, HttpClientHandler handler = null) : this(client, (string)null, handler)
        {
        }
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public MultiTokensBscApi(HttpClient client, string basePath, HttpClientHandler handler = null)
        {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MultiTokensBscApi"/> class using Configuration object.
        /// </summary>
        /// <param name="client">An instance of HttpClient.</param>
        ...
        /// <exception cref="ArgumentNullException"></exception>
        public MultiTokensBscApi(ISynchronousClient client, IAsynchronousClient asyncClient, IReadableConfiguration configuration)
        {
        ...
        public ApiResponse<TransactionHash> AddMultiTokenMinterWithHttpInfo(AddMultiTokenMinter addMultiTokenMinter, string xTestnetType = default(string))
        {
            ...
            if (addMultiTokenMinter == null)
                throw new ApiException(400, "Missing required parameter 'addMultiTokenMinter' when calling MultiTokensBscApi->AddMultiTokenMinter");
        ...
        public ApiResponse<SignatureId> AddMultiTokenMinterWithHttpInfo(AddMultiTokenMinterKMS addMultiTokenMinterKMS, string xTestnetType = default(string))
        {
            ...
            if (addMultiTokenMinterKMS == null)
                throw new ApiException(400, "Missing required parameter 'addMultiTokenMinterKMS' when calling MultiTokensBscApi->AddMultiTokenMinter_0");
        ...
        public ApiResponse<TransactionHash> BurnMultiTokenWithHttpInfo(BurnMultiToken burnMultiToken, string xTestnetType = default(string))
        {
            ...
            if (burnMultiToken == null)
                throw new ApiException(400, "Missing required parameter 'burnMultiToken' when calling MultiTokensBscApi->BurnMultiToken");
        ...
        public ApiResponse<TransactionHash> BurnMultiTokenBatchWithHttpInfo(BurnMultiTokenBatch burnMultiTokenBatch, string xTestnetType = default(string))
        {
            ...
            if (burnMultiTokenBatch == null)
                throw new ApiException(400, "Missing required parameter 'burnMultiTokenBatch' when calling MultiTokensBscApi->BurnMultiTokenBatch");
        ...
        public ApiResponse<SignatureId> BurnMultiTokenBatchWithHttpInfo(BurnMultiTokenBatchKMS burnMultiTokenBatchKMS, string xTestnetType = default(string))
        {
            ...
            if (burnMultiTokenBatchKMS == null)
                throw new ApiException(400, "Missing required parameter 'burnMultiTokenBatchKMS' when calling MultiTokensBscApi->BurnMultiTokenBatch_0");
        ...
        public ApiResponse<SignatureId> BurnMultiTokenWithHttpInfo(BurnMultiTokenKMS burnMultiTokenKMS, string xTestnetType = default(string))
        {
            ...
            if (burnMultiTokenKMS == null)
                throw new ApiException(400, "Missing required parameter 'burnMultiTokenKMS' when calling MultiTokensBscApi->BurnMultiToken_0");
        ...
        public ApiResponse<TransactionHash> DeployMultiTokenWithHttpInfo(DeployMultiToken deployMultiToken, string xTestnetType = default(string))
        {
            ...
            if (deployMultiToken == null)
                throw new ApiException(400, "Missing required parameter 'deployMultiToken' when calling MultiTokensBscApi->DeployMultiToken");
        ...
        public ApiResponse<SignatureId> DeployMultiTokenWithHttpInfo(DeployMultiTokenKMS deployMultiTokenKMS, string xTestnetType = default(string))
        {
            ...
            if (deployMultiTokenKMS == null)
                throw new ApiException(400, "Missing required parameter 'deployMultiTokenKMS' when calling MultiTokensBscApi->DeployMultiToken_0");
        ...
        public ApiResponse<TransactionHash> MintMultiTokenWithHttpInfo(MintMultiToken mintMultiToken, string xTestnetType = default(string))
        {
            ...
            if (mintMultiToken == null)
                throw new ApiException(400, "Missing required parameter 'mintMultiToken' when calling MultiTokensBscApi->MintMultiToken");
        ...
        public ApiResponse<TransactionHash> MintMultiTokenBatchWithHttpInfo(MintMultiTokenBatch mintMultiTokenBatch, string xTestnetType = default(string))
        {
            ...
            if (mintMultiTokenBatch == null)
                throw new ApiException(400, "Missing required parameter 'mintMultiTokenBatch' when calling MultiTokensBscApi->MintMultiTokenBatch");
        ...
        public ApiResponse<SignatureId> MintMultiTokenBatchWithHttpInfo(MintMultiTokenBatchKMS mintMultiTokenBatchKMS, string xTestnetType = default(string))
        {
            ...
            if (mintMultiTokenBatchKMS == null)
                throw new ApiException(400, "Missing required parameter 'mintMultiTokenBatchKMS' when calling MultiTokensBscApi->MintMultiTokenBatch_0");
        ...
        public ApiResponse<SignatureId> MintMultiTokenWithHttpInfo(MintMultiTokenKMS mintMultiTokenKMS, string xTestnetType = default(string))
        {
            ...
            if (mintMultiTokenKMS == null)
                throw new ApiException(400, "Missing required parameter 'mintMultiTokenKMS' when calling MultiTokensBscApi->MintMultiToken_0");
        ...
        public ApiResponse<MultiTokenBalanceValue> MultiTokenGetBalanceWithHttpInfo(string address, string contractAddress, string tokenId, string xTestnetType = default(string))
        {
            ...
            if (address == null)
                throw new ApiException(400, "Missing required parameter 'address' when calling MultiTokensBscApi->MultiTokenGetBalance");

            // verify the required parameter 'contractAddress' is set
            if (contractAddress == null)
                throw new ApiException(400, "Missing required parameter 'contractAddress' when calling MultiTokensBscApi->MultiTokenGetBalance");

            // verify the required parameter 'tokenId' is set
            if (tokenId == null)
                throw new ApiException(400, "Missing required parameter 'tokenId' when calling MultiTokensBscApi->MultiTokenGetBalance");
        ...
        public ApiResponse<MultiTokenBalanceBatch> MultiTokenGetBalanceBatchWithHttpInfo(string contractAddress, string tokenId, string address, string xTestnetType = default(string))
        {
            // verify the required parameter 'contractAddress' is set
            if (contractAddress == null)
                throw new ApiException(400, "Missing required parameter 'contractAddress' when calling MultiTokensBscApi->MultiTokenGetBalanceBatch");

            // verify the required parameter 'tokenId' is set
            if (tokenId == null)
                throw new ApiException(400, "Missing required parameter 'tokenId' when calling MultiTokensBscApi->MultiTokenGetBalanceBatch");

            // verify the required parameter 'address' is set
            if (address == null)
                throw new ApiException(400, "Missing required parameter 'address' when calling MultiTokensBscApi->MultiTokenGetBalanceBatch");
        ...
        public ApiResponse<MultiTokenMetadata> MultiTokenGetMetadataWithHttpInfo(string token, string contractAddress, string xTestnetType = default(string))
        {
            ...
            if (token == null)
                throw new ApiException(400, "Missing required parameter 'token' when calling MultiTokensBscApi->MultiTokenGetMetadata");

            // verify the required parameter 'contractAddress' is set
            if (contractAddress == null)
                throw new ApiException(400, "Missing required parameter 'contractAddress' when calling MultiTokensBscApi->MultiTokenGetMetadata");
        ...
        public ApiResponse<EthTx> MultiTokenGetTransactionWithHttpInfo(string hash, string xTestnetType = default(string))
        {
            ...
            if (hash == null)
                throw new ApiException(400, "Missing required parameter 'hash' when calling MultiTokensBscApi->MultiTokenGetTransaction");
        ...
        public ApiResponse<TransactionHash> TransferMultiTokenWithHttpInfo(TransferMultiToken transferMultiToken, string xTestnetType = default(string))
        {
            ...
            if (transferMultiToken == null)
                throw new ApiException(400, "Missing required parameter 'transferMultiToken' when calling MultiTokensBscApi->TransferMultiToken");
        ...
        public ApiResponse<TransactionHash> TransferMultiTokenBatchWithHttpInfo(TransferMultiTokenBatch transferMultiTokenBatch, string xTestnetType = default(string))
        {
            ...
            if (transferMultiTokenBatch == null)
                throw new ApiException(400, "Missing required parameter 'transferMultiTokenBatch' when calling MultiTokensBscApi->TransferMultiTokenBatch");
        ...
        public ApiResponse<SignatureId> TransferMultiTokenBatchWithHttpInfo(TransferMultiTokenBatchKMS transferMultiTokenBatchKMS, string xTestnetType = default(string))
        {
            ...
            if (transferMultiTokenBatchKMS == null)
                throw new ApiException(400, "Missing required parameter 'transferMultiTokenBatchKMS' when calling MultiTokensBscApi->TransferMultiTokenBatch_0");
        ...
        public ApiResponse<SignatureId> TransferMultiTokenWithHttpInfo(TransferMultiTokenKMS transferMultiTokenKMS, string xTestnetType = default(string))
        {
            ...
            if (transferMultiTokenKMS == null)
                throw new ApiException(400, "Missing required parameter 'transferMultiTokenKMS' when calling MultiTokensBscApi->TransferMultiToken_0");
