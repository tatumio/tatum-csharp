...
namespace Tatum.CSharp.MultiTokens.Core.Api
{
    ...
    /// </summary>
    public interface IMultiTokensMaticApiSync : IApiAccessor
    {
        ...
        /// </summary>
        /// <remarks>
        /// 1 credit per API call Get all Multi Tokens that a blockchain address holds. The Multi Tokens are returned grouped by the smart contracts they were minted on. This API is supported for the following blockchains: Celo Ethereum Polygon
        /// </remarks>
        /// <exception cref="Tatum.CSharp.MultiTokens.Core.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="address">Blockchain address</param>
        /// <param name="xTestnetType">Type of testnet. Defaults to Sepolia. Valid only for ETH invocations. (optional, default to ethereum-sepolia)</param>
        /// <returns>List&lt;MultiTokenAddressBalance&gt;</returns>
        List<MultiTokenAddressBalance> MultiTokenGetAddressBalance(string address, string xTestnetType = default(string));
        /// <summary>
        ...
        /// </summary>
        /// <remarks>
        /// 1 credit per API call Get incoming and outgoing Multi Token transactions on a blockchain address. This API is supported for the following blockchains: Celo Ethereum Polygon
        /// </remarks>
        /// <exception cref="Tatum.CSharp.MultiTokens.Core.Client.ApiException">Thrown when fails to make API call</exception>
        ...
        /// <returns>List&lt;MultiTx&gt;</returns>
        List<MultiTx> MultiTokenGetTransactionByAddress(string address, string tokenAddress, decimal pageSize, decimal? offset = default(decimal?), decimal? from = default(decimal?), decimal? to = default(decimal?));
        /// <summary>
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IMultiTokensMaticApiWithHttpInfoSync : IApiAccessor
    {
        ...
        /// <param name="address">Blockchain address</param>
        /// <param name="xTestnetType">Type of testnet. Defaults to Sepolia. Valid only for ETH invocations. (optional, default to ethereum-sepolia)</param>
        /// <returns>ApiResponse of List&lt;MultiTokenAddressBalance&gt;</returns>
        ApiResponse<List<MultiTokenAddressBalance>> MultiTokenGetAddressBalanceWithHttpInfo(string address, string xTestnetType = default(string));
        /// <summary>
        /// Get the amount of a specific MultiToken that a blockchain address holds
        /// </summary>
        /// <remarks>
        ...
        /// <param name="from">Transactions from this block onwards will be included. (optional)</param>
        /// <param name="to">Transactions up to this block will be included. (optional)</param>
        /// <returns>ApiResponse of List&lt;MultiTx&gt;</returns>
        ApiResponse<List<MultiTx>> MultiTokenGetTransactionByAddressWithHttpInfo(string address, string tokenAddress, decimal pageSize, decimal? offset = default(decimal?), decimal? from = default(decimal?), decimal? to = default(decimal?));
        /// <summary>
        /// Transfer a Multi Token
        /// </summary>
        /// <remarks>
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IMultiTokensMaticApiAsync : IApiAccessor
    {
        ...
        /// <param name="xTestnetType">Type of testnet. Defaults to Sepolia. Valid only for ETH invocations. (optional, default to ethereum-sepolia)</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of List&lt;MultiTokenAddressBalance&gt;</returns>
        System.Threading.Tasks.Task<List<MultiTokenAddressBalance>> MultiTokenGetAddressBalanceAsync(string address, string xTestnetType = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Get the amount of a specific MultiToken that a blockchain address holds
        /// </summary>
        /// <remarks>
        ...
        /// <param name="to">Transactions up to this block will be included. (optional)</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of List&lt;MultiTx&gt;</returns>
        System.Threading.Tasks.Task<List<MultiTx>> MultiTokenGetTransactionByAddressAsync(string address, string tokenAddress, decimal pageSize, decimal? offset = default(decimal?), decimal? from = default(decimal?), decimal? to = default(decimal?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Transfer a Multi Token
        /// </summary>
        /// <remarks>
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IMultiTokensMaticApiWithHttpInfoAsync : IApiAccessor
    {
        ...
        /// <param name="xTestnetType">Type of testnet. Defaults to Sepolia. Valid only for ETH invocations. (optional, default to ethereum-sepolia)</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;MultiTokenAddressBalance&gt;)</returns>
        System.Threading.Tasks.Task<ApiResponse<List<MultiTokenAddressBalance>>> MultiTokenGetAddressBalanceWithHttpInfoAsync(string address, string xTestnetType = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Get the amount of a specific MultiToken that a blockchain address holds
        /// </summary>
        /// <remarks>
        ...
        /// <param name="to">Transactions up to this block will be included. (optional)</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;MultiTx&gt;)</returns>
        System.Threading.Tasks.Task<ApiResponse<List<MultiTx>>> MultiTokenGetTransactionByAddressWithHttpInfoAsync(string address, string tokenAddress, decimal pageSize, decimal? offset = default(decimal?), decimal? from = default(decimal?), decimal? to = default(decimal?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Transfer a Multi Token
        /// </summary>
        /// <remarks>
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IMultiTokensMaticApi : IMultiTokensMaticApiSync, IMultiTokensMaticApiWithHttpInfoSync, IMultiTokensMaticApiAsync, IMultiTokensMaticApiWithHttpInfoAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class MultiTokensMaticApi : IMultiTokensMaticApi
    {
        private ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="MultiTokensMaticApi"/> class.
        /// </summary>
        ...
        /// </remarks>
        public MultiTokensMaticApi(HttpClient client, HttpClientHandler handler = null) : this(client, (string)null, handler)
        {
        }
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public MultiTokensMaticApi(HttpClient client, string basePath, HttpClientHandler handler = null)
        {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MultiTokensMaticApi"/> class using Configuration object.
        /// </summary>
        /// <param name="client">An instance of HttpClient.</param>
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public MultiTokensMaticApi(HttpClient client, Tatum.CSharp.MultiTokens.Core.Client.Configuration configuration, HttpClientHandler handler = null)
        {
        ...
        /// <exception cref="ArgumentNullException"></exception>
        public MultiTokensMaticApi(ISynchronousClient client, IAsynchronousClient asyncClient, IReadableConfiguration configuration)
        {
        ...
        public ApiResponse<TransactionHash> AddMultiTokenMinterWithHttpInfo(AddMultiTokenMinter addMultiTokenMinter, string xTestnetType = default(string))
        {
            ...
            if (addMultiTokenMinter == null)
                throw new ApiException(400, "Missing required parameter 'addMultiTokenMinter' when calling MultiTokensMaticApi->AddMultiTokenMinter");
        ...
        public ApiResponse<SignatureId> AddMultiTokenMinterWithHttpInfo(AddMultiTokenMinterKMS addMultiTokenMinterKMS, string xTestnetType = default(string))
        {
            ...
            if (addMultiTokenMinterKMS == null)
                throw new ApiException(400, "Missing required parameter 'addMultiTokenMinterKMS' when calling MultiTokensMaticApi->AddMultiTokenMinter_0");
        ...
        public ApiResponse<TransactionHash> BurnMultiTokenWithHttpInfo(BurnMultiToken burnMultiToken, string xTestnetType = default(string))
        {
            ...
            if (burnMultiToken == null)
                throw new ApiException(400, "Missing required parameter 'burnMultiToken' when calling MultiTokensMaticApi->BurnMultiToken");
        ...
        public ApiResponse<TransactionHash> BurnMultiTokenBatchWithHttpInfo(BurnMultiTokenBatch burnMultiTokenBatch, string xTestnetType = default(string))
        {
            ...
            if (burnMultiTokenBatch == null)
                throw new ApiException(400, "Missing required parameter 'burnMultiTokenBatch' when calling MultiTokensMaticApi->BurnMultiTokenBatch");
        ...
        public ApiResponse<SignatureId> BurnMultiTokenBatchWithHttpInfo(BurnMultiTokenBatchKMS burnMultiTokenBatchKMS, string xTestnetType = default(string))
        {
            ...
            if (burnMultiTokenBatchKMS == null)
                throw new ApiException(400, "Missing required parameter 'burnMultiTokenBatchKMS' when calling MultiTokensMaticApi->BurnMultiTokenBatch_0");
        ...
        public ApiResponse<SignatureId> BurnMultiTokenWithHttpInfo(BurnMultiTokenKMS burnMultiTokenKMS, string xTestnetType = default(string))
        {
            ...
            if (burnMultiTokenKMS == null)
                throw new ApiException(400, "Missing required parameter 'burnMultiTokenKMS' when calling MultiTokensMaticApi->BurnMultiToken_0");
        ...
        public ApiResponse<TransactionHash> DeployMultiTokenWithHttpInfo(DeployMultiToken deployMultiToken, string xTestnetType = default(string))
        {
            ...
            if (deployMultiToken == null)
                throw new ApiException(400, "Missing required parameter 'deployMultiToken' when calling MultiTokensMaticApi->DeployMultiToken");
        ...
        public ApiResponse<SignatureId> DeployMultiTokenWithHttpInfo(DeployMultiTokenKMS deployMultiTokenKMS, string xTestnetType = default(string))
        {
            ...
            if (deployMultiTokenKMS == null)
                throw new ApiException(400, "Missing required parameter 'deployMultiTokenKMS' when calling MultiTokensMaticApi->DeployMultiToken_0");
        ...
        public ApiResponse<TransactionHash> MintMultiTokenWithHttpInfo(MintMultiToken mintMultiToken, string xTestnetType = default(string))
        {
            ...
            if (mintMultiToken == null)
                throw new ApiException(400, "Missing required parameter 'mintMultiToken' when calling MultiTokensMaticApi->MintMultiToken");
        ...
        public ApiResponse<TransactionHash> MintMultiTokenBatchWithHttpInfo(MintMultiTokenBatch mintMultiTokenBatch, string xTestnetType = default(string))
        {
            ...
            if (mintMultiTokenBatch == null)
                throw new ApiException(400, "Missing required parameter 'mintMultiTokenBatch' when calling MultiTokensMaticApi->MintMultiTokenBatch");
        ...
        public ApiResponse<SignatureId> MintMultiTokenBatchWithHttpInfo(MintMultiTokenBatchKMS mintMultiTokenBatchKMS, string xTestnetType = default(string))
        {
            ...
            if (mintMultiTokenBatchKMS == null)
                throw new ApiException(400, "Missing required parameter 'mintMultiTokenBatchKMS' when calling MultiTokensMaticApi->MintMultiTokenBatch_0");
        ...
        public ApiResponse<SignatureId> MintMultiTokenWithHttpInfo(MintMultiTokenKMS mintMultiTokenKMS, string xTestnetType = default(string))
        {
            ...
            if (mintMultiTokenKMS == null)
                throw new ApiException(400, "Missing required parameter 'mintMultiTokenKMS' when calling MultiTokensMaticApi->MintMultiToken_0");
        ...
        /// <summary>
        /// Get all Multi Tokens that a blockchain address holds 1 credit per API call Get all Multi Tokens that a blockchain address holds. The Multi Tokens are returned grouped by the smart contracts they were minted on. This API is supported for the following blockchains: Celo Ethereum Polygon
        /// </summary>
        /// <exception cref="Tatum.CSharp.MultiTokens.Core.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="address">Blockchain address</param>
        /// <param name="xTestnetType">Type of testnet. Defaults to Sepolia. Valid only for ETH invocations. (optional, default to ethereum-sepolia)</param>
        /// <returns>List&lt;MultiTokenAddressBalance&gt;</returns>
        public List<MultiTokenAddressBalance> MultiTokenGetAddressBalance(string address, string xTestnetType = default(string))
        {
            var localVarResponse = MultiTokenGetAddressBalanceWithHttpInfo(address, xTestnetType);

            var exception = ExceptionFactory?.Invoke("MultiTokenGetAddressBalance", localVarResponse);
            if (exception != null) throw exception;
        ...
        /// <param name="xTestnetType">Type of testnet. Defaults to Sepolia. Valid only for ETH invocations. (optional, default to ethereum-sepolia)</param>
        /// <returns>ApiResponse of List&lt;MultiTokenAddressBalance&gt;</returns>
        public ApiResponse<List<MultiTokenAddressBalance>> MultiTokenGetAddressBalanceWithHttpInfo(string address, string xTestnetType = default(string))
        {
            // verify the required parameter 'address' is set
            if (address == null)
                throw new ApiException(400, "Missing required parameter 'address' when calling MultiTokensMaticApi->MultiTokenGetAddressBalance");
            ...
            // make the HTTP request
            var localVarResponse = Client.Get<List<MultiTokenAddressBalance>>("/v3/multitoken/address/balance/MATIC/{address}", localVarRequestOptions, Configuration);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of List&lt;MultiTokenAddressBalance&gt;</returns>
        public async System.Threading.Tasks.Task<List<MultiTokenAddressBalance>> MultiTokenGetAddressBalanceAsync(string address, string xTestnetType = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            var localVarResponse = await MultiTokenGetAddressBalanceWithHttpInfoAsync(address, xTestnetType, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;MultiTokenAddressBalance&gt;)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<List<MultiTokenAddressBalance>>> MultiTokenGetAddressBalanceWithHttpInfoAsync(string address, string xTestnetType = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'address' is set
            if (address == null)
                throw new ApiException(400, "Missing required parameter 'address' when calling MultiTokensMaticApi->MultiTokenGetAddressBalance");
            ...
            var localVarResponse = await AsynchronousClient.GetAsync<List<MultiTokenAddressBalance>>("/v3/multitoken/address/balance/MATIC/{address}", localVarRequestOptions, Configuration, cancellationToken).ConfigureAwait(false);
        ...
        public ApiResponse<MultiTokenBalanceValue> MultiTokenGetBalanceWithHttpInfo(string address, string contractAddress, string tokenId, string xTestnetType = default(string))
        {
            // verify the required parameter 'address' is set
            if (address == null)
                throw new ApiException(400, "Missing required parameter 'address' when calling MultiTokensMaticApi->MultiTokenGetBalance");

            // verify the required parameter 'contractAddress' is set
            if (contractAddress == null)
                throw new ApiException(400, "Missing required parameter 'contractAddress' when calling MultiTokensMaticApi->MultiTokenGetBalance");

            // verify the required parameter 'tokenId' is set
            if (tokenId == null)
                throw new ApiException(400, "Missing required parameter 'tokenId' when calling MultiTokensMaticApi->MultiTokenGetBalance");
            ...
            // make the HTTP request
            var localVarResponse = Client.Get<MultiTokenBalanceValue>("/v3/multitoken/balance/MATIC/{contractAddress}/{address}/{tokenId}", localVarRequestOptions, Configuration);
        ...
        public async System.Threading.Tasks.Task<ApiResponse<MultiTokenBalanceValue>> MultiTokenGetBalanceWithHttpInfoAsync(string address, string contractAddress, string tokenId, string xTestnetType = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var localVarResponse = await AsynchronousClient.GetAsync<MultiTokenBalanceValue>("/v3/multitoken/balance/MATIC/{contractAddress}/{address}/{tokenId}", localVarRequestOptions, Configuration, cancellationToken).ConfigureAwait(false);
        ...
        public ApiResponse<MultiTokenBalanceBatch> MultiTokenGetBalanceBatchWithHttpInfo(string contractAddress, string tokenId, string address, string xTestnetType = default(string))
        {
            // verify the required parameter 'contractAddress' is set
            if (contractAddress == null)
                throw new ApiException(400, "Missing required parameter 'contractAddress' when calling MultiTokensMaticApi->MultiTokenGetBalanceBatch");

            // verify the required parameter 'tokenId' is set
            if (tokenId == null)
                throw new ApiException(400, "Missing required parameter 'tokenId' when calling MultiTokensMaticApi->MultiTokenGetBalanceBatch");

            // verify the required parameter 'address' is set
            if (address == null)
                throw new ApiException(400, "Missing required parameter 'address' when calling MultiTokensMaticApi->MultiTokenGetBalanceBatch");
            ...
            // make the HTTP request
            var localVarResponse = Client.Get<MultiTokenBalanceBatch>("/v3/multitoken/balance/batch/MATIC/{contractAddress}", localVarRequestOptions, Configuration);
        ...
        public async System.Threading.Tasks.Task<ApiResponse<MultiTokenBalanceBatch>> MultiTokenGetBalanceBatchWithHttpInfoAsync(string contractAddress, string tokenId, string address, string xTestnetType = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var localVarResponse = await AsynchronousClient.GetAsync<MultiTokenBalanceBatch>("/v3/multitoken/balance/batch/MATIC/{contractAddress}", localVarRequestOptions, Configuration, cancellationToken).ConfigureAwait(false);
        ...
        public ApiResponse<MultiTokenMetadata> MultiTokenGetMetadataWithHttpInfo(string token, string contractAddress, string xTestnetType = default(string))
        {
            ...
            if (token == null)
                throw new ApiException(400, "Missing required parameter 'token' when calling MultiTokensMaticApi->MultiTokenGetMetadata");

            // verify the required parameter 'contractAddress' is set
            if (contractAddress == null)
                throw new ApiException(400, "Missing required parameter 'contractAddress' when calling MultiTokensMaticApi->MultiTokenGetMetadata");
            ...
            // make the HTTP request
            var localVarResponse = Client.Get<MultiTokenMetadata>("/v3/multitoken/metadata/MATIC/{contractAddress}/{token}", localVarRequestOptions, Configuration);
        ...
        public async System.Threading.Tasks.Task<ApiResponse<MultiTokenMetadata>> MultiTokenGetMetadataWithHttpInfoAsync(string token, string contractAddress, string xTestnetType = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var localVarResponse = await AsynchronousClient.GetAsync<MultiTokenMetadata>("/v3/multitoken/metadata/MATIC/{contractAddress}/{token}", localVarRequestOptions, Configuration, cancellationToken).ConfigureAwait(false);
        ...
        public ApiResponse<EthTx> MultiTokenGetTransactionWithHttpInfo(string hash, string xTestnetType = default(string))
        {
            ...
            if (hash == null)
                throw new ApiException(400, "Missing required parameter 'hash' when calling MultiTokensMaticApi->MultiTokenGetTransaction");
            ...
            // make the HTTP request
            var localVarResponse = Client.Get<EthTx>("/v3/multitoken/transaction/MATIC/{hash}", localVarRequestOptions, Configuration);
        ...
        public async System.Threading.Tasks.Task<ApiResponse<EthTx>> MultiTokenGetTransactionWithHttpInfoAsync(string hash, string xTestnetType = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var localVarResponse = await AsynchronousClient.GetAsync<EthTx>("/v3/multitoken/transaction/MATIC/{hash}", localVarRequestOptions, Configuration, cancellationToken).ConfigureAwait(false);

            return localVarResponse;
        }

        /// <summary>
        /// Get Multi Token transactions on a blockchain address 1 credit per API call Get incoming and outgoing Multi Token transactions on a blockchain address. This API is supported for the following blockchains: Celo Ethereum Polygon
        /// </summary>
        /// <exception cref="Tatum.CSharp.MultiTokens.Core.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="address">Account address you want to get balance of</param>
        /// <param name="tokenAddress">Address of the token smart contract</param>
        ...
        /// <param name="to">Transactions up to this block will be included. (optional)</param>
        /// <returns>List&lt;MultiTx&gt;</returns>
        public List<MultiTx> MultiTokenGetTransactionByAddress(string address, string tokenAddress, decimal pageSize, decimal? offset = default(decimal?), decimal? from = default(decimal?), decimal? to = default(decimal?))
        {
            var localVarResponse = MultiTokenGetTransactionByAddressWithHttpInfo(address, tokenAddress, pageSize, offset, from, to);

            var exception = ExceptionFactory?.Invoke("MultiTokenGetTransactionByAddress", localVarResponse);
            if (exception != null) throw exception;
        ...
        /// <param name="to">Transactions up to this block will be included. (optional)</param>
        /// <returns>ApiResponse of List&lt;MultiTx&gt;</returns>
        public ApiResponse<List<MultiTx>> MultiTokenGetTransactionByAddressWithHttpInfo(string address, string tokenAddress, decimal pageSize, decimal? offset = default(decimal?), decimal? from = default(decimal?), decimal? to = default(decimal?))
        {
            // verify the required parameter 'address' is set
            if (address == null)
                throw new ApiException(400, "Missing required parameter 'address' when calling MultiTokensMaticApi->MultiTokenGetTransactionByAddress");

            // verify the required parameter 'tokenAddress' is set
            if (tokenAddress == null)
                throw new ApiException(400, "Missing required parameter 'tokenAddress' when calling MultiTokensMaticApi->MultiTokenGetTransactionByAddress");
            ...
            // make the HTTP request
            var localVarResponse = Client.Get<List<MultiTx>>("/v3/multitoken/transaction/MATIC/{address}/{tokenAddress}", localVarRequestOptions, Configuration);
        ...
        {
            var localVarResponse = await MultiTokenGetTransactionByAddressWithHttpInfoAsync(address, tokenAddress, pageSize, offset, from, to, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;MultiTx&gt;)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<List<MultiTx>>> MultiTokenGetTransactionByAddressWithHttpInfoAsync(string address, string tokenAddress, decimal pageSize, decimal? offset = default(decimal?), decimal? from = default(decimal?), decimal? to = default(decimal?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'address' is set
            if (address == null)
                throw new ApiException(400, "Missing required parameter 'address' when calling MultiTokensMaticApi->MultiTokenGetTransactionByAddress");
            ...
            var localVarResponse = await AsynchronousClient.GetAsync<List<MultiTx>>("/v3/multitoken/transaction/MATIC/{address}/{tokenAddress}", localVarRequestOptions, Configuration, cancellationToken).ConfigureAwait(false);
        ...
        public ApiResponse<TransactionHash> TransferMultiTokenWithHttpInfo(TransferMultiToken transferMultiToken, string xTestnetType = default(string))
        {
            ...
            if (transferMultiToken == null)
                throw new ApiException(400, "Missing required parameter 'transferMultiToken' when calling MultiTokensMaticApi->TransferMultiToken");
        ...
        public ApiResponse<TransactionHash> TransferMultiTokenBatchWithHttpInfo(TransferMultiTokenBatch transferMultiTokenBatch, string xTestnetType = default(string))
        {
            ...
            if (transferMultiTokenBatch == null)
                throw new ApiException(400, "Missing required parameter 'transferMultiTokenBatch' when calling MultiTokensMaticApi->TransferMultiTokenBatch");
        ...
        public ApiResponse<SignatureId> TransferMultiTokenBatchWithHttpInfo(TransferMultiTokenBatchKMS transferMultiTokenBatchKMS, string xTestnetType = default(string))
        {
            ...
            if (transferMultiTokenBatchKMS == null)
                throw new ApiException(400, "Missing required parameter 'transferMultiTokenBatchKMS' when calling MultiTokensMaticApi->TransferMultiTokenBatch_0");
        ...
        public ApiResponse<SignatureId> TransferMultiTokenWithHttpInfo(TransferMultiTokenKMS transferMultiTokenKMS, string xTestnetType = default(string))
        {
            ...
            if (transferMultiTokenKMS == null)
                throw new ApiException(400, "Missing required parameter 'transferMultiTokenKMS' when calling MultiTokensMaticApi->TransferMultiToken_0");
