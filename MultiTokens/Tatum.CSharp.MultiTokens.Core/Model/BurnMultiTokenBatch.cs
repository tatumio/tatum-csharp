...
namespace Tatum.CSharp.MultiTokens.Core.Model
{
    ...
    /// BurnMultiTokenBatch
    /// </summary>
    [DataContract(Name = "BurnMultiTokenBatch")]
    public partial class BurnMultiTokenBatch : IEquatable<BurnMultiTokenBatch>, IValidatableObject
    {
        /// <summary>
        /// Chain to work with.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BurnMultiTokenBatch" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BurnMultiTokenBatch() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BurnMultiTokenBatch" /> class.
        /// </summary>
        ...
        public BurnMultiTokenBatch(ChainEnum chain = default(ChainEnum), string account = default(string), List<string> tokenId = default(List<string>), List<string> amounts = default(List<string>), string data = default(string), string contractAddress = default(string), string fromPrivateKey = default(string), decimal nonce = default(decimal), CustomFee fee = default(CustomFee))
        {
            this.Chain = chain;
            // to ensure "account" is required (not null)
            if (account == null)
            {
                throw new ArgumentNullException("account is a required property for BurnMultiTokenBatch and cannot be null");
            }
            this.Account = account;
            // to ensure "tokenId" is required (not null)
            if (tokenId == null)
            {
                throw new ArgumentNullException("tokenId is a required property for BurnMultiTokenBatch and cannot be null");
            }
            this.TokenId = tokenId;
            // to ensure "amounts" is required (not null)
            if (amounts == null)
            {
                throw new ArgumentNullException("amounts is a required property for BurnMultiTokenBatch and cannot be null");
            }
            this.Amounts = amounts;
            // to ensure "contractAddress" is required (not null)
            if (contractAddress == null)
            {
                throw new ArgumentNullException("contractAddress is a required property for BurnMultiTokenBatch and cannot be null");
            }
            this.ContractAddress = contractAddress;
            // to ensure "fromPrivateKey" is required (not null)
            if (fromPrivateKey == null)
            {
                throw new ArgumentNullException("fromPrivateKey is a required property for BurnMultiTokenBatch and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BurnMultiTokenBatch {\n");
        ...
        {
            return this.Equals(input as BurnMultiTokenBatch);
        }

        /// <summary>
        /// Returns true if BurnMultiTokenBatch instances are equal
        /// </summary>
        /// <param name="input">Instance of BurnMultiTokenBatch to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BurnMultiTokenBatch input)
        {
            if (input == null)
            {
                return false;
