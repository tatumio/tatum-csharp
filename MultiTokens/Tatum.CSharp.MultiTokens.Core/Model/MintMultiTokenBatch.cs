...
namespace Tatum.CSharp.MultiTokens.Core.Model
{
    ...
    public partial class MintMultiTokenBatch : IEquatable<MintMultiTokenBatch>, IValidatableObject
    {
        ...
        public MintMultiTokenBatch(ChainEnum chain = default(ChainEnum), List<string> to = default(List<string>), List<List<string>> tokenId = default(List<List<string>>), List<List<string>> amounts = default(List<List<string>>), string data = default(string), string contractAddress = default(string), string fromPrivateKey = default(string), decimal nonce = default(decimal), CustomFee fee = default(CustomFee))
        {
            this.Chain = chain;
