...
namespace Tatum.CSharp.MultiTokens.Core.Model
{
    ...
    public partial class BurnMultiToken : IEquatable<BurnMultiToken>, IValidatableObject
    {
        ...
        public BurnMultiToken(ChainEnum chain = default(ChainEnum), string account = default(string), string tokenId = default(string), string contractAddress = default(string), string fromPrivateKey = default(string), string data = default(string), string amount = default(string), decimal nonce = default(decimal), CustomFee fee = default(CustomFee))
        {
            this.Chain = chain;
