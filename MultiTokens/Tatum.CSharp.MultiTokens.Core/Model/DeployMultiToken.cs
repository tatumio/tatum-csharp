...
namespace Tatum.CSharp.MultiTokens.Core.Model
{
    ...
    public partial class DeployMultiToken : IEquatable<DeployMultiToken>, IValidatableObject
    {
        ...
        public DeployMultiToken(ChainEnum chain = default(ChainEnum), string uri = default(string), string fromPrivateKey = default(string), bool publicMint = default(bool), decimal nonce = default(decimal), CustomFee fee = default(CustomFee))
        {
            this.Chain = chain;
