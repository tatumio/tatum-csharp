...
namespace Tatum.CSharp.MultiTokens.Core.Model
{
    ...
    public partial class TransferMultiTokenBatch : IEquatable<TransferMultiTokenBatch>, IValidatableObject
    {
        ...
        public TransferMultiTokenBatch(ChainEnum chain = default(ChainEnum), string to = default(string), List<string> tokenId = default(List<string>), List<string> amounts = default(List<string>), string data = default(string), string contractAddress = default(string), string fromPrivateKey = default(string), decimal nonce = default(decimal), CustomFee fee = default(CustomFee))
        {
            this.Chain = chain;
