...
namespace Tatum.CSharp.MultiTokens.Core.Model
{
    ...
    public partial class DeployMultiTokenKMS : IEquatable<DeployMultiTokenKMS>, IValidatableObject
    {
        ...
        public DeployMultiTokenKMS(ChainEnum chain = default(ChainEnum), string uri = default(string), bool publicMint = default(bool), Guid signatureId = default(Guid), decimal nonce = default(decimal), CustomFee fee = default(CustomFee))
        {
            this.Chain = chain;
