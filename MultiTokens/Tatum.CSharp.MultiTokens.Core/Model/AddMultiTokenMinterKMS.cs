...
namespace Tatum.CSharp.MultiTokens.Core.Model
{
    ...
    public partial class AddMultiTokenMinterKMS : IEquatable<AddMultiTokenMinterKMS>, IValidatableObject
    {
        ...
        public AddMultiTokenMinterKMS(ChainEnum chain = default(ChainEnum), string contractAddress = default(string), string minter = default(string), decimal index = default(decimal), Guid signatureId = default(Guid), decimal nonce = default(decimal), CustomFee fee = default(CustomFee), FeeCurrencyEnum? feeCurrency = default(FeeCurrencyEnum?))
        {
            this.Chain = chain;
