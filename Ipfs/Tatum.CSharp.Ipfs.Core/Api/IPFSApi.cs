...
namespace Tatum.CSharp.Ipfs.Core.Api
{
    ...
    public interface IIPFSApiSync : IApiAccessor
    {
        ...
        /// </remarks>
        /// <exception cref="Tatum.CSharp.Ipfs.Core.Client.ApiException">Thrown when fails to make API call</exception>
    ...
    public partial class IPFSApi : IIPFSApi
    {
        ...
        public IPFSApi(HttpClient client, string basePath, HttpClientHandler handler = null)
        {
            ...
            Configuration = Tatum.CSharp.Ipfs.Core.Client.Configuration.MergeConfigurations(
                GlobalConfiguration.Instance,
                new Tatum.CSharp.Ipfs.Core.Client.Configuration { BasePath = basePath }
            );
            ApiClient = new ApiClient(client, Configuration.BasePath, handler);
            Client =  ApiClient;
            AsynchronousClient = ApiClient;
            ExceptionFactory = Tatum.CSharp.Ipfs.Core.Client.Configuration.DefaultExceptionFactory;
        }
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public IPFSApi(HttpClient client, Tatum.CSharp.Ipfs.Core.Client.Configuration configuration, HttpClientHandler handler = null)
        {
