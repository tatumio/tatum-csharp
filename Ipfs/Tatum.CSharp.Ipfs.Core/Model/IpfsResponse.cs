...
using FileParameter = Tatum.CSharp.Ipfs.Core.Client.FileParameter;
using OpenAPIDateConverter = Tatum.CSharp.Ipfs.Core.Client.OpenAPIDateConverter;

namespace Tatum.CSharp.Ipfs.Core.Model
{
    /// <summary>
    /// IpfsResponse
    /// </summary>
