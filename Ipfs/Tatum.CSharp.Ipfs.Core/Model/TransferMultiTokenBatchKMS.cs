...
namespace Tatum.CSharp.MultiTokens.Core.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TransferMultiTokenBatchKMS")]
    public partial class TransferMultiTokenBatchKMS : IEquatable<TransferMultiTokenBatchKMS>, IValidatableObject
    {
        /// <summary>
        /// Chain to work with.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TransferMultiTokenBatchKMS" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TransferMultiTokenBatchKMS() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TransferMultiTokenBatchKMS" /> class.
        /// </summary>
        ...
        public TransferMultiTokenBatchKMS(ChainEnum chain = default(ChainEnum), string to = default(string), List<string> tokenId = default(List<string>), List<string> amount = default(List<string>), string data = default(string), string contractAddress = default(string), decimal index = default(decimal), Guid signatureId = default(Guid), decimal nonce = default(decimal), CustomFee fee = default(CustomFee))
        {
            this.Chain = chain;
            // to ensure "to" is required (not null)
            if (to == null)
            {
                throw new ArgumentNullException("to is a required property for TransferMultiTokenBatchKMS and cannot be null");
            }
            this.To = to;
            // to ensure "tokenId" is required (not null)
            if (tokenId == null)
            {
                throw new ArgumentNullException("tokenId is a required property for TransferMultiTokenBatchKMS and cannot be null");
            }
            this.TokenId = tokenId;
            // to ensure "amount" is required (not null)
            if (amount == null)
            {
                throw new ArgumentNullException("amount is a required property for TransferMultiTokenBatchKMS and cannot be null");
            }
            this.Amount = amount;
            // to ensure "contractAddress" is required (not null)
            if (contractAddress == null)
            {
                throw new ArgumentNullException("contractAddress is a required property for TransferMultiTokenBatchKMS and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransferMultiTokenBatchKMS {\n");
        ...
        {
            return this.Equals(input as TransferMultiTokenBatchKMS);
        }

        /// <summary>
        /// Returns true if TransferMultiTokenBatchKMS instances are equal
        /// </summary>
        /// <param name="input">Instance of TransferMultiTokenBatchKMS to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransferMultiTokenBatchKMS input)
        {
            if (input == null)
            {
                return false;
