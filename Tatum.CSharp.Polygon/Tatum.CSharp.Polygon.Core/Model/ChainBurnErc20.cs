...
namespace Tatum.CSharp.Polygon.Core.Model
{
    ...
    public partial class ChainBurnErc20 : IEquatable<ChainBurnErc20>, IValidatableObject
    {
        ...
        public ChainBurnErc20(string amount = default(string), string contractAddress = default(string), string fromPrivateKey = default(string), CustomFee fee = default(CustomFee), decimal nonce = default(decimal))
        {
