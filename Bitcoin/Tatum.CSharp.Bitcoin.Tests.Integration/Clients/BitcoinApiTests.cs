...
public class BitcoinApiTests : IAsyncDisposable
{
    ...
    {
        var privKey = _bitcoinApi.Local.GenerateAddressPrivateKey(new PrivKeyRequestLocal(0, _testData.TestMnemonic));
    ...
    public async Task GenerateAddressPrivateKey_ShouldReturnSamePrivateKey_WhenCalledWithSameDataOnLocal()
    {
        ...
        var privKeyLocal = _bitcoinApi.Local.GenerateAddressPrivateKey(privKeyRequestLocal);
