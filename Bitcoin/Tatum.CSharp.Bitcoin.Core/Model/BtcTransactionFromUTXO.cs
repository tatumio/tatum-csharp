...
namespace Tatum.CSharp.Bitcoin.Core.Model
{
    ...
    /// </summary>
    [DataContract(Name = "BtcTransactionFromUTXO")]
    public partial class BtcTransactionFromUTXO : IEquatable<BtcTransactionFromUTXO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BtcTransactionFromUTXO" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BtcTransactionFromUTXO() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BtcTransactionFromUTXO" /> class.
        /// </summary>
        /// <param name="fromUTXO">The array of transaction hashes, indexes of its UTXOs, and the private keys of the associated blockchain addresses (required).</param>
        ...
        /// <param name="changeAddress">The blockchain address to send any extra assets remaining after covering the fee; if you are using this parameter, you have to also use the &lt;code&gt;fee&lt;/code&gt; parameter because these two parameters only work together..</param>
        public BtcTransactionFromUTXO(List<BtcTransactionFromUTXOSource> fromUTXO = default(List<BtcTransactionFromUTXOSource>), List<BtcTransactionFromUTXOTarget> to = default(List<BtcTransactionFromUTXOTarget>), string fee = default(string), string changeAddress = default(string))
        {
            // to ensure "fromUTXO" is required (not null)
            if (fromUTXO == null)
            {
                throw new ArgumentNullException("fromUTXO is a required property for BtcTransactionFromUTXO and cannot be null");
            }
            this.FromUTXO = fromUTXO;
            // to ensure "to" is required (not null)
            if (to == null)
            {
                throw new ArgumentNullException("to is a required property for BtcTransactionFromUTXO and cannot be null");
            }
            this.To = to;
            this.Fee = fee;
        ...
        /// </summary>
        /// <value>The array of transaction hashes, indexes of its UTXOs, and the private keys of the associated blockchain addresses</value>
        [DataMember(Name = "fromUTXO", IsRequired = true, EmitDefaultValue = true)]
        public List<BtcTransactionFromUTXOSource> FromUTXO { get; set; }
        ...
        public List<BtcTransactionFromUTXOTarget> To { get; set; }
        ...
        /// </summary>
        /// <value>The blockchain address to send any extra assets remaining after covering the fee; if you are using this parameter, you have to also use the &lt;code&gt;fee&lt;/code&gt; parameter because these two parameters only work together.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BtcTransactionFromUTXO {\n");
        ...
        {
            return this.Equals(input as BtcTransactionFromUTXO);
        }

        /// <summary>
        /// Returns true if BtcTransactionFromUTXO instances are equal
        /// </summary>
        /// <param name="input">Instance of BtcTransactionFromUTXO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BtcTransactionFromUTXO input)
        {
            if (input == null)
            {
                return false;
