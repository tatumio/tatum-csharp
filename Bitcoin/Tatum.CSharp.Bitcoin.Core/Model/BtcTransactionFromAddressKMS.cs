...
namespace Tatum.CSharp.Bitcoin.Core.Model
{
    ...
    /// </summary>
    [DataContract(Name = "BtcTransactionFromAddressKMS")]
    public partial class BtcTransactionFromAddressKMS : IEquatable<BtcTransactionFromAddressKMS>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BtcTransactionFromAddressKMS" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BtcTransactionFromAddressKMS() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BtcTransactionFromAddressKMS" /> class.
        /// </summary>
        /// <param name="fromAddress">The array of blockchain addresses to send the assets from and their signature IDs. For each address, the last 100 transactions are scanned for any UTXO to be included in the transaction. (required).</param>
        ...
        public BtcTransactionFromAddressKMS(List<BtcTransactionFromAddressKMSSource> fromAddress = default(List<BtcTransactionFromAddressKMSSource>), List<BtcTransactionFromAddressKMSTarget> to = default(List<BtcTransactionFromAddressKMSTarget>), string fee = default(string), string changeAddress = default(string))
        {
            // to ensure "fromAddress" is required (not null)
            if (fromAddress == null)
            {
                throw new ArgumentNullException("fromAddress is a required property for BtcTransactionFromAddressKMS and cannot be null");
            }
            this.FromAddress = fromAddress;
            // to ensure "to" is required (not null)
            if (to == null)
            {
                throw new ArgumentNullException("to is a required property for BtcTransactionFromAddressKMS and cannot be null");
            }
            this.To = to;
            this.Fee = fee;
        ...
        /// </summary>
        /// <value>The array of blockchain addresses to send the assets from and their signature IDs. For each address, the last 100 transactions are scanned for any UTXO to be included in the transaction.</value>
        [DataMember(Name = "fromAddress", IsRequired = true, EmitDefaultValue = true)]
        public List<BtcTransactionFromAddressKMSSource> FromAddress { get; set; }
        ...
        public List<BtcTransactionFromAddressKMSTarget> To { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BtcTransactionFromAddressKMS {\n");
        ...
        {
            return this.Equals(input as BtcTransactionFromAddressKMS);
        }

        /// <summary>
        /// Returns true if BtcTransactionFromAddressKMS instances are equal
        /// </summary>
        /// <param name="input">Instance of BtcTransactionFromAddressKMS to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BtcTransactionFromAddressKMS input)
        {
            if (input == null)
            {
                return false;
