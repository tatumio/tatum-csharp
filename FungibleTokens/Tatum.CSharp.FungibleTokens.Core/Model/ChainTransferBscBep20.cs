...
namespace Tatum.CSharp.FungibleTokens.Core.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ChainTransferBscBep20")]
    public partial class ChainTransferBscBep20 : IEquatable<ChainTransferBscBep20>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ChainTransferBscBep20" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ChainTransferBscBep20() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ChainTransferBscBep20" /> class.
        /// </summary>
        ...
        public ChainTransferBscBep20(ChainEnum chain = default(ChainEnum), string to = default(string), string contractAddress = default(string), string amount = default(string), decimal digits = default(decimal), string fromPrivateKey = default(string), decimal nonce = default(decimal), CustomFee fee = default(CustomFee))
        {
            this.Chain = chain;
            // to ensure "to" is required (not null)
            if (to == null)
            {
                throw new ArgumentNullException("to is a required property for ChainTransferBscBep20 and cannot be null");
            }
            this.To = to;
            // to ensure "contractAddress" is required (not null)
            if (contractAddress == null)
            {
                throw new ArgumentNullException("contractAddress is a required property for ChainTransferBscBep20 and cannot be null");
            }
            this.ContractAddress = contractAddress;
            // to ensure "amount" is required (not null)
            if (amount == null)
            {
                throw new ArgumentNullException("amount is a required property for ChainTransferBscBep20 and cannot be null");
            }
            this.Amount = amount;
            this.Digits = digits;
            ...
            {
                throw new ArgumentNullException("fromPrivateKey is a required property for ChainTransferBscBep20 and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ChainTransferBscBep20 {\n");
        ...
        {
            return this.Equals(input as ChainTransferBscBep20);
        }

        /// <summary>
        /// Returns true if ChainTransferBscBep20 instances are equal
        /// </summary>
        /// <param name="input">Instance of ChainTransferBscBep20 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ChainTransferBscBep20 input)
        {
            if (input == null)
            {
                return false;
