...
namespace Tatum.CSharp.FungibleTokens.Core.Model
{
    ...
    public partial class ApproveErc20KMS : IEquatable<ApproveErc20KMS>, IValidatableObject
    {
        ...
        public ApproveErc20KMS(ChainEnum chain = default(ChainEnum), string amount = default(string), string spender = default(string), string contractAddress = default(string), Guid signatureId = default(Guid), CustomFee fee = default(CustomFee), decimal nonce = default(decimal))
        {
            this.Chain = chain;
