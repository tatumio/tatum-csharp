...
namespace Tatum.CSharp.FungibleTokens.Core.Model
{
    ...
    public partial class ChainDeployErc20 : IEquatable<ChainDeployErc20>, IValidatableObject
    {
        ...
        public ChainDeployErc20(ChainEnum chain = default(ChainEnum), string symbol = default(string), string name = default(string), string totalCap = default(string), string supply = default(string), decimal digits = default(decimal), string address = default(string), string fromPrivateKey = default(string), decimal nonce = default(decimal), CustomFee fee = default(CustomFee))
        {
            this.Chain = chain;
