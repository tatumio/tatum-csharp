...
namespace Tatum.CSharp.FungibleTokens.Core.Model
{
    ...
    public partial class ApproveErc20 : IEquatable<ApproveErc20>, IValidatableObject
    {
        ...
        public ApproveErc20(ChainEnum chain = default(ChainEnum), string contractAddress = default(string), string spender = default(string), string amount = default(string), string fromPrivateKey = default(string), CustomFee fee = default(CustomFee), decimal nonce = default(decimal))
        {
            this.Chain = chain;
