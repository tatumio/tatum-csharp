...
namespace Tatum.CSharp.FungibleTokens.Core.Model
{
    ...
    public partial class ChainTransferEthErc20 : IEquatable<ChainTransferEthErc20>, IValidatableObject
    {
        ...
        public ChainTransferEthErc20(ChainEnum chain = default(ChainEnum), string to = default(string), string contractAddress = default(string), string amount = default(string), decimal digits = default(decimal), string fromPrivateKey = default(string), decimal nonce = default(decimal), CustomFee fee = default(CustomFee))
        {
            this.Chain = chain;
