...
namespace Tatum.CSharp.FungibleTokens.Core.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ChainTransferBscBep20KMS")]
    public partial class ChainTransferBscBep20KMS : IEquatable<ChainTransferBscBep20KMS>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ChainTransferBscBep20KMS" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ChainTransferBscBep20KMS() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ChainTransferBscBep20KMS" /> class.
        /// </summary>
        ...
        public ChainTransferBscBep20KMS(ChainEnum chain = default(ChainEnum), string to = default(string), string contractAddress = default(string), string amount = default(string), decimal digits = default(decimal), Guid signatureId = default(Guid), decimal nonce = default(decimal), CustomFee fee = default(CustomFee))
        {
            this.Chain = chain;
            // to ensure "to" is required (not null)
            if (to == null)
            {
                throw new ArgumentNullException("to is a required property for ChainTransferBscBep20KMS and cannot be null");
            }
            this.To = to;
            // to ensure "contractAddress" is required (not null)
            if (contractAddress == null)
            {
                throw new ArgumentNullException("contractAddress is a required property for ChainTransferBscBep20KMS and cannot be null");
            }
            this.ContractAddress = contractAddress;
            // to ensure "amount" is required (not null)
            if (amount == null)
            {
                throw new ArgumentNullException("amount is a required property for ChainTransferBscBep20KMS and cannot be null");
            }
            this.Amount = amount;
            this.Digits = digits;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ChainTransferBscBep20KMS {\n");
        ...
        {
            return this.Equals(input as ChainTransferBscBep20KMS);
        }

        /// <summary>
        /// Returns true if ChainTransferBscBep20KMS instances are equal
        /// </summary>
        /// <param name="input">Instance of ChainTransferBscBep20KMS to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ChainTransferBscBep20KMS input)
        {
            if (input == null)
            {
                return false;
