...
namespace Tatum.CSharp.Core.Model
{
    ...
    /// </summary>
    [DataContract(Name = "EthGasEstimation_estimations")]
    public partial class EthGasEstimationEstimations : IEquatable<EthGasEstimationEstimations>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EthGasEstimationEstimations" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EthGasEstimationEstimations() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EthGasEstimationEstimations" /> class.
        /// </summary>
        ...
        public EthGasEstimationEstimations(string safe = default(string), string standard = default(string), string fast = default(string), string baseFee = default(string))
        {
            // to ensure "safe" is required (not null)
            if (safe == null) {
                throw new ArgumentNullException("safe is a required property for EthGasEstimationEstimations and cannot be null");
            }
            this.Safe = safe;
            // to ensure "standard" is required (not null)
            if (standard == null) {
                throw new ArgumentNullException("standard is a required property for EthGasEstimationEstimations and cannot be null");
            }
            this.Standard = standard;
            // to ensure "fast" is required (not null)
            if (fast == null) {
                throw new ArgumentNullException("fast is a required property for EthGasEstimationEstimations and cannot be null");
            }
            this.Fast = fast;
            // to ensure "baseFee" is required (not null)
            if (baseFee == null) {
                throw new ArgumentNullException("baseFee is a required property for EthGasEstimationEstimations and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EthGasEstimationEstimations {\n");
        ...
        {
            return this.Equals(input as EthGasEstimationEstimations);
        }

        /// <summary>
        /// Returns true if EthGasEstimationEstimations instances are equal
        /// </summary>
        /// <param name="input">Instance of EthGasEstimationEstimations to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EthGasEstimationEstimations input)
        {
            if (input == null)
            {
                return false;
