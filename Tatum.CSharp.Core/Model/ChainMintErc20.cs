...
namespace Tatum.CSharp.Core.Model
{
    ...
    public partial class ChainMintErc20 : IEquatable<ChainMintErc20>, IValidatableObject
    {
        ...
        public ChainMintErc20(ChainEnum chain = default(ChainEnum), string amount = default(string), string to = default(string), string contractAddress = default(string), string fromPrivateKey = default(string), decimal nonce = default(decimal))
        {
            this.Chain = chain;
