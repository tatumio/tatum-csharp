...
namespace Tatum.CSharp.Core.Model
{
    ...
    public partial class TransferEthBlockchainKMS : IEquatable<TransferEthBlockchainKMS>, IValidatableObject
    {
        ...
        public TransferEthBlockchainKMS(string data = default(string), decimal nonce = default(decimal), string to = default(string), CurrencyEnum currency = default(CurrencyEnum), CallSmartContractMethodFee fee = default(CallSmartContractMethodFee), string amount = default(string), Guid signatureId = default(Guid), decimal index = default(decimal))
        {
