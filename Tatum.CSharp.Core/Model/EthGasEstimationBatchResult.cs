...
namespace Tatum.CSharp.Core.Model
{
    ...
    /// </summary>
    [DataContract(Name = "EthGasEstimationBatch_result")]
    public partial class EthGasEstimationBatchResult : IEquatable<EthGasEstimationBatchResult>, IValidatableObject
    {
        ...
        public EthGasEstimationBatchResult(bool error = default(bool), string contractAddress = default(string), EthGasEstimationBatchData data = default(EthGasEstimationBatchData), string msg = default(string))
        {
            this.Error = error;
        ...
        public EthGasEstimationBatchData Data { get; set; }
