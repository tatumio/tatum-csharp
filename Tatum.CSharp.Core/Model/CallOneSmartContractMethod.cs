...
namespace Tatum.CSharp.Core.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CallOneSmartContractMethod")]
    public partial class CallOneSmartContractMethod : IEquatable<CallOneSmartContractMethod>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CallOneSmartContractMethod" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CallOneSmartContractMethod() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CallOneSmartContractMethod" /> class.
        /// </summary>
        ...
        public CallOneSmartContractMethod(string contractAddress = default(string), string amount = default(string), string methodName = default(string), Object methodABI = default(Object), List<string> _params = default(List<string>), string fromPrivateKey = default(string), decimal nonce = default(decimal), CustomFee fee = default(CustomFee))
        {
            // to ensure "contractAddress" is required (not null)
            if (contractAddress == null)
            {
                throw new ArgumentNullException("contractAddress is a required property for CallOneSmartContractMethod and cannot be null");
            }
            this.ContractAddress = contractAddress;
            // to ensure "methodName" is required (not null)
            if (methodName == null)
            {
                throw new ArgumentNullException("methodName is a required property for CallOneSmartContractMethod and cannot be null");
            }
            this.MethodName = methodName;
            // to ensure "methodABI" is required (not null)
            if (methodABI == null)
            {
                throw new ArgumentNullException("methodABI is a required property for CallOneSmartContractMethod and cannot be null");
            }
            this.MethodABI = methodABI;
            // to ensure "_params" is required (not null)
            if (_params == null)
            {
                throw new ArgumentNullException("_params is a required property for CallOneSmartContractMethod and cannot be null");
            }
            this.Params = _params;
            // to ensure "fromPrivateKey" is required (not null)
            if (fromPrivateKey == null)
            {
                throw new ArgumentNullException("fromPrivateKey is a required property for CallOneSmartContractMethod and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CallOneSmartContractMethod {\n");
        ...
        {
            return this.Equals(input as CallOneSmartContractMethod);
        }

        /// <summary>
        /// Returns true if CallOneSmartContractMethod instances are equal
        /// </summary>
        /// <param name="input">Instance of CallOneSmartContractMethod to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CallOneSmartContractMethod input)
        {
            if (input == null)
            {
                return false;
