...
namespace Tatum.CSharp.Core.Model
{
    ...
    public partial class UpdateCashbackValueForAuthorNftCelo : IEquatable<UpdateCashbackValueForAuthorNftCelo>, IValidatableObject
    {
        ...
        public UpdateCashbackValueForAuthorNftCelo(ChainEnum chain = default(ChainEnum), string tokenId = default(string), string cashbackValue = default(string), string contractAddress = default(string), string fromPrivateKey = default(string), decimal nonce = default(decimal), FeeCurrencyEnum feeCurrency = default(FeeCurrencyEnum))
        {
            this.Chain = chain;
