...
namespace Tatum.CSharp.Core.Model
{
    ...
    public partial class UpdateCashbackValueForAuthorNftCelo : IEquatable<UpdateCashbackValueForAuthorNftCelo>, IValidatableObject
    {
        ...
        public UpdateCashbackValueForAuthorNftCelo(ChainEnum chain = default(ChainEnum), int tokenId = default(int), string contractAddress = default(string), string cashbackValue = default(string), FeeCurrencyEnum feeCurrency = default(FeeCurrencyEnum), string fromPrivateKey = default(string), decimal nonce = default(decimal))
        {
            this.Chain = chain;
