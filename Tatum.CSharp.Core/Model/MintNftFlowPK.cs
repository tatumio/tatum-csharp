...
namespace Tatum.CSharp.Core.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MintNftFlowPK")]
    public partial class MintNftFlowPK : IEquatable<MintNftFlowPK>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MintNftFlowPK" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MintNftFlowPK() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MintNftFlowPK" /> class.
        /// </summary>
        ...
        public MintNftFlowPK(ChainEnum chain = default(ChainEnum), string to = default(string), string url = default(string), string contractAddress = default(string), string account = default(string), string privateKey = default(string))
        {
            this.Chain = chain;
            // to ensure "to" is required (not null)
            if (to == null)
            {
                throw new ArgumentNullException("to is a required property for MintNftFlowPK and cannot be null");
            }
            this.To = to;
            // to ensure "url" is required (not null)
            if (url == null)
            {
                throw new ArgumentNullException("url is a required property for MintNftFlowPK and cannot be null");
            }
            this.Url = url;
            // to ensure "contractAddress" is required (not null)
            if (contractAddress == null)
            {
                throw new ArgumentNullException("contractAddress is a required property for MintNftFlowPK and cannot be null");
            }
            this.ContractAddress = contractAddress;
            // to ensure "account" is required (not null)
            if (account == null)
            {
                throw new ArgumentNullException("account is a required property for MintNftFlowPK and cannot be null");
            }
            this.Account = account;
            // to ensure "privateKey" is required (not null)
            if (privateKey == null)
            {
                throw new ArgumentNullException("privateKey is a required property for MintNftFlowPK and cannot be null");
            }
        ...
        {
            return this.Equals(input as MintNftFlowPK);
        }

        /// <summary>
        /// Returns true if MintNftFlowPK instances are equal
        /// </summary>
        /// <param name="input">Instance of MintNftFlowPK to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MintNftFlowPK input)
        {
            if (input == null)
            {
                return false;
