...
namespace Tatum.CSharp.Core.Model
{
    ...
    public partial class BurnNftTron : IEquatable<BurnNftTron>, IValidatableObject
    {
        ...
        public BurnNftTron(ChainEnum chain = default(ChainEnum), string tokenId = default(string), string contractAddress = default(string), string fromPrivateKey = default(string), decimal feeLimit = default(decimal))
        {
            ...
            {
                throw new ArgumentNullException("contractAddress is a required property for BurnNftTron and cannot be null");
            }
            this.ContractAddress = contractAddress;
            // to ensure "fromPrivateKey" is required (not null)
            if (fromPrivateKey == null)
            {
                throw new ArgumentNullException("fromPrivateKey is a required property for BurnNftTron and cannot be null");
            }
        ...
        {
            return this.Equals(input as BurnNftTron);
        }

        /// <summary>
        /// Returns true if BurnNftTron instances are equal
        /// </summary>
        /// <param name="input">Instance of BurnNftTron to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BurnNftTron input)
        {
            if (input == null)
            {
                return false;
