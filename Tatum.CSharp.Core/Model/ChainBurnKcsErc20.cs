...
namespace Tatum.CSharp.Core.Model
{
    ...
    /// ChainBurnKcsErc20
    /// </summary>
    [DataContract(Name = "ChainBurnKcsErc20")]
    public partial class ChainBurnKcsErc20 : IEquatable<ChainBurnKcsErc20>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ChainBurnKcsErc20" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ChainBurnKcsErc20() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ChainBurnKcsErc20" /> class.
        /// </summary>
        ...
        public ChainBurnKcsErc20(ChainEnum chain = default(ChainEnum), string amount = default(string), string contractAddress = default(string), string fromPrivateKey = default(string), CustomFee fee = default(CustomFee), decimal nonce = default(decimal))
        {
            this.Chain = chain;
            // to ensure "amount" is required (not null)
            if (amount == null)
            {
                throw new ArgumentNullException("amount is a required property for ChainBurnKcsErc20 and cannot be null");
            }
            this.Amount = amount;
            // to ensure "contractAddress" is required (not null)
            if (contractAddress == null)
            {
                throw new ArgumentNullException("contractAddress is a required property for ChainBurnKcsErc20 and cannot be null");
            }
            this.ContractAddress = contractAddress;
            // to ensure "fromPrivateKey" is required (not null)
            if (fromPrivateKey == null)
            {
                throw new ArgumentNullException("fromPrivateKey is a required property for ChainBurnKcsErc20 and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ChainBurnKcsErc20 {\n");
        ...
        {
            return this.Equals(input as ChainBurnKcsErc20);
        }

        /// <summary>
        /// Returns true if ChainBurnKcsErc20 instances are equal
        /// </summary>
        /// <param name="input">Instance of ChainBurnKcsErc20 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ChainBurnKcsErc20 input)
        {
            if (input == null)
            {
                return false;
