...
namespace Tatum.CSharp.Core.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DeployNftFlowMnemonic")]
    public partial class DeployNftFlowMnemonic : IEquatable<DeployNftFlowMnemonic>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DeployNftFlowMnemonic" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DeployNftFlowMnemonic() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DeployNftFlowMnemonic" /> class.
        /// </summary>
        ...
        public DeployNftFlowMnemonic(ChainEnum chain = default(ChainEnum), string account = default(string), string mnemonic = default(string), int index = default(int))
        {
            this.Chain = chain;
            // to ensure "account" is required (not null)
            if (account == null)
            {
                throw new ArgumentNullException("account is a required property for DeployNftFlowMnemonic and cannot be null");
            }
            this.Account = account;
            // to ensure "mnemonic" is required (not null)
            if (mnemonic == null)
            {
                throw new ArgumentNullException("mnemonic is a required property for DeployNftFlowMnemonic and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DeployNftFlowMnemonic {\n");
        ...
        {
            return this.Equals(input as DeployNftFlowMnemonic);
        }

        /// <summary>
        /// Returns true if DeployNftFlowMnemonic instances are equal
        /// </summary>
        /// <param name="input">Instance of DeployNftFlowMnemonic to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeployNftFlowMnemonic input)
        {
            if (input == null)
            {
                return false;
