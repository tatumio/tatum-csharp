...
namespace Tatum.CSharp.Core.Model
{
    ...
    /// ChainMintCeloErc20
    /// </summary>
    [DataContract(Name = "ChainMintCeloErc20")]
    public partial class ChainMintCeloErc20 : IEquatable<ChainMintCeloErc20>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ChainMintCeloErc20" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ChainMintCeloErc20() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ChainMintCeloErc20" /> class.
        /// </summary>
        ...
        public ChainMintCeloErc20(ChainEnum chain = default(ChainEnum), string amount = default(string), string to = default(string), string contractAddress = default(string), string fromPrivateKey = default(string), decimal nonce = default(decimal), FeeCurrencyEnum feeCurrency = default(FeeCurrencyEnum))
        {
            this.Chain = chain;
            // to ensure "amount" is required (not null)
            if (amount == null)
            {
                throw new ArgumentNullException("amount is a required property for ChainMintCeloErc20 and cannot be null");
            }
            this.Amount = amount;
            // to ensure "to" is required (not null)
            if (to == null)
            {
                throw new ArgumentNullException("to is a required property for ChainMintCeloErc20 and cannot be null");
            }
            this.To = to;
            // to ensure "contractAddress" is required (not null)
            if (contractAddress == null)
            {
                throw new ArgumentNullException("contractAddress is a required property for ChainMintCeloErc20 and cannot be null");
            }
            this.ContractAddress = contractAddress;
            // to ensure "fromPrivateKey" is required (not null)
            if (fromPrivateKey == null)
            {
                throw new ArgumentNullException("fromPrivateKey is a required property for ChainMintCeloErc20 and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ChainMintCeloErc20 {\n");
        ...
        {
            return this.Equals(input as ChainMintCeloErc20);
        }

        /// <summary>
        /// Returns true if ChainMintCeloErc20 instances are equal
        /// </summary>
        /// <param name="input">Instance of ChainMintCeloErc20 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ChainMintCeloErc20 input)
        {
            if (input == null)
            {
                return false;
