...
namespace Tatum.CSharp.Core.Model
{
    ...
    public partial class BurnNftKMS : IEquatable<BurnNftKMS>, IValidatableObject
    {
        ...
        public BurnNftKMS(ChainEnum chain = default(ChainEnum), int tokenId = default(int), string contractAddress = default(string), decimal index = default(decimal), Guid signatureId = default(Guid), decimal nonce = default(decimal), CustomFee fee = default(CustomFee))
        {
            this.Chain = chain;
