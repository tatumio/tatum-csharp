...
namespace Tatum.CSharp.Core.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MintNftTron")]
    public partial class MintNftTron : IEquatable<MintNftTron>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MintNftTron" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MintNftTron() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MintNftTron" /> class.
        /// </summary>
        ...
        public MintNftTron(ChainEnum chain = default(ChainEnum), string to = default(string), string contractAddress = default(string), string tokenId = default(string), string url = default(string), decimal feeLimit = default(decimal), string fromPrivateKey = default(string), List<string> authorAddresses = default(List<string>), List<string> cashbackValues = default(List<string>))
        {
            this.Chain = chain;
            // to ensure "to" is required (not null)
            if (to == null)
            {
                throw new ArgumentNullException("to is a required property for MintNftTron and cannot be null");
            }
            this.To = to;
            // to ensure "contractAddress" is required (not null)
            if (contractAddress == null)
            {
                throw new ArgumentNullException("contractAddress is a required property for MintNftTron and cannot be null");
            }
            this.ContractAddress = contractAddress;
            // to ensure "tokenId" is required (not null)
            if (tokenId == null)
            {
                throw new ArgumentNullException("tokenId is a required property for MintNftTron and cannot be null");
            }
            this.TokenId = tokenId;
            // to ensure "url" is required (not null)
            if (url == null)
            {
                throw new ArgumentNullException("url is a required property for MintNftTron and cannot be null");
            }
            this.Url = url;
            ...
            {
                throw new ArgumentNullException("fromPrivateKey is a required property for MintNftTron and cannot be null");
            }
        ...
        {
            return this.Equals(input as MintNftTron);
        }

        /// <summary>
        /// Returns true if MintNftTron instances are equal
        /// </summary>
        /// <param name="input">Instance of MintNftTron to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MintNftTron input)
        {
            if (input == null)
            {
                return false;
