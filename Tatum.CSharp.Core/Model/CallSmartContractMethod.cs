...
namespace Tatum.CSharp.Core.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CallSmartContractMethod")]
    public partial class CallSmartContractMethod : IEquatable<CallSmartContractMethod>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CallSmartContractMethod" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CallSmartContractMethod() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CallSmartContractMethod" /> class.
        /// </summary>
        ...
        public CallSmartContractMethod(string contractAddress = default(string), string methodName = default(string), Object methodABI = default(Object), List<Object> _params = default(List<Object>), string amount = default(string), string fromPrivateKey = default(string), decimal nonce = default(decimal), CallSmartContractMethodFee fee = default(CallSmartContractMethodFee))
        {
            // to ensure "contractAddress" is required (not null)
            if (contractAddress == null) {
                throw new ArgumentNullException("contractAddress is a required property for CallSmartContractMethod and cannot be null");
            }
            this.ContractAddress = contractAddress;
            // to ensure "methodName" is required (not null)
            if (methodName == null) {
                throw new ArgumentNullException("methodName is a required property for CallSmartContractMethod and cannot be null");
            }
            this.MethodName = methodName;
            // to ensure "methodABI" is required (not null)
            if (methodABI == null) {
                throw new ArgumentNullException("methodABI is a required property for CallSmartContractMethod and cannot be null");
            }
            this.MethodABI = methodABI;
            // to ensure "_params" is required (not null)
            if (_params == null) {
                throw new ArgumentNullException("_params is a required property for CallSmartContractMethod and cannot be null");
            }
            this.Params = _params;
            // to ensure "fromPrivateKey" is required (not null)
            if (fromPrivateKey == null) {
                throw new ArgumentNullException("fromPrivateKey is a required property for CallSmartContractMethod and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CallSmartContractMethod {\n");
        ...
        {
            return this.Equals(input as CallSmartContractMethod);
        }

        /// <summary>
        /// Returns true if CallSmartContractMethod instances are equal
        /// </summary>
        /// <param name="input">Instance of CallSmartContractMethod to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CallSmartContractMethod input)
        {
            if (input == null)
            {
                return false;
