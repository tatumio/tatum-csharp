...
namespace Tatum.CSharp.Core.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MintNftExpressAlgorand")]
    public partial class MintNftExpressAlgorand : IEquatable<MintNftExpressAlgorand>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MintNftExpressAlgorand" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MintNftExpressAlgorand() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MintNftExpressAlgorand" /> class.
        /// </summary>
        ...
        public MintNftExpressAlgorand(ChainEnum chain = default(ChainEnum), string url = default(string), string name = default(string), Object attr = default(Object))
        {
            this.Chain = chain;
            // to ensure "url" is required (not null)
            if (url == null)
            {
                throw new ArgumentNullException("url is a required property for MintNftExpressAlgorand and cannot be null");
            }
            this.Url = url;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for MintNftExpressAlgorand and cannot be null");
            }
            this.Name = name;
            this.Attr = attr;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MintNftExpressAlgorand {\n");
        ...
        {
            return this.Equals(input as MintNftExpressAlgorand);
        }

        /// <summary>
        /// Returns true if MintNftExpressAlgorand instances are equal
        /// </summary>
        /// <param name="input">Instance of MintNftExpressAlgorand to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MintNftExpressAlgorand input)
        {
            if (input == null)
            {
                return false;
