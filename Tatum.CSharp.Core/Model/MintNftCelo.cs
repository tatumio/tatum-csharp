...
namespace Tatum.CSharp.Core.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MintNftCelo")]
    public partial class MintNftCelo : IEquatable<MintNftCelo>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MintNftCelo" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MintNftCelo() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MintNftCelo" /> class.
        /// </summary>
        ...
        /// <param name="authorAddresses">The blockchain addresses where the royalties will be sent every time the minted NFT is transferred; the royalties are paid in the native blockchain currency, CELO.</param>
        ...
        public MintNftCelo(ChainEnum chain = default(ChainEnum), string to = default(string), string contractAddress = default(string), string tokenId = default(string), string url = default(string), FeeCurrencyEnum feeCurrency = default(FeeCurrencyEnum), string fromPrivateKey = default(string), string erc20 = default(string), bool provenance = default(bool), List<string> authorAddresses = default(List<string>), List<string> cashbackValues = default(List<string>), List<string> fixedValues = default(List<string>), decimal nonce = default(decimal))
        {
            this.Chain = chain;
            // to ensure "to" is required (not null)
            if (to == null)
            {
                throw new ArgumentNullException("to is a required property for MintNftCelo and cannot be null");
            }
            this.To = to;
            // to ensure "contractAddress" is required (not null)
            if (contractAddress == null)
            {
                throw new ArgumentNullException("contractAddress is a required property for MintNftCelo and cannot be null");
            }
            this.ContractAddress = contractAddress;
            // to ensure "tokenId" is required (not null)
            if (tokenId == null)
            {
                throw new ArgumentNullException("tokenId is a required property for MintNftCelo and cannot be null");
            }
            this.TokenId = tokenId;
            // to ensure "url" is required (not null)
            if (url == null)
            {
                throw new ArgumentNullException("url is a required property for MintNftCelo and cannot be null");
            }
            this.Url = url;
            ...
            {
                throw new ArgumentNullException("fromPrivateKey is a required property for MintNftCelo and cannot be null");
            }
        ...
        /// </summary>
        /// <value>The blockchain addresses where the royalties will be sent every time the minted NFT is transferred; the royalties are paid in the native blockchain currency, CELO</value>
        ...
        {
            return this.Equals(input as MintNftCelo);
        }

        /// <summary>
        /// Returns true if MintNftCelo instances are equal
        /// </summary>
        /// <param name="input">Instance of MintNftCelo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MintNftCelo input)
        {
            if (input == null)
            {
                return false;
