...
namespace Tatum.CSharp.Core.Model
{
    ...
    /// ChainMintKcsErc20
    /// </summary>
    [DataContract(Name = "ChainMintKcsErc20")]
    public partial class ChainMintKcsErc20 : IEquatable<ChainMintKcsErc20>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ChainMintKcsErc20" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ChainMintKcsErc20() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ChainMintKcsErc20" /> class.
        /// </summary>
        ...
        public ChainMintKcsErc20(ChainEnum chain = default(ChainEnum), string amount = default(string), string to = default(string), string contractAddress = default(string), string fromPrivateKey = default(string), decimal nonce = default(decimal))
        {
            this.Chain = chain;
            // to ensure "amount" is required (not null)
            if (amount == null)
            {
                throw new ArgumentNullException("amount is a required property for ChainMintKcsErc20 and cannot be null");
            }
            this.Amount = amount;
            // to ensure "to" is required (not null)
            if (to == null)
            {
                throw new ArgumentNullException("to is a required property for ChainMintKcsErc20 and cannot be null");
            }
            this.To = to;
            // to ensure "contractAddress" is required (not null)
            if (contractAddress == null)
            {
                throw new ArgumentNullException("contractAddress is a required property for ChainMintKcsErc20 and cannot be null");
            }
            this.ContractAddress = contractAddress;
            // to ensure "fromPrivateKey" is required (not null)
            if (fromPrivateKey == null)
            {
                throw new ArgumentNullException("fromPrivateKey is a required property for ChainMintKcsErc20 and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ChainMintKcsErc20 {\n");
        ...
        {
            return this.Equals(input as ChainMintKcsErc20);
        }

        /// <summary>
        /// Returns true if ChainMintKcsErc20 instances are equal
        /// </summary>
        /// <param name="input">Instance of ChainMintKcsErc20 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ChainMintKcsErc20 input)
        {
            if (input == null)
            {
                return false;
