...
namespace Tatum.CSharp.Core.Model
{
    ...
    public partial class MintNftKMS : IEquatable<MintNftKMS>, IValidatableObject
    {
        ...
        public MintNftKMS(ChainEnum chain = default(ChainEnum), string to = default(string), string contractAddress = default(string), int tokenId = default(int), string url = default(string), Guid signatureId = default(Guid), decimal index = default(decimal), string erc20 = default(string), bool provenance = default(bool), List<string> authorAddresses = default(List<string>), List<string> cashbackValues = default(List<string>), List<string> fixedValues = default(List<string>), decimal nonce = default(decimal), CustomFee fee = default(CustomFee))
        {
            this.Chain = chain;
