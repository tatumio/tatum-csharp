...
namespace Tatum.CSharp.Core.Model
{
    ...
    /// BurnNftKMSCelo
    /// </summary>
    [DataContract(Name = "BurnNftKMSCelo")]
    public partial class BurnNftKMSCelo : IEquatable<BurnNftKMSCelo>, IValidatableObject
    {
        /// <summary>
        ...
        public BurnNftKMSCelo(ChainEnum chain = default(ChainEnum), int tokenId = default(int), string contractAddress = default(string), decimal index = default(decimal), Guid signatureId = default(Guid), decimal nonce = default(decimal), FeeCurrencyEnum feeCurrency = default(FeeCurrencyEnum))
        {
            this.Chain = chain;
            ...
            {
                throw new ArgumentNullException("contractAddress is a required property for BurnNftKMSCelo and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BurnNftKMSCelo {\n");
        ...
        {
            return this.Equals(input as BurnNftKMSCelo);
        }

        /// <summary>
        /// Returns true if BurnNftKMSCelo instances are equal
        /// </summary>
        /// <param name="input">Instance of BurnNftKMSCelo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BurnNftKMSCelo input)
        {
            if (input == null)
            {
                return false;
