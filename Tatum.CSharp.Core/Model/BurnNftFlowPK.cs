...
namespace Tatum.CSharp.Core.Model
{
    ...
    public partial class BurnNftFlowPK : IEquatable<BurnNftFlowPK>, IValidatableObject
    {
        ...
        public BurnNftFlowPK(ChainEnum chain = default(ChainEnum), int tokenId = default(int), string contractAddress = default(string), string account = default(string), string privateKey = default(string))
        {
            this.Chain = chain;
