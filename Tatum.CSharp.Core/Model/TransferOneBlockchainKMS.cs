...
namespace Tatum.CSharp.Core.Model
{
    ...
    public partial class TransferOneBlockchainKMS : IEquatable<TransferOneBlockchainKMS>, IValidatableObject
    {
        ...
        public TransferOneBlockchainKMS(string data = default(string), CurrencyEnum currency = default(CurrencyEnum), decimal nonce = default(decimal), string to = default(string), CustomFee fee = default(CustomFee), string amount = default(string), decimal index = default(decimal), Guid signatureId = default(Guid))
        {
