...
namespace Tatum.CSharp.Core.Model
{
    ...
    /// ChainDeployKcsErc20
    /// </summary>
    [DataContract(Name = "ChainDeployKcsErc20")]
    public partial class ChainDeployKcsErc20 : IEquatable<ChainDeployKcsErc20>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ChainDeployKcsErc20" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ChainDeployKcsErc20() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ChainDeployKcsErc20" /> class.
        /// </summary>
        ...
        public ChainDeployKcsErc20(ChainEnum chain = default(ChainEnum), string symbol = default(string), string name = default(string), string totalCap = default(string), string supply = default(string), decimal digits = default(decimal), string address = default(string), string fromPrivateKey = default(string), decimal nonce = default(decimal), CustomFee fee = default(CustomFee))
        {
            this.Chain = chain;
            // to ensure "symbol" is required (not null)
            if (symbol == null)
            {
                throw new ArgumentNullException("symbol is a required property for ChainDeployKcsErc20 and cannot be null");
            }
            this.Symbol = symbol;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for ChainDeployKcsErc20 and cannot be null");
            }
            this.Name = name;
            // to ensure "supply" is required (not null)
            if (supply == null)
            {
                throw new ArgumentNullException("supply is a required property for ChainDeployKcsErc20 and cannot be null");
            }
            this.Supply = supply;
            this.Digits = digits;
            ...
            if (address == null)
            {
                throw new ArgumentNullException("address is a required property for ChainDeployKcsErc20 and cannot be null");
            }
            this.Address = address;
            // to ensure "fromPrivateKey" is required (not null)
            if (fromPrivateKey == null)
            {
                throw new ArgumentNullException("fromPrivateKey is a required property for ChainDeployKcsErc20 and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ChainDeployKcsErc20 {\n");
        ...
        {
            return this.Equals(input as ChainDeployKcsErc20);
        }

        /// <summary>
        /// Returns true if ChainDeployKcsErc20 instances are equal
        /// </summary>
        /// <param name="input">Instance of ChainDeployKcsErc20 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ChainDeployKcsErc20 input)
        {
            if (input == null)
            {
                return false;
