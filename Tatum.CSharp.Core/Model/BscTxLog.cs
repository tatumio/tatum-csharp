...
namespace Tatum.CSharp.Core.Model
{
    ...
    /// BscTxLog
    /// </summary>
    [DataContract(Name = "BscTxLog")]
    public partial class BscTxLog : IEquatable<BscTxLog>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BscTxLog" /> class.
        /// </summary>
        ...
        public BscTxLog(string address = default(string), List<string> topics = default(List<string>), string data = default(string), decimal logIndex = default(decimal), decimal blockNumber = default(decimal), string blockHash = default(string), decimal transactionIndex = default(decimal), string transactionHash = default(string))
        {
        ...
        {
            return this.Equals(input as BscTxLog);
        }

        /// <summary>
        /// Returns true if BscTxLog instances are equal
        /// </summary>
        /// <param name="input">Instance of BscTxLog to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BscTxLog input)
        {
            if (input == null)
            {
                return false;
