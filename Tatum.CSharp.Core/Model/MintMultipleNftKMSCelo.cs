...
namespace Tatum.CSharp.Core.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MintMultipleNftKMSCelo")]
    public partial class MintMultipleNftKMSCelo : IEquatable<MintMultipleNftKMSCelo>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MintMultipleNftKMSCelo" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MintMultipleNftKMSCelo() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MintMultipleNftKMSCelo" /> class.
        /// </summary>
        ...
        public MintMultipleNftKMSCelo(ChainEnum chain = default(ChainEnum), List<string> to = default(List<string>), List<string> tokenId = default(List<string>), List<string> url = default(List<string>), List<List<string>> authorAddresses = default(List<List<string>>), List<List<string>> cashbackValues = default(List<List<string>>), string contractAddress = default(string), decimal index = default(decimal), Guid signatureId = default(Guid), decimal nonce = default(decimal), FeeCurrencyEnum feeCurrency = default(FeeCurrencyEnum))
        {
            this.Chain = chain;
            // to ensure "to" is required (not null)
            if (to == null)
            {
                throw new ArgumentNullException("to is a required property for MintMultipleNftKMSCelo and cannot be null");
            }
            this.To = to;
            // to ensure "tokenId" is required (not null)
            if (tokenId == null)
            {
                throw new ArgumentNullException("tokenId is a required property for MintMultipleNftKMSCelo and cannot be null");
            }
            this.TokenId = tokenId;
            // to ensure "url" is required (not null)
            if (url == null)
            {
                throw new ArgumentNullException("url is a required property for MintMultipleNftKMSCelo and cannot be null");
            }
            this.Url = url;
            // to ensure "contractAddress" is required (not null)
            if (contractAddress == null)
            {
                throw new ArgumentNullException("contractAddress is a required property for MintMultipleNftKMSCelo and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MintMultipleNftKMSCelo {\n");
        ...
        {
            return this.Equals(input as MintMultipleNftKMSCelo);
        }

        /// <summary>
        /// Returns true if MintMultipleNftKMSCelo instances are equal
        /// </summary>
        /// <param name="input">Instance of MintMultipleNftKMSCelo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MintMultipleNftKMSCelo input)
        {
            if (input == null)
            {
                return false;
