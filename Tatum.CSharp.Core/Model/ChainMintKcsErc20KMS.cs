...
namespace Tatum.CSharp.Core.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ChainMintKcsErc20KMS")]
    public partial class ChainMintKcsErc20KMS : IEquatable<ChainMintKcsErc20KMS>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ChainMintKcsErc20KMS" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ChainMintKcsErc20KMS() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ChainMintKcsErc20KMS" /> class.
        /// </summary>
        ...
        public ChainMintKcsErc20KMS(ChainEnum chain = default(ChainEnum), string amount = default(string), string to = default(string), string contractAddress = default(string), Guid signatureId = default(Guid), decimal nonce = default(decimal))
        {
            this.Chain = chain;
            // to ensure "amount" is required (not null)
            if (amount == null)
            {
                throw new ArgumentNullException("amount is a required property for ChainMintKcsErc20KMS and cannot be null");
            }
            this.Amount = amount;
            // to ensure "to" is required (not null)
            if (to == null)
            {
                throw new ArgumentNullException("to is a required property for ChainMintKcsErc20KMS and cannot be null");
            }
            this.To = to;
            // to ensure "contractAddress" is required (not null)
            if (contractAddress == null)
            {
                throw new ArgumentNullException("contractAddress is a required property for ChainMintKcsErc20KMS and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ChainMintKcsErc20KMS {\n");
        ...
        {
            return this.Equals(input as ChainMintKcsErc20KMS);
        }

        /// <summary>
        /// Returns true if ChainMintKcsErc20KMS instances are equal
        /// </summary>
        /// <param name="input">Instance of ChainMintKcsErc20KMS to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ChainMintKcsErc20KMS input)
        {
            if (input == null)
            {
                return false;
