...
namespace Tatum.CSharp.Core.Model
{
    ...
    public partial class TransferEthBlockchain : IEquatable<TransferEthBlockchain>, IValidatableObject
    {
        ...
        public TransferEthBlockchain(string data = default(string), decimal nonce = default(decimal), string to = default(string), CurrencyEnum currency = default(CurrencyEnum), CallSmartContractMethodFee fee = default(CallSmartContractMethodFee), string amount = default(string), string fromPrivateKey = default(string))
        {
