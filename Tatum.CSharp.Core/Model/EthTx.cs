...
namespace Tatum.CSharp.Core.Model
{
    ...
    /// EthTx
    /// </summary>
    [DataContract(Name = "EthTx")]
    public partial class EthTx : IEquatable<EthTx>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EthTx" /> class.
        /// </summary>
        ...
        public EthTx(string blockHash = default(string), bool status = default(bool), decimal blockNumber = default(decimal), string from = default(string), decimal gas = default(decimal), string gasPrice = default(string), string transactionHash = default(string), string input = default(string), decimal nonce = default(decimal), string to = default(string), decimal transactionIndex = default(decimal), string value = default(string), decimal gasUsed = default(decimal), decimal cumulativeGasUsed = default(decimal), string contractAddress = default(string), List<EthTxLogs> logs = default(List<EthTxLogs>))
        {
        ...
        public List<EthTxLogs> Logs { get; set; }
        ...
        {
            return this.Equals(input as EthTx);
        }

        /// <summary>
        /// Returns true if EthTx instances are equal
        /// </summary>
        /// <param name="input">Instance of EthTx to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EthTx input)
        {
            if (input == null)
            {
                return false;
