...
namespace Tatum.CSharp.Core.Model
{
    ...
    /// ApproveCeloErc20KMS
    /// </summary>
    [DataContract(Name = "ApproveCeloErc20KMS")]
    public partial class ApproveCeloErc20KMS : IEquatable<ApproveCeloErc20KMS>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ApproveCeloErc20KMS" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ApproveCeloErc20KMS() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ApproveCeloErc20KMS" /> class.
        /// </summary>
        ...
        public ApproveCeloErc20KMS(ChainEnum chain = default(ChainEnum), string amount = default(string), string spender = default(string), string contractAddress = default(string), Guid signatureId = default(Guid), CustomFee fee = default(CustomFee), decimal nonce = default(decimal), FeeCurrencyEnum feeCurrency = default(FeeCurrencyEnum))
        {
            this.Chain = chain;
            // to ensure "amount" is required (not null)
            if (amount == null)
            {
                throw new ArgumentNullException("amount is a required property for ApproveCeloErc20KMS and cannot be null");
            }
            this.Amount = amount;
            // to ensure "spender" is required (not null)
            if (spender == null)
            {
                throw new ArgumentNullException("spender is a required property for ApproveCeloErc20KMS and cannot be null");
            }
            this.Spender = spender;
            // to ensure "contractAddress" is required (not null)
            if (contractAddress == null)
            {
                throw new ArgumentNullException("contractAddress is a required property for ApproveCeloErc20KMS and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ApproveCeloErc20KMS {\n");
        ...
        {
            return this.Equals(input as ApproveCeloErc20KMS);
        }

        /// <summary>
        /// Returns true if ApproveCeloErc20KMS instances are equal
        /// </summary>
        /// <param name="input">Instance of ApproveCeloErc20KMS to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApproveCeloErc20KMS input)
        {
            if (input == null)
            {
                return false;
