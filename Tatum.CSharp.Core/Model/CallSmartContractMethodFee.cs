...
namespace Tatum.CSharp.Core.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CallSmartContractMethod_fee")]
    public partial class CallSmartContractMethodFee : IEquatable<CallSmartContractMethodFee>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CallSmartContractMethodFee" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CallSmartContractMethodFee() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CallSmartContractMethodFee" /> class.
        /// </summary>
        ...
        public CallSmartContractMethodFee(string gasLimit = default(string), string gasPrice = default(string))
        {
            // to ensure "gasLimit" is required (not null)
            if (gasLimit == null) {
                throw new ArgumentNullException("gasLimit is a required property for CallSmartContractMethodFee and cannot be null");
            }
            this.GasLimit = gasLimit;
            // to ensure "gasPrice" is required (not null)
            if (gasPrice == null) {
                throw new ArgumentNullException("gasPrice is a required property for CallSmartContractMethodFee and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CallSmartContractMethodFee {\n");
        ...
        {
            return this.Equals(input as CallSmartContractMethodFee);
        }

        /// <summary>
        /// Returns true if CallSmartContractMethodFee instances are equal
        /// </summary>
        /// <param name="input">Instance of CallSmartContractMethodFee to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CallSmartContractMethodFee input)
        {
            if (input == null)
            {
                return false;
