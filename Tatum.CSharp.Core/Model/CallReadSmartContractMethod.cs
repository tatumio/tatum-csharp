...
namespace Tatum.CSharp.Core.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CallReadSmartContractMethod")]
    public partial class CallReadSmartContractMethod : IEquatable<CallReadSmartContractMethod>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CallReadSmartContractMethod" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CallReadSmartContractMethod() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CallReadSmartContractMethod" /> class.
        /// </summary>
        ...
        public CallReadSmartContractMethod(string contractAddress = default(string), string methodName = default(string), Object methodABI = default(Object), List<Object> _params = default(List<Object>))
        {
            // to ensure "contractAddress" is required (not null)
            if (contractAddress == null) {
                throw new ArgumentNullException("contractAddress is a required property for CallReadSmartContractMethod and cannot be null");
            }
            this.ContractAddress = contractAddress;
            // to ensure "methodName" is required (not null)
            if (methodName == null) {
                throw new ArgumentNullException("methodName is a required property for CallReadSmartContractMethod and cannot be null");
            }
            this.MethodName = methodName;
            // to ensure "methodABI" is required (not null)
            if (methodABI == null) {
                throw new ArgumentNullException("methodABI is a required property for CallReadSmartContractMethod and cannot be null");
            }
            this.MethodABI = methodABI;
            // to ensure "_params" is required (not null)
            if (_params == null) {
                throw new ArgumentNullException("_params is a required property for CallReadSmartContractMethod and cannot be null");
            }
            this.Params = _params;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CallReadSmartContractMethod {\n");
        ...
        {
            return this.Equals(input as CallReadSmartContractMethod);
        }

        /// <summary>
        /// Returns true if CallReadSmartContractMethod instances are equal
        /// </summary>
        /// <param name="input">Instance of CallReadSmartContractMethod to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CallReadSmartContractMethod input)
        {
            if (input == null)
            {
                return false;
