...
namespace Tatum.CSharp.Core.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ChainTransferCeloErc20Token")]
    public partial class ChainTransferCeloErc20Token : IEquatable<ChainTransferCeloErc20Token>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ChainTransferCeloErc20Token" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ChainTransferCeloErc20Token() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ChainTransferCeloErc20Token" /> class.
        /// </summary>
        ...
        public ChainTransferCeloErc20Token(ChainEnum chain = default(ChainEnum), string to = default(string), string contractAddress = default(string), string amount = default(string), decimal digits = default(decimal), string fromPrivateKey = default(string), decimal nonce = default(decimal), FeeCurrencyEnum feeCurrency = default(FeeCurrencyEnum))
        {
            this.Chain = chain;
            // to ensure "to" is required (not null)
            if (to == null)
            {
                throw new ArgumentNullException("to is a required property for ChainTransferCeloErc20Token and cannot be null");
            }
            this.To = to;
            // to ensure "contractAddress" is required (not null)
            if (contractAddress == null)
            {
                throw new ArgumentNullException("contractAddress is a required property for ChainTransferCeloErc20Token and cannot be null");
            }
            this.ContractAddress = contractAddress;
            // to ensure "amount" is required (not null)
            if (amount == null)
            {
                throw new ArgumentNullException("amount is a required property for ChainTransferCeloErc20Token and cannot be null");
            }
            this.Amount = amount;
            this.Digits = digits;
            ...
            {
                throw new ArgumentNullException("fromPrivateKey is a required property for ChainTransferCeloErc20Token and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ChainTransferCeloErc20Token {\n");
        ...
        {
            return this.Equals(input as ChainTransferCeloErc20Token);
        }

        /// <summary>
        /// Returns true if ChainTransferCeloErc20Token instances are equal
        /// </summary>
        /// <param name="input">Instance of ChainTransferCeloErc20Token to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ChainTransferCeloErc20Token input)
        {
            if (input == null)
            {
                return false;
