...
namespace Tatum.CSharp.Core.Model
{
    ...
    public partial class MintNftKMSCelo : IEquatable<MintNftKMSCelo>, IValidatableObject
    {
        ...
        public MintNftKMSCelo(ChainEnum chain = default(ChainEnum), string to = default(string), string contractAddress = default(string), int tokenId = default(int), string url = default(string), FeeCurrencyEnum feeCurrency = default(FeeCurrencyEnum), Guid signatureId = default(Guid), decimal index = default(decimal), string erc20 = default(string), bool provenance = default(bool), List<string> authorAddresses = default(List<string>), List<string> cashbackValues = default(List<string>), List<string> fixedValues = default(List<string>), decimal nonce = default(decimal))
        {
            this.Chain = chain;
