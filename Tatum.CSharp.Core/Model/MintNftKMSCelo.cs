...
namespace Tatum.CSharp.Core.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MintNftKMSCelo")]
    public partial class MintNftKMSCelo : IEquatable<MintNftKMSCelo>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MintNftKMSCelo" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MintNftKMSCelo() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MintNftKMSCelo" /> class.
        /// </summary>
        ...
        public MintNftKMSCelo(ChainEnum chain = default(ChainEnum), string to = default(string), string contractAddress = default(string), string tokenId = default(string), string url = default(string), FeeCurrencyEnum feeCurrency = default(FeeCurrencyEnum), Guid signatureId = default(Guid), decimal index = default(decimal), string erc20 = default(string), bool provenance = default(bool), List<string> authorAddresses = default(List<string>), List<string> cashbackValues = default(List<string>), List<string> fixedValues = default(List<string>), decimal nonce = default(decimal))
        {
            this.Chain = chain;
            // to ensure "to" is required (not null)
            if (to == null)
            {
                throw new ArgumentNullException("to is a required property for MintNftKMSCelo and cannot be null");
            }
            this.To = to;
            // to ensure "contractAddress" is required (not null)
            if (contractAddress == null)
            {
                throw new ArgumentNullException("contractAddress is a required property for MintNftKMSCelo and cannot be null");
            }
            this.ContractAddress = contractAddress;
            // to ensure "tokenId" is required (not null)
            if (tokenId == null)
            {
                throw new ArgumentNullException("tokenId is a required property for MintNftKMSCelo and cannot be null");
            }
            this.TokenId = tokenId;
            // to ensure "url" is required (not null)
            if (url == null)
            {
                throw new ArgumentNullException("url is a required property for MintNftKMSCelo and cannot be null");
            }
            this.Url = url;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MintNftKMSCelo {\n");
        ...
        {
            return this.Equals(input as MintNftKMSCelo);
        }

        /// <summary>
        /// Returns true if MintNftKMSCelo instances are equal
        /// </summary>
        /// <param name="input">Instance of MintNftKMSCelo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MintNftKMSCelo input)
        {
            if (input == null)
            {
                return false;
