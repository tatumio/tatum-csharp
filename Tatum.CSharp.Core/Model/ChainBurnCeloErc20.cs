...
namespace Tatum.CSharp.Core.Model
{
    ...
    /// ChainBurnCeloErc20
    /// </summary>
    [DataContract(Name = "ChainBurnCeloErc20")]
    public partial class ChainBurnCeloErc20 : IEquatable<ChainBurnCeloErc20>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ChainBurnCeloErc20" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ChainBurnCeloErc20() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ChainBurnCeloErc20" /> class.
        /// </summary>
        ...
        public ChainBurnCeloErc20(ChainEnum chain = default(ChainEnum), string amount = default(string), string contractAddress = default(string), string fromPrivateKey = default(string), CustomFee fee = default(CustomFee), decimal nonce = default(decimal), FeeCurrencyEnum feeCurrency = default(FeeCurrencyEnum))
        {
            this.Chain = chain;
            // to ensure "amount" is required (not null)
            if (amount == null)
            {
                throw new ArgumentNullException("amount is a required property for ChainBurnCeloErc20 and cannot be null");
            }
            this.Amount = amount;
            // to ensure "contractAddress" is required (not null)
            if (contractAddress == null)
            {
                throw new ArgumentNullException("contractAddress is a required property for ChainBurnCeloErc20 and cannot be null");
            }
            this.ContractAddress = contractAddress;
            // to ensure "fromPrivateKey" is required (not null)
            if (fromPrivateKey == null)
            {
                throw new ArgumentNullException("fromPrivateKey is a required property for ChainBurnCeloErc20 and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ChainBurnCeloErc20 {\n");
        ...
        {
            return this.Equals(input as ChainBurnCeloErc20);
        }

        /// <summary>
        /// Returns true if ChainBurnCeloErc20 instances are equal
        /// </summary>
        /// <param name="input">Instance of ChainBurnCeloErc20 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ChainBurnCeloErc20 input)
        {
            if (input == null)
            {
                return false;
