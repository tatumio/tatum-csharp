...
namespace Tatum.CSharp.Core.Model
{
    ...
    /// DeployNftCelo
    /// </summary>
    [DataContract(Name = "DeployNftCelo")]
    public partial class DeployNftCelo : IEquatable<DeployNftCelo>, IValidatableObject
    {
        ...
        public DeployNftCelo(ChainEnum chain = default(ChainEnum), string name = default(string), bool provenance = default(bool), bool cashback = default(bool), bool publicMint = default(bool), string symbol = default(string), string fromPrivateKey = default(string), decimal nonce = default(decimal), FeeCurrencyEnum feeCurrency = default(FeeCurrencyEnum))
        {
            ...
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for DeployNftCelo and cannot be null");
            }
            this.Name = name;
            // to ensure "symbol" is required (not null)
            if (symbol == null)
            {
                throw new ArgumentNullException("symbol is a required property for DeployNftCelo and cannot be null");
            }
            this.Symbol = symbol;
            // to ensure "fromPrivateKey" is required (not null)
            if (fromPrivateKey == null)
            {
                throw new ArgumentNullException("fromPrivateKey is a required property for DeployNftCelo and cannot be null");
            }
        ...
        {
            return this.Equals(input as DeployNftCelo);
        }

        /// <summary>
        /// Returns true if DeployNftCelo instances are equal
        /// </summary>
        /// <param name="input">Instance of DeployNftCelo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeployNftCelo input)
        {
            if (input == null)
            {
                return false;
