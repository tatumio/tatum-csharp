...
namespace Tatum.CSharp.Core.Model
{
    ...
    /// TransferNftCelo
    /// </summary>
    [DataContract(Name = "TransferNftCelo")]
    public partial class TransferNftCelo : IEquatable<TransferNftCelo>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TransferNftCelo" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TransferNftCelo() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TransferNftCelo" /> class.
        /// </summary>
        ...
        /// <param name="feeCurrency">The currency in which the transaction fee will be paid.</param>
        public TransferNftCelo(string value = default(string), ChainEnum chain = default(ChainEnum), string to = default(string), string tokenId = default(string), bool provenance = default(bool), string provenanceData = default(string), string tokenPrice = default(string), string contractAddress = default(string), string fromPrivateKey = default(string), decimal nonce = default(decimal), FeeCurrencyEnum? feeCurrency = default(FeeCurrencyEnum?))
        {
            this.Chain = chain;
            // to ensure "to" is required (not null)
            if (to == null)
            {
                throw new ArgumentNullException("to is a required property for TransferNftCelo and cannot be null");
            }
            this.To = to;
            // to ensure "tokenId" is required (not null)
            if (tokenId == null)
            {
                throw new ArgumentNullException("tokenId is a required property for TransferNftCelo and cannot be null");
            }
            this.TokenId = tokenId;
            // to ensure "contractAddress" is required (not null)
            if (contractAddress == null)
            {
                throw new ArgumentNullException("contractAddress is a required property for TransferNftCelo and cannot be null");
            }
            this.ContractAddress = contractAddress;
            // to ensure "fromPrivateKey" is required (not null)
            if (fromPrivateKey == null)
            {
                throw new ArgumentNullException("fromPrivateKey is a required property for TransferNftCelo and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransferNftCelo {\n");
        ...
        {
            return this.Equals(input as TransferNftCelo);
        }

        /// <summary>
        /// Returns true if TransferNftCelo instances are equal
        /// </summary>
        /// <param name="input">Instance of TransferNftCelo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransferNftCelo input)
        {
            if (input == null)
            {
                return false;
