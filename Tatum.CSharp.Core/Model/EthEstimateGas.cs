...
namespace Tatum.CSharp.Core.Model
{
    ...
    /// EthEstimateGas
    /// </summary>
    [DataContract(Name = "EthEstimateGas")]
    public partial class EthEstimateGas : IEquatable<EthEstimateGas>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EthEstimateGas" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EthEstimateGas() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EthEstimateGas" /> class.
        /// </summary>
        ...
        public EthEstimateGas(string from = default(string), string to = default(string), string contractAddress = default(string), string amount = default(string), string data = default(string))
        {
            ...
            if (from == null)
            {
                throw new ArgumentNullException("from is a required property for EthEstimateGas and cannot be null");
            }
            this.From = from;
            // to ensure "to" is required (not null)
            if (to == null)
            {
                throw new ArgumentNullException("to is a required property for EthEstimateGas and cannot be null");
            }
            this.To = to;
            // to ensure "amount" is required (not null)
            if (amount == null)
            {
                throw new ArgumentNullException("amount is a required property for EthEstimateGas and cannot be null");
            }
            this.Amount = amount;
        ...
        /// </summary>
        /// <value>Amount to be sent in Ether or ERC20.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EthEstimateGas {\n");
        ...
        {
            return this.Equals(input as EthEstimateGas);
        }

        /// <summary>
        /// Returns true if EthEstimateGas instances are equal
        /// </summary>
        /// <param name="input">Instance of EthEstimateGas to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EthEstimateGas input)
        {
            if (input == null)
            {
                return false;
