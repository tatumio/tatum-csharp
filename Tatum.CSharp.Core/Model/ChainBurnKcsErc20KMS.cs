...
namespace Tatum.CSharp.Core.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ChainBurnKcsErc20KMS")]
    public partial class ChainBurnKcsErc20KMS : IEquatable<ChainBurnKcsErc20KMS>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ChainBurnKcsErc20KMS" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ChainBurnKcsErc20KMS() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ChainBurnKcsErc20KMS" /> class.
        /// </summary>
        ...
        public ChainBurnKcsErc20KMS(ChainEnum chain = default(ChainEnum), string amount = default(string), string contractAddress = default(string), Guid signatureId = default(Guid), CustomFee fee = default(CustomFee), decimal nonce = default(decimal))
        {
            this.Chain = chain;
            // to ensure "amount" is required (not null)
            if (amount == null)
            {
                throw new ArgumentNullException("amount is a required property for ChainBurnKcsErc20KMS and cannot be null");
            }
            this.Amount = amount;
            // to ensure "contractAddress" is required (not null)
            if (contractAddress == null)
            {
                throw new ArgumentNullException("contractAddress is a required property for ChainBurnKcsErc20KMS and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ChainBurnKcsErc20KMS {\n");
        ...
        {
            return this.Equals(input as ChainBurnKcsErc20KMS);
        }

        /// <summary>
        /// Returns true if ChainBurnKcsErc20KMS instances are equal
        /// </summary>
        /// <param name="input">Instance of ChainBurnKcsErc20KMS to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ChainBurnKcsErc20KMS input)
        {
            if (input == null)
            {
                return false;
