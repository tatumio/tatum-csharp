...
namespace Tatum.CSharp.Core.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MintMultipleNftFlowMnemonic")]
    public partial class MintMultipleNftFlowMnemonic : IEquatable<MintMultipleNftFlowMnemonic>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MintMultipleNftFlowMnemonic" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MintMultipleNftFlowMnemonic() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MintMultipleNftFlowMnemonic" /> class.
        /// </summary>
        ...
        public MintMultipleNftFlowMnemonic(ChainEnum chain = default(ChainEnum), List<string> to = default(List<string>), List<string> url = default(List<string>), string contractAddress = default(string), string account = default(string), string mnemonic = default(string), int index = default(int))
        {
            this.Chain = chain;
            // to ensure "to" is required (not null)
            if (to == null)
            {
                throw new ArgumentNullException("to is a required property for MintMultipleNftFlowMnemonic and cannot be null");
            }
            this.To = to;
            // to ensure "url" is required (not null)
            if (url == null)
            {
                throw new ArgumentNullException("url is a required property for MintMultipleNftFlowMnemonic and cannot be null");
            }
            this.Url = url;
            // to ensure "contractAddress" is required (not null)
            if (contractAddress == null)
            {
                throw new ArgumentNullException("contractAddress is a required property for MintMultipleNftFlowMnemonic and cannot be null");
            }
            this.ContractAddress = contractAddress;
            // to ensure "account" is required (not null)
            if (account == null)
            {
                throw new ArgumentNullException("account is a required property for MintMultipleNftFlowMnemonic and cannot be null");
            }
            this.Account = account;
            // to ensure "mnemonic" is required (not null)
            if (mnemonic == null)
            {
                throw new ArgumentNullException("mnemonic is a required property for MintMultipleNftFlowMnemonic and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MintMultipleNftFlowMnemonic {\n");
        ...
        {
            return this.Equals(input as MintMultipleNftFlowMnemonic);
        }

        /// <summary>
        /// Returns true if MintMultipleNftFlowMnemonic instances are equal
        /// </summary>
        /// <param name="input">Instance of MintMultipleNftFlowMnemonic to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MintMultipleNftFlowMnemonic input)
        {
            if (input == null)
            {
                return false;
