...
namespace Tatum.CSharp.Core.Model
{
    ...
    /// DeployNftCeloKMS
    /// </summary>
    [DataContract(Name = "DeployNftCeloKMS")]
    public partial class DeployNftCeloKMS : IEquatable<DeployNftCeloKMS>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DeployNftCeloKMS" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DeployNftCeloKMS() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DeployNftCeloKMS" /> class.
        /// </summary>
        ...
        public DeployNftCeloKMS(ChainEnum chain = default(ChainEnum), string name = default(string), string symbol = default(string), decimal index = default(decimal), Guid signatureId = default(Guid), decimal nonce = default(decimal), bool provenance = default(bool), bool cashback = default(bool), bool publicMint = default(bool), FeeCurrencyEnum feeCurrency = default(FeeCurrencyEnum))
        {
            this.Chain = chain;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for DeployNftCeloKMS and cannot be null");
            }
            this.Name = name;
            // to ensure "symbol" is required (not null)
            if (symbol == null)
            {
                throw new ArgumentNullException("symbol is a required property for DeployNftCeloKMS and cannot be null");
            }
            this.Symbol = symbol;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DeployNftCeloKMS {\n");
        ...
        {
            return this.Equals(input as DeployNftCeloKMS);
        }

        /// <summary>
        /// Returns true if DeployNftCeloKMS instances are equal
        /// </summary>
        /// <param name="input">Instance of DeployNftCeloKMS to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeployNftCeloKMS input)
        {
            if (input == null)
            {
                return false;
