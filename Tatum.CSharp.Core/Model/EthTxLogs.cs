...
namespace Tatum.CSharp.Core.Model
{
    ...
    /// EthTxLogs
    /// </summary>
    [DataContract(Name = "EthTx_logs")]
    public partial class EthTxLogs : IEquatable<EthTxLogs>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EthTxLogs" /> class.
        /// </summary>
        ...
        public EthTxLogs(string address = default(string), List<string> topics = default(List<string>), string data = default(string), decimal logIndex = default(decimal), decimal transactionIndex = default(decimal), string transactionHash = default(string))
        {
        ...
        {
            return this.Equals(input as EthTxLogs);
        }

        /// <summary>
        /// Returns true if EthTxLogs instances are equal
        /// </summary>
        /// <param name="input">Instance of EthTxLogs to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EthTxLogs input)
        {
            if (input == null)
            {
                return false;
