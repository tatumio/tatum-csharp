...
namespace Tatum.CSharp.Core.Model
{
    ...
    public partial class TransferNftFlowPK : IEquatable<TransferNftFlowPK>, IValidatableObject
    {
        ...
        public TransferNftFlowPK(ChainEnum chain = default(ChainEnum), string to = default(string), int tokenId = default(int), string contractAddress = default(string), string account = default(string), string privateKey = default(string))
        {
            this.Chain = chain;
