...
namespace Tatum.CSharp.Core.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ChainDeployCeloErc20KMS")]
    public partial class ChainDeployCeloErc20KMS : IEquatable<ChainDeployCeloErc20KMS>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ChainDeployCeloErc20KMS" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ChainDeployCeloErc20KMS() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ChainDeployCeloErc20KMS" /> class.
        /// </summary>
        ...
        public ChainDeployCeloErc20KMS(ChainEnum chain = default(ChainEnum), string symbol = default(string), string name = default(string), string totalCap = default(string), string supply = default(string), decimal digits = default(decimal), string address = default(string), Guid signatureId = default(Guid), decimal nonce = default(decimal), FeeCurrencyEnum feeCurrency = default(FeeCurrencyEnum))
        {
            this.Chain = chain;
            // to ensure "symbol" is required (not null)
            if (symbol == null)
            {
                throw new ArgumentNullException("symbol is a required property for ChainDeployCeloErc20KMS and cannot be null");
            }
            this.Symbol = symbol;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for ChainDeployCeloErc20KMS and cannot be null");
            }
            this.Name = name;
            // to ensure "supply" is required (not null)
            if (supply == null)
            {
                throw new ArgumentNullException("supply is a required property for ChainDeployCeloErc20KMS and cannot be null");
            }
            this.Supply = supply;
            this.Digits = digits;
            ...
            if (address == null)
            {
                throw new ArgumentNullException("address is a required property for ChainDeployCeloErc20KMS and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ChainDeployCeloErc20KMS {\n");
        ...
        {
            return this.Equals(input as ChainDeployCeloErc20KMS);
        }

        /// <summary>
        /// Returns true if ChainDeployCeloErc20KMS instances are equal
        /// </summary>
        /// <param name="input">Instance of ChainDeployCeloErc20KMS to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ChainDeployCeloErc20KMS input)
        {
            if (input == null)
            {
                return false;
