...
namespace Tatum.CSharp.Core.Api
{
    ...
    /// </summary>
    public interface INFTEthApiSync : IApiAccessor
    {
        ...
        /// </summary>
        /// <remarks>
        /// 100 credits per API call on Flow 2 credits per API call on the other blockchains Deploy an NFT smart contract on the blockchain. In a deployed NFT smart contract, you can mint NFTs (one NFT at a time or multiple NFTs at once), burn, and transfer NFTs. Smart contracts are standardized and audited. This API is supported for the following blockchains: BNB Smart Chain Celo Ethereum Flow Harmony Klaytn KuCoin Community Chain Polygon TRON By default, an NFT smart contract is deployed as a general ERC-721 smart contract compatible with OpenSea royalties. This is a standard ERC-721 contract with AccessControl and Ownable, enhanced with NFT batch minting. NFTs minted in this smart contract are compatible with OpenSea and its royalty structure. In addition to the general ERC-721 contract, you can also deploy the following types of NFT smart contracts for the supported blockchains except for Flow and TRON: Cashback ERC-721 smart contract is an ERC-721 smart contract that forces on-chain royalties to be paid every time an NFT is transferred. The royalties are defined as a fixed value and are not OpenSea-compatible. To deploy an NFT smart contract as a cashback contract, deploy the contract with the cashback parameter set to true in the request body. Provenance ERC-721 smart contract is an ERC-721 smart contract that forces on-chain royalties to be paid every time an NFT is transferred. The royalties are defined as a percentage of the NFT price and are not OpenSea-compatible. To deploy an NFT smart contract as a provenance contract, deploy the contract with the provenance parameter set to true in the request body. You can enable public minting for cashback and provenance smart contracts. By default, public minting is disabled, which means that only the blockchain address whose private key was used to create the smart contract or the blockchain addresses added to the smart contract as NFT minters will be able to mint NFTs for the contract. To enable public minting and allow anyone to mint NFTs on top of the smart contract, deploy the contract with the publicMint parameter set to true in the request body. You can review the code of a deployed NFT smart contract here (if the contract is deployed on Flow) or here (if the contract is deployed on any other supported blockchain). Signing a transaction When deploying an NFT smart contract, you are charged a fee for the transaction, and you must sign the transaction with the private key of the blockchain address from which the fee will be deducted. Providing the private key in the API is not a secure way of signing transactions, because the private key can be stolen or exposed. Your private keys should never leave your security perimeter. You should use the private keys only for testing a solution you are building on the testnet of a blockchain. For signing transactions on the mainnet, we strongly recommend that you use the Tatum Key Management System (KMS) and provide the signature ID instead of the private key in the API. Alternatively, you can use the Tatum JavaScript client.
        /// </remarks>
        /// <exception cref="Tatum.CSharp.Core.Client.ApiException">Thrown when fails to make API call</exception>
        ...
        /// </summary>
        /// <remarks>
        /// 1 credit per API call Get NFT token metadata. This API is supported for the following blockchains: BNB Smart Chain Celo Ethereum Flow Harmony Klaytn KuCoin Community Chain Polygon Solana TRON
        /// </remarks>
        /// <exception cref="Tatum.CSharp.Core.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="contractAddress">NFT contract address</param>
        /// <param name="token">Token ID, required for all except SOL</param>
        /// <param name="account">Account holding this token. FLOW only. (optional)</param>
        /// <param name="xTestnetType">Type of Ethereum testnet. Defaults to Sepolia. Valid only for ETH invocations for testnet API Key. For mainnet API Key, this value is ignored. (optional, default to ethereum-sepolia)</param>
        ...
        /// </summary>
        /// <remarks>
        /// 1 credit per API call Get NFT token provenance data, valid only for provenance contract. This API is supported for the following blockchains: BNB Smart Chain Celo Ethereum Harmony Klaytn KuCoin Community Chain Polygon
        /// </remarks>
        /// <exception cref="Tatum.CSharp.Core.Client.ApiException">Thrown when fails to make API call</exception>
        ...
        List<NftProvenanceDataErc721> NftGetProvenanceDataErc721(string tokenId, string contractAddress, string xTestnetType = default(string));
        /// <summary>
        /// Get NFT royalty information
        /// </summary>
        /// <remarks>
        /// 1 credit per API call Get NFT token royalty. This API is supported for the following blockchains: BNB Smart Chain Celo Ethereum Flow Harmony Klaytn KuCoin Community Chain Polygon Solana TRON
        /// </remarks>
        /// <exception cref="Tatum.CSharp.Core.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="contractAddress">NFT contract address</param>
        /// <param name="token">Token ID, required for all except SOL</param>
        ...
        /// </summary>
        /// <remarks>
        /// 1 credit per API call + 5 credits for each listed NFT Get all minted NFTs in the collection. Returns all NFTs this contract minted. This API is supported for the following blockchains: Celo Ethereum Polygon
        /// </remarks>
        /// <exception cref="Tatum.CSharp.Core.Client.ApiException">Thrown when fails to make API call</exception>
        ...
        List<NftTokenByCollectionErc721> NftGetTokensByCollectionErc721(decimal pageSize, string address, decimal? offset = default(decimal?));
        /// <summary>
        /// Get an NFT transaction by its hash
        /// </summary>
        /// <remarks>
        /// 1 credit per API call Get NFT transaction by transaction hash. This API is supported for the following blockchains: BNB Smart Chain Celo Ethereum Flow Harmony Klaytn KuCoin Community Chain Polygon TRON
        /// </remarks>
        /// <exception cref="Tatum.CSharp.Core.Client.ApiException">Thrown when fails to make API call</exception>
        ...
        List<NftTx> NftGetTransactionByAddress(string address, string tokenAddress, decimal pageSize, decimal? offset = default(decimal?), decimal? from = default(decimal?), decimal? to = default(decimal?));
        /// <summary>
        /// Get NFT transactions for an NFT
        /// </summary>
        /// <remarks>
        /// 1 credit per API call Get NFT transactions by token. This includes incoming and outgoing transactions for the token. This API is supported for the following blockchains: Celo Ethereum Polygon
        /// </remarks>
        /// <exception cref="Tatum.CSharp.Core.Client.ApiException">Thrown when fails to make API call</exception>
        ...
        /// </summary>
        /// <remarks>
        /// 2 credits per API call Update royalty cashback value for one NFT Token. This method updates the first royalty value of specific author for 1 token. If royalty value is set to 0, it will disable the royalty system for the token. Only from author&#39;s address of the royalty can change it&#39;s royalty value, not the owner of the token. This API is supported for the following blockchains: BNB Smart Chain Celo Ethereum Harmony Klaytn KuCoin Community Chain Polygon TRON Signing a transaction When updating NFT royalty, you are charged a fee for the transaction, and you must sign the transaction with the private key of the blockchain address from which the fee will be deducted. Providing the private key in the API is not a secure way of signing transactions, because the private key can be stolen or exposed. Your private keys should never leave your security perimeter. You should use the private keys only for testing a solution you are building on the testnet of a blockchain. For signing transactions on the mainnet, we strongly recommend that you use the Tatum Key Management System (KMS) and provide the signature ID instead of the private key in the API. Alternatively, you can use the Tatum JavaScript client.
        /// </remarks>
        /// <exception cref="Tatum.CSharp.Core.Client.ApiException">Thrown when fails to make API call</exception>
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface INFTEthApiWithHttpInfoSync : IApiAccessor
    {
        ...
        ApiResponse<List<NftProvenanceDataErc721>> NftGetProvenanceDataErc721WithHttpInfo(string tokenId, string contractAddress, string xTestnetType = default(string));
        /// <summary>
        /// Get NFT royalty information
        /// </summary>
        /// <remarks>
        ...
        ApiResponse<NftRoyaltyErc721> NftGetRoyaltyErc721WithHttpInfo(string contractAddress, string token, string xTestnetType = default(string));
        /// <summary>
        /// Get all NFTs that a blockchain address holds
        /// </summary>
        /// <remarks>
        ...
        ApiResponse<List<NftTokenByCollectionErc721>> NftGetTokensByCollectionErc721WithHttpInfo(decimal pageSize, string address, decimal? offset = default(decimal?));
        /// <summary>
        /// Get an NFT transaction by its hash
        /// </summary>
        /// <remarks>
        ...
        ApiResponse<List<NftTx>> NftGetTransactionByAddressWithHttpInfo(string address, string tokenAddress, decimal pageSize, decimal? offset = default(decimal?), decimal? from = default(decimal?), decimal? to = default(decimal?));
        /// <summary>
        /// Get NFT transactions for an NFT
        /// </summary>
        /// <remarks>
        ...
        /// <param name="to">Transactions up to this block will be included. (optional)</param>
        /// <returns>ApiResponse of List&lt;NftTx&gt;</returns>
        ApiResponse<List<NftTx>> NftGetTransactionByTokenWithHttpInfo(int tokenId, string tokenAddress, decimal pageSize, decimal? offset = default(decimal?), decimal? from = default(decimal?), decimal? to = default(decimal?));
        /// <summary>
        /// Mint an NFT
        /// </summary>
        /// <remarks>
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface INFTEthApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<List<NftProvenanceDataErc721>> NftGetProvenanceDataErc721Async(string tokenId, string contractAddress, string xTestnetType = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Get NFT royalty information
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<NftRoyaltyErc721> NftGetRoyaltyErc721Async(string contractAddress, string token, string xTestnetType = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Get all NFTs that a blockchain address holds
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<List<NftTokenByCollectionErc721>> NftGetTokensByCollectionErc721Async(decimal pageSize, string address, decimal? offset = default(decimal?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Get an NFT transaction by its hash
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<List<NftTx>> NftGetTransactionByAddressAsync(string address, string tokenAddress, decimal pageSize, decimal? offset = default(decimal?), decimal? from = default(decimal?), decimal? to = default(decimal?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Get NFT transactions for an NFT
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of List&lt;NftTx&gt;</returns>
        System.Threading.Tasks.Task<List<NftTx>> NftGetTransactionByTokenAsync(int tokenId, string tokenAddress, decimal pageSize, decimal? offset = default(decimal?), decimal? from = default(decimal?), decimal? to = default(decimal?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Mint an NFT
        /// </summary>
        /// <remarks>
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface INFTEthApiWithHttpInfoAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<ApiResponse<List<NftProvenanceDataErc721>>> NftGetProvenanceDataErc721WithHttpInfoAsync(string tokenId, string contractAddress, string xTestnetType = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Get NFT royalty information
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<ApiResponse<NftRoyaltyErc721>> NftGetRoyaltyErc721WithHttpInfoAsync(string contractAddress, string token, string xTestnetType = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Get all NFTs that a blockchain address holds
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<ApiResponse<List<NftTokenByCollectionErc721>>> NftGetTokensByCollectionErc721WithHttpInfoAsync(decimal pageSize, string address, decimal? offset = default(decimal?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Get an NFT transaction by its hash
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<ApiResponse<List<NftTx>>> NftGetTransactionByAddressWithHttpInfoAsync(string address, string tokenAddress, decimal pageSize, decimal? offset = default(decimal?), decimal? from = default(decimal?), decimal? to = default(decimal?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Get NFT transactions for an NFT
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;NftTx&gt;)</returns>
        System.Threading.Tasks.Task<ApiResponse<List<NftTx>>> NftGetTransactionByTokenWithHttpInfoAsync(int tokenId, string tokenAddress, decimal pageSize, decimal? offset = default(decimal?), decimal? from = default(decimal?), decimal? to = default(decimal?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Mint an NFT
        /// </summary>
        /// <remarks>
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface INFTEthApi : INFTEthApiSync, INFTEthApiWithHttpInfoSync, INFTEthApiAsync, INFTEthApiWithHttpInfoAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class NFTEthApi : INFTEthApi
    {
        private ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="NFTEthApi"/> class.
        /// </summary>
        ...
        /// </remarks>
        public NFTEthApi(HttpClient client, HttpClientHandler handler = null) : this(client, (string)null, handler)
        {
        }
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public NFTEthApi(HttpClient client, string basePath, HttpClientHandler handler = null)
        {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NFTEthApi"/> class using Configuration object.
        /// </summary>
        /// <param name="client">An instance of HttpClient.</param>
        ...
        /// <exception cref="ArgumentNullException"></exception>
        public NFTEthApi(ISynchronousClient client, IAsynchronousClient asyncClient, IReadableConfiguration configuration)
        {
        ...
        /// <summary>
        /// Add an NFT minter 2 credits per API call Add a new minter of NFTs. This method adds minter permission to new minter address. This API is supported for the following blockchains: BNB Smart Chain Celo Ethereum Harmony Klaytn KuCoin Community Chain Polygon Signing a transaction When adding an NFT minter, you are charged a fee for the transaction, and you must sign the transaction with the private key of the blockchain address from which the fee will be deducted. Providing the private key in the API is not a secure way of signing transactions, because the private key can be stolen or exposed. Your private keys should never leave your security perimeter. You should use the private keys only for testing a solution you are building on the testnet of a blockchain. For signing transactions on the mainnet, we strongly recommend that you use the Tatum Key Management System (KMS) and provide the signature ID instead of the private key in the API. Alternatively, you can use the Tatum JavaScript client.
        /// </summary>
        /// <exception cref="Tatum.CSharp.Core.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="addNftMinter"></param>
        /// <param name="xTestnetType">Type of Ethereum testnet. Defaults to Sepolia. Valid only for ETH invocations for testnet API Key. For mainnet API Key, this value is ignored. (optional, default to ethereum-sepolia)</param>
        ...
        public ApiResponse<TransactionHash> NftAddMinterWithHttpInfo(AddNftMinter addNftMinter, string xTestnetType = default(string))
        {
            ...
            if (addNftMinter == null)
                throw new ApiException(400, "Missing required parameter 'addNftMinter' when calling NFTEthApi->NftAddMinter");

            addNftMinter.Chain = AddNftMinter.ChainEnum.ETH;
        ...
        public ApiResponse<SignatureId> NftAddMinterWithHttpInfo(AddNftMinterKMS addNftMinterKMS, string xTestnetType = default(string))
        {
            ...
            if (addNftMinterKMS == null)
                throw new ApiException(400, "Missing required parameter 'addNftMinterKMS' when calling NFTEthApi->NftAddMinter_0");

            addNftMinterKMS.Chain = AddNftMinterKMS.ChainEnum.ETH;
        ...
        public ApiResponse<TransactionHash> NftBurnErc721WithHttpInfo(BurnNft burnNft, string xTestnetType = default(string))
        {
            ...
            if (burnNft == null)
                throw new ApiException(400, "Missing required parameter 'burnNft' when calling NFTEthApi->NftBurnErc721");

            burnNft.Chain = BurnNft.ChainEnum.ETH;
        ...
        public ApiResponse<SignatureId> NftBurnErc721WithHttpInfo(BurnNftKMS burnNftKMS, string xTestnetType = default(string))
        {
            ...
            if (burnNftKMS == null)
                throw new ApiException(400, "Missing required parameter 'burnNftKMS' when calling NFTEthApi->NftBurnErc721_0");

            burnNftKMS.Chain = BurnNftKMS.ChainEnum.ETH;
        ...
        public ApiResponse<TransactionHash> NftDeployErc721WithHttpInfo(DeployNft deployNft, string xTestnetType = default(string))
        {
            ...
            if (deployNft == null)
                throw new ApiException(400, "Missing required parameter 'deployNft' when calling NFTEthApi->NftDeployErc721");

            deployNft.Chain = DeployNft.ChainEnum.ETH;
        ...
        public ApiResponse<SignatureId> NftDeployErc721WithHttpInfo(DeployNftKMS deployNftKMS, string xTestnetType = default(string))
        {
            ...
            if (deployNftKMS == null)
                throw new ApiException(400, "Missing required parameter 'deployNftKMS' when calling NFTEthApi->NftDeployErc721_0");

            deployNftKMS.Chain = DeployNftKMS.ChainEnum.ETH;
        ...
        public ApiResponse<NftGetBalanceSc> NftGetBalanceErc721WithHttpInfo(string address, string contractAddress, string xTestnetType = default(string))
        {
            ...
            if (address == null)
                throw new ApiException(400, "Missing required parameter 'address' when calling NFTEthApi->NftGetBalanceErc721");


            // verify the required parameter 'contractAddress' is set
            if (contractAddress == null)
                throw new ApiException(400, "Missing required parameter 'contractAddress' when calling NFTEthApi->NftGetBalanceErc721");
            ...
            // make the HTTP request
            var localVarResponse = Client.Get<NftGetBalanceSc>("/v3/nft/balance/ETH/{contractAddress}/{address}", localVarRequestOptions, Configuration);
        ...
        public async System.Threading.Tasks.Task<ApiResponse<NftGetBalanceSc>> NftGetBalanceErc721WithHttpInfoAsync(string address, string contractAddress, string xTestnetType = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var localVarResponse = await AsynchronousClient.GetAsync<NftGetBalanceSc>("/v3/nft/balance/ETH/{contractAddress}/{address}", localVarRequestOptions, Configuration, cancellationToken).ConfigureAwait(false);

            return localVarResponse;
        }

        /// <summary>
        /// Get NFT metadata 1 credit per API call Get NFT token metadata. This API is supported for the following blockchains: BNB Smart Chain Celo Ethereum Flow Harmony Klaytn KuCoin Community Chain Polygon Solana TRON
        /// </summary>
        /// <exception cref="Tatum.CSharp.Core.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="contractAddress">NFT contract address</param>
        /// <param name="token">Token ID, required for all except SOL</param>
        ...
        /// <summary>
        /// Get NFT provenance data 1 credit per API call Get NFT token provenance data, valid only for provenance contract. This API is supported for the following blockchains: BNB Smart Chain Celo Ethereum Harmony Klaytn KuCoin Community Chain Polygon
        /// </summary>
        /// <exception cref="Tatum.CSharp.Core.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="tokenId">Token ID</param>
        /// <param name="contractAddress">NFT contract address</param>
        /// <param name="xTestnetType">Type of Ethereum testnet. Defaults to Sepolia. Valid only for ETH invocations for testnet API Key. For mainnet API Key, this value is ignored. (optional, default to ethereum-sepolia)</param>
        /// <returns>List&lt;NftProvenanceDataErc721&gt;</returns>
        public List<NftProvenanceDataErc721> NftGetProvenanceDataErc721(string tokenId, string contractAddress, string xTestnetType = default(string))
        {
            var localVarResponse = NftGetProvenanceDataErc721WithHttpInfo(tokenId, contractAddress, xTestnetType);
        ...
        /// <param name="xTestnetType">Type of Ethereum testnet. Defaults to Sepolia. Valid only for ETH invocations for testnet API Key. For mainnet API Key, this value is ignored. (optional, default to ethereum-sepolia)</param>
        /// <returns>ApiResponse of List&lt;NftProvenanceDataErc721&gt;</returns>
        public ApiResponse<List<NftProvenanceDataErc721>> NftGetProvenanceDataErc721WithHttpInfo(string tokenId, string contractAddress, string xTestnetType = default(string))
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of List&lt;NftProvenanceDataErc721&gt;</returns>
        public async System.Threading.Tasks.Task<List<NftProvenanceDataErc721>> NftGetProvenanceDataErc721Async(string tokenId, string contractAddress, string xTestnetType = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            var localVarResponse = await NftGetProvenanceDataErc721WithHttpInfoAsync(tokenId, contractAddress, xTestnetType, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;NftProvenanceDataErc721&gt;)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<List<NftProvenanceDataErc721>>> NftGetProvenanceDataErc721WithHttpInfoAsync(string tokenId, string contractAddress, string xTestnetType = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'tokenId' is set
            if (tokenId == null)
                throw new ApiException(400, "Missing required parameter 'tokenId' when calling NFTEthApi->NftGetProvenanceDataErc721");
        ...
        /// <summary>
        /// Get NFT royalty information 1 credit per API call Get NFT token royalty. This API is supported for the following blockchains: BNB Smart Chain Celo Ethereum Flow Harmony Klaytn KuCoin Community Chain Polygon Solana TRON
        /// </summary>
        /// <exception cref="Tatum.CSharp.Core.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="contractAddress">NFT contract address</param>
        /// <param name="token">Token ID, required for all except SOL</param>
        /// <param name="xTestnetType">Type of Ethereum testnet. Defaults to Sepolia. Valid only for ETH invocations for testnet API Key. For mainnet API Key, this value is ignored. (optional, default to ethereum-sepolia)</param>
        /// <returns>NftRoyaltyErc721</returns>
        public NftRoyaltyErc721 NftGetRoyaltyErc721(string contractAddress, string token, string xTestnetType = default(string))
        {
            var localVarResponse = NftGetRoyaltyErc721WithHttpInfo(contractAddress, token, xTestnetType);
        ...
        /// <param name="xTestnetType">Type of Ethereum testnet. Defaults to Sepolia. Valid only for ETH invocations for testnet API Key. For mainnet API Key, this value is ignored. (optional, default to ethereum-sepolia)</param>
        /// <returns>ApiResponse of NftRoyaltyErc721</returns>
        public ApiResponse<NftRoyaltyErc721> NftGetRoyaltyErc721WithHttpInfo(string contractAddress, string token, string xTestnetType = default(string))
        {
            // verify the required parameter 'contractAddress' is set
            if (contractAddress == null)
                throw new ApiException(400, "Missing required parameter 'contractAddress' when calling NFTEthApi->NftGetRoyaltyErc721");


            // verify the required parameter 'token' is set
            if (token == null)
                throw new ApiException(400, "Missing required parameter 'token' when calling NFTEthApi->NftGetRoyaltyErc721");
            ...
            // make the HTTP request
            var localVarResponse = Client.Get<NftRoyaltyErc721>("/v3/nft/royalty/ETH/{contractAddress}/{token}", localVarRequestOptions, Configuration);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of NftRoyaltyErc721</returns>
        public async System.Threading.Tasks.Task<NftRoyaltyErc721> NftGetRoyaltyErc721Async(string contractAddress, string token, string xTestnetType = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            var localVarResponse = await NftGetRoyaltyErc721WithHttpInfoAsync(contractAddress, token, xTestnetType, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (NftRoyaltyErc721)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<NftRoyaltyErc721>> NftGetRoyaltyErc721WithHttpInfoAsync(string contractAddress, string token, string xTestnetType = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'contractAddress' is set
            if (contractAddress == null)
                throw new ApiException(400, "Missing required parameter 'contractAddress' when calling NFTEthApi->NftGetRoyaltyErc721");
            ...
            var localVarResponse = await AsynchronousClient.GetAsync<NftRoyaltyErc721>("/v3/nft/royalty/ETH/{contractAddress}/{token}", localVarRequestOptions, Configuration, cancellationToken).ConfigureAwait(false);
        ...
        public ApiResponse<List<NftTokenByAddressErc721>> NftGetTokensByAddressErc721WithHttpInfo(string address)
        {
            // verify the required parameter 'address' is set
            if (address == null)
                throw new ApiException(400, "Missing required parameter 'address' when calling NFTEthApi->NftGetTokensByAddressErc721");
        ...
        /// <summary>
        /// Get NFTs from a collection 1 credit per API call + 5 credits for each listed NFT Get all minted NFTs in the collection. Returns all NFTs this contract minted. This API is supported for the following blockchains: Celo Ethereum Polygon
        /// </summary>
        /// <exception cref="Tatum.CSharp.Core.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="pageSize">Max number of items per page is 50.</param>
        /// <param name="address">Collection address</param>
        /// <param name="offset">Offset to obtain next page of the data. (optional)</param>
        /// <returns>List&lt;NftTokenByCollectionErc721&gt;</returns>
        public List<NftTokenByCollectionErc721> NftGetTokensByCollectionErc721(decimal pageSize, string address, decimal? offset = default(decimal?))
        {
            var localVarResponse = NftGetTokensByCollectionErc721WithHttpInfo(pageSize, address, offset);
        ...
        /// <param name="offset">Offset to obtain next page of the data. (optional)</param>
        /// <returns>ApiResponse of List&lt;NftTokenByCollectionErc721&gt;</returns>
        public ApiResponse<List<NftTokenByCollectionErc721>> NftGetTokensByCollectionErc721WithHttpInfo(decimal pageSize, string address, decimal? offset = default(decimal?))
        {
            // verify the required parameter 'address' is set
            if (address == null)
                throw new ApiException(400, "Missing required parameter 'address' when calling NFTEthApi->NftGetTokensByCollectionErc721");
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of List&lt;NftTokenByCollectionErc721&gt;</returns>
        public async System.Threading.Tasks.Task<List<NftTokenByCollectionErc721>> NftGetTokensByCollectionErc721Async(decimal pageSize, string address, decimal? offset = default(decimal?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            var localVarResponse = await NftGetTokensByCollectionErc721WithHttpInfoAsync(pageSize, address, offset, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;NftTokenByCollectionErc721&gt;)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<List<NftTokenByCollectionErc721>>> NftGetTokensByCollectionErc721WithHttpInfoAsync(decimal pageSize, string address, decimal? offset = default(decimal?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'address' is set
            if (address == null)
                throw new ApiException(400, "Missing required parameter 'address' when calling NFTEthApi->NftGetTokensByCollectionErc721");
        ...
        /// <summary>
        /// Get an NFT transaction by its hash 1 credit per API call Get NFT transaction by transaction hash. This API is supported for the following blockchains: BNB Smart Chain Celo Ethereum Flow Harmony Klaytn KuCoin Community Chain Polygon TRON
        /// </summary>
        /// <exception cref="Tatum.CSharp.Core.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="hash">Transaction hash</param>
        /// <param name="xTestnetType">Type of Ethereum testnet. Defaults to Sepolia. Valid only for ETH invocations for testnet API Key. For mainnet API Key, this value is ignored. (optional, default to ethereum-sepolia)</param>
        ...
        public ApiResponse<EthTx> NftGetTransactErc721WithHttpInfo(string hash, string xTestnetType = default(string))
        {
            ...
            if (hash == null)
                throw new ApiException(400, "Missing required parameter 'hash' when calling NFTEthApi->NftGetTransactErc721");
            ...
            // make the HTTP request
            var localVarResponse = Client.Get<EthTx>("/v3/nft/transaction/ETH/{hash}", localVarRequestOptions, Configuration);
        ...
        public async System.Threading.Tasks.Task<ApiResponse<EthTx>> NftGetTransactErc721WithHttpInfoAsync(string hash, string xTestnetType = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var localVarResponse = await AsynchronousClient.GetAsync<EthTx>("/v3/nft/transaction/ETH/{hash}", localVarRequestOptions, Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="to">Transactions up to this block will be included. (optional)</param>
        /// <returns>List&lt;NftTx&gt;</returns>
        public List<NftTx> NftGetTransactionByAddress(string address, string tokenAddress, decimal pageSize, decimal? offset = default(decimal?), decimal? from = default(decimal?), decimal? to = default(decimal?))
        {
            var localVarResponse = NftGetTransactionByAddressWithHttpInfo(address, tokenAddress, pageSize, offset, from, to);
        ...
        /// <param name="to">Transactions up to this block will be included. (optional)</param>
        /// <returns>ApiResponse of List&lt;NftTx&gt;</returns>
        public ApiResponse<List<NftTx>> NftGetTransactionByAddressWithHttpInfo(string address, string tokenAddress, decimal pageSize, decimal? offset = default(decimal?), decimal? from = default(decimal?), decimal? to = default(decimal?))
        {
            // verify the required parameter 'address' is set
            if (address == null)
                throw new ApiException(400, "Missing required parameter 'address' when calling NFTEthApi->NftGetTransactionByAddress");


            // verify the required parameter 'tokenAddress' is set
            if (tokenAddress == null)
                throw new ApiException(400, "Missing required parameter 'tokenAddress' when calling NFTEthApi->NftGetTransactionByAddress");
        ...
        {
            var localVarResponse = await NftGetTransactionByAddressWithHttpInfoAsync(address, tokenAddress, pageSize, offset, from, to, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;NftTx&gt;)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<List<NftTx>>> NftGetTransactionByAddressWithHttpInfoAsync(string address, string tokenAddress, decimal pageSize, decimal? offset = default(decimal?), decimal? from = default(decimal?), decimal? to = default(decimal?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'address' is set
            if (address == null)
                throw new ApiException(400, "Missing required parameter 'address' when calling NFTEthApi->NftGetTransactionByAddress");
        ...
        /// <summary>
        /// Get NFT transactions for an NFT 1 credit per API call Get NFT transactions by token. This includes incoming and outgoing transactions for the token. This API is supported for the following blockchains: Celo Ethereum Polygon
        /// </summary>
        /// <exception cref="Tatum.CSharp.Core.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="tokenId">NFT Token ID</param>
        /// <param name="tokenAddress">Address of the token smart contract</param>
        ...
        /// <param name="to">Transactions up to this block will be included. (optional)</param>
        /// <returns>List&lt;NftTx&gt;</returns>
        public List<NftTx> NftGetTransactionByToken(int tokenId, string tokenAddress, decimal pageSize, decimal? offset = default(decimal?), decimal? from = default(decimal?), decimal? to = default(decimal?))
        {
            var localVarResponse = NftGetTransactionByTokenWithHttpInfo(tokenId, tokenAddress, pageSize, offset, from, to);
        ...
        /// <param name="to">Transactions up to this block will be included. (optional)</param>
        /// <returns>ApiResponse of List&lt;NftTx&gt;</returns>
        public ApiResponse<List<NftTx>> NftGetTransactionByTokenWithHttpInfo(int tokenId, string tokenAddress, decimal pageSize, decimal? offset = default(decimal?), decimal? from = default(decimal?), decimal? to = default(decimal?))
        {
            // verify the required parameter 'tokenAddress' is set
            if (tokenAddress == null)
                throw new ApiException(400, "Missing required parameter 'tokenAddress' when calling NFTEthApi->NftGetTransactionByToken");
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of List&lt;NftTx&gt;</returns>
        public async System.Threading.Tasks.Task<List<NftTx>> NftGetTransactionByTokenAsync(int tokenId, string tokenAddress, decimal pageSize, decimal? offset = default(decimal?), decimal? from = default(decimal?), decimal? to = default(decimal?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            var localVarResponse = await NftGetTransactionByTokenWithHttpInfoAsync(tokenId, tokenAddress, pageSize, offset, from, to, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;NftTx&gt;)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<List<NftTx>>> NftGetTransactionByTokenWithHttpInfoAsync(int tokenId, string tokenAddress, decimal pageSize, decimal? offset = default(decimal?), decimal? from = default(decimal?), decimal? to = default(decimal?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'tokenAddress' is set
            if (tokenAddress == null)
                throw new ApiException(400, "Missing required parameter 'tokenAddress' when calling NFTEthApi->NftGetTransactionByToken");
        ...
        public ApiResponse<TransactionHash> NftMintErc721WithHttpInfo(MintNftExpress mintNftExpress, string xTestnetType = default(string))
        {
            ...
            if (mintNftExpress == null)
                throw new ApiException(400, "Missing required parameter 'mintNftExpress' when calling NFTEthApi->NftMintErc721");

            mintNftExpress.Chain = MintNftExpress.ChainEnum.ETH;
        ...
        public ApiResponse<TransactionHash> NftMintErc721WithHttpInfo(MintNftMinter mintNftMinter, string xTestnetType = default(string))
        {
            ...
            if (mintNftMinter == null)
                throw new ApiException(400, "Missing required parameter 'mintNftMinter' when calling NFTEthApi->NftMintErc721_0");

            mintNftMinter.Chain = MintNftMinter.ChainEnum.ETH;
        ...
        public ApiResponse<TransactionHash> NftMintErc721WithHttpInfo(MintNft mintNft, string xTestnetType = default(string))
        {
            ...
            if (mintNft == null)
                throw new ApiException(400, "Missing required parameter 'mintNft' when calling NFTEthApi->NftMintErc721_1");

            mintNft.Chain = MintNft.ChainEnum.ETH;
        ...
        public ApiResponse<SignatureId> NftMintErc721WithHttpInfo(MintNftKMS mintNftKMS, string xTestnetType = default(string))
        {
            ...
            if (mintNftKMS == null)
                throw new ApiException(400, "Missing required parameter 'mintNftKMS' when calling NFTEthApi->NftMintErc721_2");

            mintNftKMS.Chain = MintNftKMS.ChainEnum.ETH;
        ...
        public ApiResponse<TransactionHash> NftMintMultipleErc721WithHttpInfo(MintMultipleNftMinter mintMultipleNftMinter, string xTestnetType = default(string))
        {
            ...
            if (mintMultipleNftMinter == null)
                throw new ApiException(400, "Missing required parameter 'mintMultipleNftMinter' when calling NFTEthApi->NftMintMultipleErc721");

            mintMultipleNftMinter.Chain = MintMultipleNftMinter.ChainEnum.ETH;
        ...
        public ApiResponse<TransactionHash> NftMintMultipleErc721WithHttpInfo(MintMultipleNft mintMultipleNft, string xTestnetType = default(string))
        {
            ...
            if (mintMultipleNft == null)
                throw new ApiException(400, "Missing required parameter 'mintMultipleNft' when calling NFTEthApi->NftMintMultipleErc721_0");

            mintMultipleNft.Chain = MintMultipleNft.ChainEnum.ETH;
        ...
        public ApiResponse<SignatureId> NftMintMultipleErc721WithHttpInfo(MintMultipleNftKMS mintMultipleNftKMS, string xTestnetType = default(string))
        {
            ...
            if (mintMultipleNftKMS == null)
                throw new ApiException(400, "Missing required parameter 'mintMultipleNftKMS' when calling NFTEthApi->NftMintMultipleErc721_1");

            mintMultipleNftKMS.Chain = MintMultipleNftKMS.ChainEnum.ETH;
        ...
        public ApiResponse<TransactionHash> NftTransferErc721WithHttpInfo(TransferNft transferNft, string xTestnetType = default(string))
        {
            ...
            if (transferNft == null)
                throw new ApiException(400, "Missing required parameter 'transferNft' when calling NFTEthApi->NftTransferErc721");

            transferNft.Chain = TransferNft.ChainEnum.ETH;
        ...
        public ApiResponse<SignatureId> NftTransferErc721WithHttpInfo(TransferNftKMS transferNftKMS, string xTestnetType = default(string))
        {
            ...
            if (transferNftKMS == null)
                throw new ApiException(400, "Missing required parameter 'transferNftKMS' when calling NFTEthApi->NftTransferErc721_0");

            transferNftKMS.Chain = TransferNftKMS.ChainEnum.ETH;
        ...
        /// <summary>
        /// Update NFT royalty 2 credits per API call Update royalty cashback value for one NFT Token. This method updates the first royalty value of specific author for 1 token. If royalty value is set to 0, it will disable the royalty system for the token. Only from author&#39;s address of the royalty can change it&#39;s royalty value, not the owner of the token. This API is supported for the following blockchains: BNB Smart Chain Celo Ethereum Harmony Klaytn KuCoin Community Chain Polygon TRON Signing a transaction When updating NFT royalty, you are charged a fee for the transaction, and you must sign the transaction with the private key of the blockchain address from which the fee will be deducted. Providing the private key in the API is not a secure way of signing transactions, because the private key can be stolen or exposed. Your private keys should never leave your security perimeter. You should use the private keys only for testing a solution you are building on the testnet of a blockchain. For signing transactions on the mainnet, we strongly recommend that you use the Tatum Key Management System (KMS) and provide the signature ID instead of the private key in the API. Alternatively, you can use the Tatum JavaScript client.
        /// </summary>
        /// <exception cref="Tatum.CSharp.Core.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="updateCashbackValueForAuthorNft"></param>
        /// <param name="xTestnetType">Type of Ethereum testnet. Defaults to Sepolia. Valid only for ETH invocations for testnet API Key. For mainnet API Key, this value is ignored. (optional, default to ethereum-sepolia)</param>
        ...
        public ApiResponse<TransactionHash> NftUpdateCashbackErc721WithHttpInfo(UpdateCashbackValueForAuthorNft updateCashbackValueForAuthorNft, string xTestnetType = default(string))
        {
            ...
            if (updateCashbackValueForAuthorNft == null)
                throw new ApiException(400, "Missing required parameter 'updateCashbackValueForAuthorNft' when calling NFTEthApi->NftUpdateCashbackErc721");

            updateCashbackValueForAuthorNft.Chain = UpdateCashbackValueForAuthorNft.ChainEnum.ETH;
        ...
        public ApiResponse<SignatureId> NftUpdateCashbackErc721WithHttpInfo(UpdateCashbackValueForAuthorNftKMS updateCashbackValueForAuthorNftKMS, string xTestnetType = default(string))
        {
            ...
            if (updateCashbackValueForAuthorNftKMS == null)
                throw new ApiException(400, "Missing required parameter 'updateCashbackValueForAuthorNftKMS' when calling NFTEthApi->NftUpdateCashbackErc721_0");

            updateCashbackValueForAuthorNftKMS.Chain = UpdateCashbackValueForAuthorNftKMS.ChainEnum.ETH;
