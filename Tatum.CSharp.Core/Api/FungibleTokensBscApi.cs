...
namespace Tatum.CSharp.Core.Api
{
    ...
    /// </summary>
    public interface IFungibleTokensBscApiSync : IApiAccessor
    {
        ...
        /// </remarks>
        /// <exception cref="Tatum.CSharp.Core.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="chainTransferBscBep20"></param>
        /// <param name="xTestnetType">Type of Ethereum testnet. Defaults to Sepolia. Valid only for ETH invocations for testnet API Key. For mainnet API Key, this value is ignored. (optional, default to ethereum-sepolia)</param>
        /// <returns>TransactionHash</returns>
        TransactionHash Erc20Transfer(ChainTransferBscBep20 chainTransferBscBep20, string xTestnetType = default(string));
        /// <summary>
        /// Transfer fungible tokens
        /// </summary>
        /// <remarks>
        ...
        /// </remarks>
        /// <exception cref="Tatum.CSharp.Core.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="chainTransferBscBep20KMS"></param>
        /// <param name="xTestnetType">Type of Ethereum testnet. Defaults to Sepolia. Valid only for ETH invocations for testnet API Key. For mainnet API Key, this value is ignored. (optional, default to ethereum-sepolia)</param>
        /// <returns>SignatureId</returns>
        SignatureId Erc20Transfer(ChainTransferBscBep20KMS chainTransferBscBep20KMS, string xTestnetType = default(string));
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IFungibleTokensBscApiWithHttpInfoSync : IApiAccessor
    {
        ...
        /// <param name="xTestnetType">Type of Ethereum testnet. Defaults to Sepolia. Valid only for ETH invocations for testnet API Key. For mainnet API Key, this value is ignored. (optional, default to ethereum-sepolia)</param>
        /// <returns>ApiResponse of TransactionHash</returns>
        ApiResponse<TransactionHash> Erc20TransferWithHttpInfo(ChainTransferBscBep20 chainTransferBscBep20, string xTestnetType = default(string));
        /// <summary>
        /// Transfer fungible tokens
        /// </summary>
        /// <remarks>
        ...
        /// <param name="xTestnetType">Type of Ethereum testnet. Defaults to Sepolia. Valid only for ETH invocations for testnet API Key. For mainnet API Key, this value is ignored. (optional, default to ethereum-sepolia)</param>
        /// <returns>ApiResponse of SignatureId</returns>
        ApiResponse<SignatureId> Erc20TransferWithHttpInfo(ChainTransferBscBep20KMS chainTransferBscBep20KMS, string xTestnetType = default(string));
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IFungibleTokensBscApiAsync : IApiAccessor
    {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of TransactionHash</returns>
        System.Threading.Tasks.Task<TransactionHash> Erc20TransferAsync(ChainTransferBscBep20 chainTransferBscBep20, string xTestnetType = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Transfer fungible tokens
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of SignatureId</returns>
        System.Threading.Tasks.Task<SignatureId> Erc20TransferAsync(ChainTransferBscBep20KMS chainTransferBscBep20KMS, string xTestnetType = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IFungibleTokensBscApiWithHttpInfoAsync : IApiAccessor
    {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (TransactionHash)</returns>
        System.Threading.Tasks.Task<ApiResponse<TransactionHash>> Erc20TransferWithHttpInfoAsync(ChainTransferBscBep20 chainTransferBscBep20, string xTestnetType = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Transfer fungible tokens
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (SignatureId)</returns>
        System.Threading.Tasks.Task<ApiResponse<SignatureId>> Erc20TransferWithHttpInfoAsync(ChainTransferBscBep20KMS chainTransferBscBep20KMS, string xTestnetType = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IFungibleTokensBscApi : IFungibleTokensBscApiSync, IFungibleTokensBscApiWithHttpInfoSync, IFungibleTokensBscApiAsync, IFungibleTokensBscApiWithHttpInfoAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class FungibleTokensBscApi : IFungibleTokensBscApi
    {
        private ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="FungibleTokensBscApi"/> class.
        /// </summary>
        ...
        /// </remarks>
        public FungibleTokensBscApi(HttpClient client, HttpClientHandler handler = null) : this(client, (string)null, handler)
        {
        }
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public FungibleTokensBscApi(HttpClient client, string basePath, HttpClientHandler handler = null)
        {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="FungibleTokensBscApi"/> class using Configuration object.
        /// </summary>
        /// <param name="client">An instance of HttpClient.</param>
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public FungibleTokensBscApi(HttpClient client, Configuration configuration, HttpClientHandler handler = null)
        {
        ...
        /// <exception cref="ArgumentNullException"></exception>
        public FungibleTokensBscApi(ISynchronousClient client, IAsynchronousClient asyncClient, IReadableConfiguration configuration)
        {
        ...
        public ApiResponse<TransactionHash> Erc20ApproveWithHttpInfo(ApproveErc20 approveErc20, string xTestnetType = default(string))
        {
            ...
            if (approveErc20 == null)
                throw new ApiException(400, "Missing required parameter 'approveErc20' when calling FungibleTokensBscApi->Erc20Approve");

            approveErc20.Chain = ApproveErc20.ChainEnum.BSC;
        ...
        public ApiResponse<SignatureId> Erc20ApproveWithHttpInfo(ApproveErc20KMS approveErc20KMS, string xTestnetType = default(string))
        {
            ...
            if (approveErc20KMS == null)
                throw new ApiException(400, "Missing required parameter 'approveErc20KMS' when calling FungibleTokensBscApi->Erc20Approve_0");

            approveErc20KMS.Chain = ApproveErc20KMS.ChainEnum.BSC;
        ...
        public ApiResponse<TransactionHash> Erc20BurnWithHttpInfo(ChainBurnErc20 chainBurnErc20, string xTestnetType = default(string))
        {
            ...
            if (chainBurnErc20 == null)
                throw new ApiException(400, "Missing required parameter 'chainBurnErc20' when calling FungibleTokensBscApi->Erc20Burn");

            chainBurnErc20.Chain = ChainBurnErc20.ChainEnum.BSC;
        ...
        public ApiResponse<SignatureId> Erc20BurnWithHttpInfo(ChainBurnErc20KMS chainBurnErc20KMS, string xTestnetType = default(string))
        {
            ...
            if (chainBurnErc20KMS == null)
                throw new ApiException(400, "Missing required parameter 'chainBurnErc20KMS' when calling FungibleTokensBscApi->Erc20Burn_0");

            chainBurnErc20KMS.Chain = ChainBurnErc20KMS.ChainEnum.BSC;
        ...
        public ApiResponse<TransactionHash> Erc20DeployWithHttpInfo(ChainDeployErc20 chainDeployErc20, string xTestnetType = default(string))
        {
            ...
            if (chainDeployErc20 == null)
                throw new ApiException(400, "Missing required parameter 'chainDeployErc20' when calling FungibleTokensBscApi->Erc20Deploy");

            chainDeployErc20.Chain = ChainDeployErc20.ChainEnum.BSC;
        ...
        public ApiResponse<SignatureId> Erc20DeployWithHttpInfo(ChainDeployErc20KMS chainDeployErc20KMS, string xTestnetType = default(string))
        {
            ...
            if (chainDeployErc20KMS == null)
                throw new ApiException(400, "Missing required parameter 'chainDeployErc20KMS' when calling FungibleTokensBscApi->Erc20Deploy_0");

            chainDeployErc20KMS.Chain = ChainDeployErc20KMS.ChainEnum.BSC;
        ...
        public ApiResponse<Erc20Balance> Erc20GetBalanceWithHttpInfo(string address, string contractAddress, string xTestnetType = default(string))
        {
            ...
            if (address == null)
                throw new ApiException(400, "Missing required parameter 'address' when calling FungibleTokensBscApi->Erc20GetBalance");


            // verify the required parameter 'contractAddress' is set
            if (contractAddress == null)
                throw new ApiException(400, "Missing required parameter 'contractAddress' when calling FungibleTokensBscApi->Erc20GetBalance");
            ...
            // make the HTTP request
            var localVarResponse = Client.Get<Erc20Balance>("/v3/blockchain/token/balance/BSC/{contractAddress}/{address}", localVarRequestOptions, Configuration);
        ...
        public async System.Threading.Tasks.Task<ApiResponse<Erc20Balance>> Erc20GetBalanceWithHttpInfoAsync(string address, string contractAddress, string xTestnetType = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var localVarResponse = await AsynchronousClient.GetAsync<Erc20Balance>("/v3/blockchain/token/balance/BSC/{contractAddress}/{address}", localVarRequestOptions, Configuration, cancellationToken).ConfigureAwait(false);
        ...
        public ApiResponse<List<Erc20BalanceForAddress>> Erc20GetBalanceAddressWithHttpInfo(string address)
        {
            // verify the required parameter 'address' is set
            if (address == null)
                throw new ApiException(400, "Missing required parameter 'address' when calling FungibleTokensBscApi->Erc20GetBalanceAddress");
            ...
            // make the HTTP request
            var localVarResponse = Client.Get<List<Erc20BalanceForAddress>>("/v3/blockchain/token/address/BSC/{address}", localVarRequestOptions, Configuration);
        ...
        public async System.Threading.Tasks.Task<ApiResponse<List<Erc20BalanceForAddress>>> Erc20GetBalanceAddressWithHttpInfoAsync(string address, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var localVarResponse = await AsynchronousClient.GetAsync<List<Erc20BalanceForAddress>>("/v3/blockchain/token/address/BSC/{address}", localVarRequestOptions, Configuration, cancellationToken).ConfigureAwait(false);
        ...
        public ApiResponse<List<FungibleTx>> Erc20GetTransactionByAddressWithHttpInfo(string address, string tokenAddress, decimal pageSize, decimal? offset = default(decimal?), decimal? from = default(decimal?), decimal? to = default(decimal?), string sort = default(string))
        {
            // verify the required parameter 'address' is set
            if (address == null)
                throw new ApiException(400, "Missing required parameter 'address' when calling FungibleTokensBscApi->Erc20GetTransactionByAddress");


            // verify the required parameter 'tokenAddress' is set
            if (tokenAddress == null)
                throw new ApiException(400, "Missing required parameter 'tokenAddress' when calling FungibleTokensBscApi->Erc20GetTransactionByAddress");
            ...
            // make the HTTP request
            var localVarResponse = Client.Get<List<FungibleTx>>("/v3/blockchain/token/transaction/BSC/{address}/{tokenAddress}", localVarRequestOptions, Configuration);
        ...
        public async System.Threading.Tasks.Task<ApiResponse<List<FungibleTx>>> Erc20GetTransactionByAddressWithHttpInfoAsync(string address, string tokenAddress, decimal pageSize, decimal? offset = default(decimal?), decimal? from = default(decimal?), decimal? to = default(decimal?), string sort = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var localVarResponse = await AsynchronousClient.GetAsync<List<FungibleTx>>("/v3/blockchain/token/transaction/BSC/{address}/{tokenAddress}", localVarRequestOptions, Configuration, cancellationToken).ConfigureAwait(false);
        ...
        public ApiResponse<TransactionHash> Erc20MintWithHttpInfo(ChainMintErc20 chainMintErc20, string xTestnetType = default(string))
        {
            ...
            if (chainMintErc20 == null)
                throw new ApiException(400, "Missing required parameter 'chainMintErc20' when calling FungibleTokensBscApi->Erc20Mint");

            chainMintErc20.Chain = ChainMintErc20.ChainEnum.BSC;
        ...
        public ApiResponse<SignatureId> Erc20MintWithHttpInfo(ChainMintErc20KMS chainMintErc20KMS, string xTestnetType = default(string))
        {
            ...
            if (chainMintErc20KMS == null)
                throw new ApiException(400, "Missing required parameter 'chainMintErc20KMS' when calling FungibleTokensBscApi->Erc20Mint_0");

            chainMintErc20KMS.Chain = ChainMintErc20KMS.ChainEnum.BSC;
        ...
        public ApiResponse<TransactionHash> Erc20TransferWithHttpInfo(ChainTransferEthErc20 chainTransferEthErc20, string xTestnetType = default(string))
        {
            ...
            if (chainTransferEthErc20 == null)
                throw new ApiException(400, "Missing required parameter 'chainTransferEthErc20' when calling FungibleTokensBscApi->Erc20Transfer");

            chainTransferEthErc20.Chain = ChainTransferEthErc20.ChainEnum.BSC;
        ...
        /// <param name="xTestnetType">Type of Ethereum testnet. Defaults to Sepolia. Valid only for ETH invocations for testnet API Key. For mainnet API Key, this value is ignored. (optional, default to ethereum-sepolia)</param>
        /// <returns>TransactionHash</returns>
        public TransactionHash Erc20Transfer(ChainTransferBscBep20 chainTransferBscBep20, string xTestnetType = default(string))
        {
            var localVarResponse = Erc20TransferWithHttpInfo(chainTransferBscBep20, xTestnetType);
        ...
        /// <param name="xTestnetType">Type of Ethereum testnet. Defaults to Sepolia. Valid only for ETH invocations for testnet API Key. For mainnet API Key, this value is ignored. (optional, default to ethereum-sepolia)</param>
        /// <returns>ApiResponse of TransactionHash</returns>
        public ApiResponse<TransactionHash> Erc20TransferWithHttpInfo(ChainTransferBscBep20 chainTransferBscBep20, string xTestnetType = default(string))
        {
            // verify the required parameter 'chainTransferBscBep20' is set
            if (chainTransferBscBep20 == null)
                throw new ApiException(400, "Missing required parameter 'chainTransferBscBep20' when calling FungibleTokensBscApi->Erc20Transfer_0");

            chainTransferBscBep20.Chain = ChainTransferBscBep20.ChainEnum.BSC;
            ...
            localVarRequestOptions.Data = chainTransferBscBep20;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of TransactionHash</returns>
        public async System.Threading.Tasks.Task<TransactionHash> Erc20TransferAsync(ChainTransferBscBep20 chainTransferBscBep20, string xTestnetType = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            var localVarResponse = await Erc20TransferWithHttpInfoAsync(chainTransferBscBep20, xTestnetType, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (TransactionHash)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<TransactionHash>> Erc20TransferWithHttpInfoAsync(ChainTransferBscBep20 chainTransferBscBep20, string xTestnetType = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'chainTransferBscBep20' is set
            if (chainTransferBscBep20 == null)
                throw new ApiException(400, "Missing required parameter 'chainTransferBscBep20' when calling FungibleTokensBscApi->Erc20Transfer_0");
        ...
        public SignatureId Erc20Transfer(ChainTransferEthErc20KMS chainTransferEthErc20KMS, string xTestnetType = default(string))
        {
            ...
            var exception = ExceptionFactory?.Invoke("Erc20Transfer_1", localVarResponse);
            if (exception != null) throw exception;
        ...
        public ApiResponse<SignatureId> Erc20TransferWithHttpInfo(ChainTransferEthErc20KMS chainTransferEthErc20KMS, string xTestnetType = default(string))
        {
            ...
            if (chainTransferEthErc20KMS == null)
                throw new ApiException(400, "Missing required parameter 'chainTransferEthErc20KMS' when calling FungibleTokensBscApi->Erc20Transfer_1");

            chainTransferEthErc20KMS.Chain = ChainTransferEthErc20KMS.ChainEnum.BSC;
        ...
        /// <param name="xTestnetType">Type of Ethereum testnet. Defaults to Sepolia. Valid only for ETH invocations for testnet API Key. For mainnet API Key, this value is ignored. (optional, default to ethereum-sepolia)</param>
        /// <returns>SignatureId</returns>
        public SignatureId Erc20Transfer(ChainTransferBscBep20KMS chainTransferBscBep20KMS, string xTestnetType = default(string))
        {
            var localVarResponse = Erc20TransferWithHttpInfo(chainTransferBscBep20KMS, xTestnetType);

            var exception = ExceptionFactory?.Invoke("Erc20Transfer_2", localVarResponse);
            if (exception != null) throw exception;
        ...
        /// <param name="xTestnetType">Type of Ethereum testnet. Defaults to Sepolia. Valid only for ETH invocations for testnet API Key. For mainnet API Key, this value is ignored. (optional, default to ethereum-sepolia)</param>
        /// <returns>ApiResponse of SignatureId</returns>
        public ApiResponse<SignatureId> Erc20TransferWithHttpInfo(ChainTransferBscBep20KMS chainTransferBscBep20KMS, string xTestnetType = default(string))
        {
            // verify the required parameter 'chainTransferBscBep20KMS' is set
            if (chainTransferBscBep20KMS == null)
                throw new ApiException(400, "Missing required parameter 'chainTransferBscBep20KMS' when calling FungibleTokensBscApi->Erc20Transfer_2");

            chainTransferBscBep20KMS.Chain = ChainTransferBscBep20KMS.ChainEnum.BSC;
            ...
            localVarRequestOptions.Data = chainTransferBscBep20KMS;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of SignatureId</returns>
        public async System.Threading.Tasks.Task<SignatureId> Erc20TransferAsync(ChainTransferBscBep20KMS chainTransferBscBep20KMS, string xTestnetType = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            var localVarResponse = await Erc20TransferWithHttpInfoAsync(chainTransferBscBep20KMS, xTestnetType, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (SignatureId)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<SignatureId>> Erc20TransferWithHttpInfoAsync(ChainTransferBscBep20KMS chainTransferBscBep20KMS, string xTestnetType = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'chainTransferBscBep20KMS' is set
            if (chainTransferBscBep20KMS == null)
                throw new ApiException(400, "Missing required parameter 'chainTransferBscBep20KMS' when calling FungibleTokensBscApi->Erc20Transfer_2");
