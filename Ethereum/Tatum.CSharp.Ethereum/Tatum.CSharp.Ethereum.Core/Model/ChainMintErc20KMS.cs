...
namespace Tatum.CSharp.Ethereum.Core.Model
{
    ...
    public partial class ChainMintErc20KMS : IEquatable<ChainMintErc20KMS>, IValidatableObject
    {
        ...
        public ChainMintErc20KMS(string amount = default(string), string to = default(string), string contractAddress = default(string), Guid signatureId = default(Guid), decimal nonce = default(decimal))
        {
