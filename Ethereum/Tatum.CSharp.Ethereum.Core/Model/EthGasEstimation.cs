...
namespace Tatum.CSharp.Ethereum.Core.Model
{
    ...
    public partial class EthGasEstimation : IEquatable<EthGasEstimation>, IValidatableObject
    {
        ...
        public EthGasEstimation(string gasLimit = default(string), string gasPrice = default(string), EthGasEstimationDetails estimations = default(EthGasEstimationDetails))
        {
