...
namespace Tatum.CSharp.Ethereum.Core.Model
{
    ...
    public partial class BurnMultiTokenBatch : IEquatable<BurnMultiTokenBatch>, IValidatableObject
    {
        ...
        public BurnMultiTokenBatch(string account = default(string), List<string> tokenId = default(List<string>), List<string> amounts = default(List<string>), string data = default(string), string contractAddress = default(string), string fromPrivateKey = default(string), decimal nonce = default(decimal), CustomFee fee = default(CustomFee))
        {
