...
namespace Tatum.CSharp.Ethereum.Core.Model
{
    ...
    public partial class TransferNftKMS : IEquatable<TransferNftKMS>, IValidatableObject
    {
        ...
        public TransferNftKMS(string value = default(string), string to = default(string), string tokenId = default(string), string contractAddress = default(string), decimal index = default(decimal), bool provenance = default(bool), string provenanceData = default(string), string tokenPrice = default(string), Guid signatureId = default(Guid), decimal nonce = default(decimal), CustomFee fee = default(CustomFee))
        {
