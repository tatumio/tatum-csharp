...
namespace Tatum.CSharp.Polygon.Core.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MintNft")]
    public partial class MintNft : IEquatable<MintNft>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MintNft" /> class.
        /// </summary>
        ...
        public MintNft(string to = default(string), string contractAddress = default(string), string tokenId = default(string), string url = default(string), string fromPrivateKey = default(string), string erc20 = default(string), bool provenance = default(bool), List<string> authorAddresses = default(List<string>), List<string> cashbackValues = default(List<string>), List<string> fixedValues = default(List<string>), decimal nonce = default(decimal), CustomFee fee = default(CustomFee))
        {
            // to ensure "to" is required (not null)
            if (to == null)
            {
                throw new ArgumentNullException("to is a required property for MintNft and cannot be null");
            }
            this.To = to;
            ...
            if (url == null)
            {
                throw new ArgumentNullException("url is a required property for MintNft and cannot be null");
            }
            this.Url = url;
            // to ensure "fromPrivateKey" is required (not null)
            if (fromPrivateKey == null)
            {
                throw new ArgumentNullException("fromPrivateKey is a required property for MintNft and cannot be null");
            }
        ...
        {
            return this.Equals(input as MintNft);
        }

        /// <summary>
        /// Returns true if MintNft instances are equal
        /// </summary>
        /// <param name="input">Instance of MintNft to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MintNft input)
        {
            if (input == null)
            {
                return false;
