...
namespace Tatum.CSharp.Polygon.Core.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TransferPolygonBlockchainKMS")]
    public partial class TransferPolygonBlockchainKMS : IEquatable<TransferPolygonBlockchainKMS>, IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>Currency to transfer from Polygon Blockchain Account. ERC20 tokens BETH, BBTC, BADA, WMATIC, BDOT, BXRP, BLTC, BBCH are available only for mainnet use.</value>
        ...
        protected TransferPolygonBlockchainKMS() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TransferPolygonBlockchainKMS" /> class.
        /// </summary>
        ...
        public TransferPolygonBlockchainKMS(string data = default(string), decimal nonce = default(decimal), string to = default(string), CurrencyEnum currency = default(CurrencyEnum), CustomFee fee = default(CustomFee), string amount = default(string), decimal index = default(decimal), Guid signatureId = default(Guid))
        {
            // to ensure "to" is required (not null)
            if (to == null)
            {
                throw new ArgumentNullException("to is a required property for TransferPolygonBlockchainKMS and cannot be null");
            }
            this.To = to;
            ...
            if (amount == null)
            {
                throw new ArgumentNullException("amount is a required property for TransferPolygonBlockchainKMS and cannot be null");
            }
            this.Amount = amount;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransferPolygonBlockchainKMS {\n");
        ...
        {
            return this.Equals(input as TransferPolygonBlockchainKMS);
        }

        /// <summary>
        /// Returns true if TransferPolygonBlockchainKMS instances are equal
        /// </summary>
        /// <param name="input">Instance of TransferPolygonBlockchainKMS to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransferPolygonBlockchainKMS input)
        {
            if (input == null)
            {
                return false;
