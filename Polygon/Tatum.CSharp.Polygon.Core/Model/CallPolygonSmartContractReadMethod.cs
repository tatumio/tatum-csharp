...
namespace Tatum.CSharp.Polygon.Core.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CallPolygonSmartContractReadMethod")]
    public partial class CallPolygonSmartContractReadMethod : IEquatable<CallPolygonSmartContractReadMethod>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CallPolygonSmartContractReadMethod" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CallPolygonSmartContractReadMethod() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CallPolygonSmartContractReadMethod" /> class.
        /// </summary>
        ...
        public CallPolygonSmartContractReadMethod(string contractAddress = default(string), string methodName = default(string), Object methodABI = default(Object), List<string> _params = default(List<string>))
        {
            // to ensure "contractAddress" is required (not null)
            if (contractAddress == null)
            {
                throw new ArgumentNullException("contractAddress is a required property for CallPolygonSmartContractReadMethod and cannot be null");
            }
            this.ContractAddress = contractAddress;
            // to ensure "methodName" is required (not null)
            if (methodName == null)
            {
                throw new ArgumentNullException("methodName is a required property for CallPolygonSmartContractReadMethod and cannot be null");
            }
            this.MethodName = methodName;
            // to ensure "methodABI" is required (not null)
            if (methodABI == null)
            {
                throw new ArgumentNullException("methodABI is a required property for CallPolygonSmartContractReadMethod and cannot be null");
            }
            this.MethodABI = methodABI;
            // to ensure "_params" is required (not null)
            if (_params == null)
            {
                throw new ArgumentNullException("_params is a required property for CallPolygonSmartContractReadMethod and cannot be null");
            }
            this.Params = _params;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CallPolygonSmartContractReadMethod {\n");
        ...
        {
            return this.Equals(input as CallPolygonSmartContractReadMethod);
        }

        /// <summary>
        /// Returns true if CallPolygonSmartContractReadMethod instances are equal
        /// </summary>
        /// <param name="input">Instance of CallPolygonSmartContractReadMethod to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CallPolygonSmartContractReadMethod input)
        {
            if (input == null)
            {
                return false;
