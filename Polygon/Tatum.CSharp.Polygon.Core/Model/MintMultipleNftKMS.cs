...
namespace Tatum.CSharp.Polygon.Core.Model
{
    ...
    public partial class MintMultipleNftKMS : IEquatable<MintMultipleNftKMS>, IValidatableObject
    {
        ...
        public MintMultipleNftKMS(List<string> to = default(List<string>), List<string> tokenId = default(List<string>), List<string> url = default(List<string>), List<List<string>> authorAddresses = default(List<List<string>>), List<List<string>> cashbackValues = default(List<List<string>>), string contractAddress = default(string), decimal index = default(decimal), Guid signatureId = default(Guid), decimal nonce = default(decimal), CustomFee fee = default(CustomFee))
        {
