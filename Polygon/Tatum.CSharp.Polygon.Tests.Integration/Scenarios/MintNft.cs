...
public class MintNft
{
    ...
    public async Task<EthTx> MintNft_Polygon_Example()
    {
        ...
        var addressResponse = polygonClient.Local.GenerateAddress(wallet.Xpub, 0);
        ...
        var mintRequest = new MintNftExpress
            (
                addressResponse.Address, // The blockchain address to send the NFT to
        ...
        var tokens = await polygonClient.PolygonNft.NftGetTokensByAddressErc721Async(addressResponse.Address);
