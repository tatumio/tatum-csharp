...
namespace Tatum.CSharp.Nft.Core.Model
{
    ...
    public partial class AddNftMinter : IEquatable<AddNftMinter>, IValidatableObject
    {
        ...
        /// <param name="fromPrivateKey">The private key of the blockchain address that has priviledges to add an NFT minter to the NFT smart contract (the owner of the smart contract or a blockchain address that was granted such priviledges) (required).</param>
        ...
        public AddNftMinter(ChainEnum chain = default(ChainEnum), string contractAddress = default(string), string minter = default(string), string fromPrivateKey = default(string), decimal nonce = default(decimal), CustomFee fee = default(CustomFee), FeeCurrencyEnum? feeCurrency = default(FeeCurrencyEnum?))
        {
            this.Chain = chain;
        ...
        /// </summary>
        /// <value>The private key of the blockchain address that has priviledges to add an NFT minter to the NFT smart contract (the owner of the smart contract or a blockchain address that was granted such priviledges)</value>
