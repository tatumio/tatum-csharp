...
namespace Tatum.CSharp.Nft.Core.Model
{
    ...
    /// TransferNftKMS
    /// </summary>
    [DataContract(Name = "TransferNftKMS")]
    public partial class TransferNftKMS : IEquatable<TransferNftKMS>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TransferNftKMS" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TransferNftKMS() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TransferNftKMS" /> class.
        /// </summary>
        ...
        public TransferNftKMS(string value = default(string), ChainEnum chain = default(ChainEnum), string to = default(string), string tokenId = default(string), string contractAddress = default(string), decimal index = default(decimal), bool provenance = default(bool), string provenanceData = default(string), string tokenPrice = default(string), Guid signatureId = default(Guid), decimal nonce = default(decimal), CustomFee fee = default(CustomFee))
        {
            this.Chain = chain;
            // to ensure "to" is required (not null)
            if (to == null)
            {
                throw new ArgumentNullException("to is a required property for TransferNftKMS and cannot be null");
            }
            this.To = to;
            // to ensure "tokenId" is required (not null)
            if (tokenId == null)
            {
                throw new ArgumentNullException("tokenId is a required property for TransferNftKMS and cannot be null");
            }
            this.TokenId = tokenId;
            // to ensure "contractAddress" is required (not null)
            if (contractAddress == null)
            {
                throw new ArgumentNullException("contractAddress is a required property for TransferNftKMS and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransferNftKMS {\n");
        ...
        {
            return this.Equals(input as TransferNftKMS);
        }

        /// <summary>
        /// Returns true if TransferNftKMS instances are equal
        /// </summary>
        /// <param name="input">Instance of TransferNftKMS to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransferNftKMS input)
        {
            if (input == null)
            {
                return false;
