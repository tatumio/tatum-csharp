...
namespace Tatum.CSharp.Nft.Core.Api
{
    ...
    public partial class NFTMaticApi : INFTMaticApi
    {
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public NFTMaticApi(HttpClient client, Tatum.CSharp.Nft.Core.Client.Configuration configuration, HttpClientHandler handler = null)
        {
        ...
        public ApiResponse<NftGetBalanceSc> NftGetBalanceErc721WithHttpInfo(string address, string contractAddress, string xTestnetType = default(string))
        {
            ...
            // make the HTTP request
            var localVarResponse = Client.Get<NftGetBalanceSc>("/v3/nft/balance/MATIC/{contractAddress}/{address}", localVarRequestOptions, Configuration);
        ...
        public async System.Threading.Tasks.Task<ApiResponse<NftGetBalanceSc>> NftGetBalanceErc721WithHttpInfoAsync(string address, string contractAddress, string xTestnetType = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var localVarResponse = await AsynchronousClient.GetAsync<NftGetBalanceSc>("/v3/nft/balance/MATIC/{contractAddress}/{address}", localVarRequestOptions, Configuration, cancellationToken).ConfigureAwait(false);
        ...
        public ApiResponse<EthTx> NftGetTransactErc721WithHttpInfo(string hash, string xTestnetType = default(string))
        {
            ...
            // make the HTTP request
            var localVarResponse = Client.Get<EthTx>("/v3/nft/transaction/MATIC/{hash}", localVarRequestOptions, Configuration);
        ...
        public async System.Threading.Tasks.Task<ApiResponse<EthTx>> NftGetTransactErc721WithHttpInfoAsync(string hash, string xTestnetType = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var localVarResponse = await AsynchronousClient.GetAsync<EthTx>("/v3/nft/transaction/MATIC/{hash}", localVarRequestOptions, Configuration, cancellationToken).ConfigureAwait(false);
