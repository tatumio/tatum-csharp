...
namespace Tatum.CSharp.Nft.Core.Api
{
    ...
    public partial class NFTEthApi : INFTEthApi
    {
        ...
        public NFTEthApi(HttpClient client, string basePath, HttpClientHandler handler = null)
        {
            ...
            ExceptionFactory = Tatum.CSharp.Nft.Core.Client.Configuration.DefaultExceptionFactory;
        }
